...
|Clause|Description|
|------|-----------|
|[priv](#private-openmp)|Spécifie que chaque thread doit avoir sa propre instance d’une variable.|
...
|[applicables](#reduction)|Spécifie qu’une ou plusieurs variables qui sont privées pour chaque thread font l’objet d’une opération de réduction à la fin de la région parallèle.|
...
Pour plus d’informations, consultez [copie 2.7.2.7](../2-directives.md#2727-copyin).

### <a name="example"></a>Exemple

Pour obtenir un exemple d’utilisation de, consultez [threadprivate](openmp-directives.md#threadprivate) `copyin` .
...
Pour plus d’informations, consultez [2.7.2.8 copyprivate](../2-directives.md#2728-copyprivate).
...
## <a name="default"></a><a name="default-openmp"></a> valeurs
...
Pour plus d’informations, consultez [2.7.2.5 default](../2-directives.md#2725-default).

### <a name="example"></a>Exemple

Pour obtenir un exemple d’utilisation de, consultez [Private](#private-openmp) `default` .
...
Pour plus d’informations, consultez [2.7.2.2 firstprivate](../2-directives.md#2722-firstprivate).
...
Pour plus d’informations, consultez [2.7.2.3 lastprivate](../2-directives.md#2723-lastprivate).
...
Pour plus d’informations, consultez [2.4.1 pour la construction](../2-directives.md#241-for-construct), [2.4.2 sections Construct](../2-directives.md#242-sections-construct)et [2.4.3 unique Construct](../2-directives.md#243-single-construct).
...
Consultez [ordered pour obtenir un](openmp-directives.md#ordered-openmp-directives) exemple d’utilisation de la `ordered` clause.

## <a name="private"></a><a name="private-openmp"></a> priv
...
Pour plus d’informations, consultez [2.7.2.1 Private](../2-directives.md#2721-private).
...
## <a name="reduction"></a><a name="reduction"></a> applicables
...
Pour plus d’informations, consultez [réduction de 2.7.2.6](../2-directives.md#2726-reduction).
...
## <a name="schedule"></a><a name="schedule"></a> programmateur
...
Pour plus d’informations, consultez [2.7.2.4 Shared](../2-directives.md#2724-shared).

### <a name="example"></a>Exemple

Pour obtenir un exemple d’utilisation de, consultez [Private](#private-openmp) `shared` .
