...
1. [Fonctions de bibliothèque du Run-time](3-run-time-library-functions.md)

1. [Variables d’environnement](4-environment-variables.md)

### <a name="appendices"></a>Annexes

Un fichier . [Exemples](a-examples.md)

B. [Stubs pour les fonctions de bibliothèque du run-time](b-stubs-for-run-time-library-functions.md)

C. [Grammaire OpenMP C et C++](c-openmp-c-and-cpp-grammar.md)

D. [La clause schedule](d-using-the-schedule-clause.md)
