...
## <a name="abs"></a><a name="abs"></a> absolue
...
## <a name="sign"></a><a name="sign"></a> expéditeur
...
## <a name="step"></a><a name="step"></a> première
