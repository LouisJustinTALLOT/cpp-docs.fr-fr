...
|[Procédure pas à pas : Multiplication de matrice](../../parallel/amp/walkthrough-matrix-multiplication.md)|Montre une multiplication de matrice à l’aide de code C++ AMP et de la mosaïque.|
...
[Programmation parallèle en Code natif Blog](https://go.microsoft.com/fwlink/p/?linkid=238472)<br/>
[Exemples de projets C++ AMP pour téléchargement](https://go.microsoft.com/fwlink/p/?linkid=248508)<br/>
