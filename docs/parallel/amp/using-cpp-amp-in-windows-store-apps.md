---
title: À l’aide de C++ AMP dans les applications UWP | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-amp
...
[Créer votre première application UWP à l’aide de C++](/windows/uwp/get-started/create-a-basic-windows-10-app-in-cpp)   
