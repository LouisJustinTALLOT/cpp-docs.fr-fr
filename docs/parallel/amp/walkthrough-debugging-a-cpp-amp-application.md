---
description: 'En savoir plus sur : procédure pas à pas : débogage d’une application C++ AMP'
...
1. Dans la boîte de dialogue **pages de propriétés** , sous **Propriétés de configuration**, choisissez en-têtes précompilés **C/C++**  >  .
