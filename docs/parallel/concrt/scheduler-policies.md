...
|`SchedulingProtocol`| Un [concurrency::SchedulingProtocolType](reference/concurrency-namespace-enums.md#schedulingprotocoltype) valeur qui spécifie l’algorithme de planification à utiliser. |`EnhanceScheduleGroupLocality`|  
