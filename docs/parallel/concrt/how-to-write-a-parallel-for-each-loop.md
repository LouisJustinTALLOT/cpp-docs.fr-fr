---
title: 'Procédure : Écrire une boucle parallel_for_each'
ms.date: 11/04/2016
helpviewer_keywords:
...
ms.locfileid: "62375559"
---
# <a name="how-to-write-a-parallelforeach-loop"></a>Procédure : Écrire une boucle parallel_for_each
