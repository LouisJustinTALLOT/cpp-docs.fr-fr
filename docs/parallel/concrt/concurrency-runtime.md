...
|[Exemples d’applications Windows Runtime](https://docs.microsoft.com/samples/browse/?languages=cpp&expanded=windows&products=windows-uwp)|Contient des exemples de code téléchargeables et des applications de démonstration pour Windows Runtime.|
