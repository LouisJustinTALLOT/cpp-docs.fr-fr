---
title: concordance namespace constantes
ms.date: 11/04/2016
f1_keywords:
...
ms.locfileid: "81372736"
---
# <a name="concurrency-namespace-constants"></a>concordance namespace constantes
...
|[ConcRT_ProviderGuid](#concrt_providerguid)|[ContexteEventGuid](#contexteventguid)|[INHERIT_THREAD_PRIORITY](#inherit_thread_priority)|
...
|[CalendrierGroupEventGuid](#schedulegroupeventguid)|[PlanificateurEventGuid](#schedulereventguid)|[VirtualProcessorEventGuid](#virtualprocessoreventguid)|
...
Cette catégorie d’événements n’est pas actuellement tirée par le Concurrency Runtime.
...
## <a name="contexteventguid"></a><a name="contexteventguid"></a>ContexteEventGuid
...
## <a name="schedulegroupeventguid"></a><a name="schedulegroupeventguid"></a>CalendrierGroupEventGuid
...
## <a name="schedulereventguid"></a><a name="schedulereventguid"></a>PlanificateurEventGuid
