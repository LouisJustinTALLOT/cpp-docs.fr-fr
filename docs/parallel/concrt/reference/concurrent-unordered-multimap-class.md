...
|Nom|Description|
|----------|-----------------|
|[concurrent_unordered_multimap](#ctor)|Surchargé. Construit un multimap non trié simultané.|
...
|[swap](#swap)|Échange le contenu de deux `concurrent_unordered_multimap` objets. Cette méthode n’est pas concurrentiel.|
|[unsafe_erase](#unsafe_erase)|Surchargé. Supprime les éléments de la `concurrent_unordered_multimap` aux positions spécifiées. Cette méthode n’est pas concurrentiel.|

### <a name="public-operators"></a>Op&#233;rateurs publics

|Nom|Description|
|----------|-----------------|
|[operator=](#operator_eq)|Surchargé. Assigne le contenu d’un autre `concurrent_unordered_multimap` objet à celui-ci. Cette méthode n’est pas concurrentiel.|
...
Construit un multimap non trié simultané.
...
Le premier constructeur spécifie un multimap initial vide et spécifie explicitement les fonctions de hachage et d’égalité et allocateur tapez le nombre de compartiments, pour être utilisé.

Le deuxième constructeur spécifie un allocateur du multimap non triée.

Le troisième constructeur spécifie les valeurs fournies par la plage d’itérateurs [ `_Begin`, `_End`).

Les quatrième et cinquième constructeurs spécifient une copie du multimap non triée simultanée `_Umap`.

Le dernier constructeur spécifie un déplacement du multimap non trié simultané `_Umap`.
...
Après avoir supprimé les éléments existants dans un multimap non trié simultané, `operator=` copie ou déplace le contenu de `_Umap` dans le multimap non trié simultané.
...
Supprime les éléments de la `concurrent_unordered_multimap` aux positions spécifiées. Cette méthode n’est pas concurrentiel.
...
La troisième fonction membre supprime les éléments dans la plage délimitée par `concurrent_unordered_multimap::equal_range`(KVal).
