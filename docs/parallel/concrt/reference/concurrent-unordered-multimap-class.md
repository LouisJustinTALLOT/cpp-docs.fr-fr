...
|[insert](#insert)|Surchargé. Ajoute des éléments à l’objet `concurrent_unordered_multimap`.|
...
|[unsafe_erase](#unsafe_erase)|Surchargé. Supprime des éléments de la `concurrent_unordered_multimap` aux positions spécifiées. Cette méthode n’est pas sécurisée pour la concurrence.|

### <a name="public-operators"></a>Op&#233;rateurs publics

|Name|Description|
|----------|-----------------|
|[operator=](#operator_eq)|Surchargé. Assigne le contenu d’un autre objet `concurrent_unordered_multimap` à celui-ci. Cette méthode n’est pas sécurisée pour la concurrence.|
...
*_Umap*<br/>
Objet `concurrent_unordered_multimap` source à partir duquel copier les éléments.
...
Les quatrième et cinquième constructeurs spécifient une copie de la `_Umap`Multimap non ordonnée simultanée.

Le dernier constructeur spécifie un déplacement de la `_Umap`Multimap non ordonnée simultanée.
...
Assigne le contenu d’un autre objet `concurrent_unordered_multimap` à celui-ci. Cette méthode n’est pas sécurisée pour la concurrence.
...
Référence à cet objet `concurrent_unordered_multimap`.

### <a name="remarks"></a>Notes

Après l’effacement des éléments existants dans un Multimap non ordonné simultané, `operator=` copie ou déplace le contenu de `_Umap` dans le Multimap non ordonné simultané.
...
*_Umap*<br/>
Objet `concurrent_unordered_multimap` à utiliser pour l’échange.
...
Supprime des éléments de la `concurrent_unordered_multimap` aux positions spécifiées. Cette méthode n’est pas sécurisée pour la concurrence.
