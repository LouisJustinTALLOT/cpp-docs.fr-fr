...
|[Concurrency Runtime](concrt/concurrency-runtime.md)|Classes qui simplifient l’écriture de programmes qui utilisent le parallélisme des données ou le parallélisme des tâches.|
...
|[Visual C++](../overview/visual-cpp-in-visual-studio.md)|Cette section de la documentation contient des informations sur la plupart des fonctionnalités de Visual C++.|