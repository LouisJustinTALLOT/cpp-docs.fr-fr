---
description: 'En savoir plus sur : exécution de programmes Linux sur Windows'
...
- Exécutez le programme tel quel dans une machine virtuelle Linux ou un conteneur Docker, sur votre ordinateur local ou sur Azure. Pour plus d’informations, consultez [Machines virtuelles](https://azure.microsoft.com/services/virtual-machines/) et [Docker sur Azure](/azure/docker/).
