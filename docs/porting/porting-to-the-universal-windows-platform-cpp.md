...
2. Ouvrez la fenêtre Propriétés du projet et, sous C++, Général, affectez v141 à la propriété Ensemble d’outils de plateforme, l’ensemble d’outils pour Visual Studio 2017.
