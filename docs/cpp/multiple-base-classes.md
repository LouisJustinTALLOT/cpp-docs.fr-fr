...
1. Si l'accès au nom ne respecte pas l'autorisation accès-membre, un message d'erreur est généré. (Pour plus d’informations, consultez [contrôle d’accès de membre](../cpp/member-access-control-cpp.md).)
