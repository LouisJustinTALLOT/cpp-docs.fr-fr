...
Le **decltype** spécificateur de type est pris en charge dans Visual Studio 2010 ou versions ultérieures et peut être utilisé avec le code natif ou managé. `decltype(auto)` (C++14) est pris en charge dans Visual Studio 2015 et versions ultérieures.
