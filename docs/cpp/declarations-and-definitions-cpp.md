...
2.  Contient le **extern** spécificateur mais aucun initialiseur (objets et variables) ou le corps de la fonction (fonctions). Cela signifie que la définition n'est pas nécessairement dans l'unité de traduction actuelle et donne une liaison externe au nom.  
