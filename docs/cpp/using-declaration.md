---
description: 'En savoir plus sur : déclaration using'
...
*déclarateur-liste* Liste séparée par des virgules des **`typename`** déclarateurs *Unqualified-ID* *imbriqués* [], suivi éventuellement d’un point de suspension.
