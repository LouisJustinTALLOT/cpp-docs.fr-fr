...
Les opérateurs **New** et **Delete** peuvent également être utilisés pour les types intégrés, y compris les tableaux. Si `pointer` fait référence à un tableau, placez les crochets vides (`[]`) avant `pointer`:
