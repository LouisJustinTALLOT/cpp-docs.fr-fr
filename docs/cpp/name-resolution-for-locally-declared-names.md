---
description: 'En savoir plus sur : résolution de noms pour les noms déclarés localement'
...
## <a name="example-specialization-versus-partial-specialization"></a>Exemple : spécialisation et spécialisation partielle
...
## <a name="example-name-conflict-between-template-parameter-and-object"></a>Exemple : conflit de nom entre le paramètre de modèle et l’objet
...
## <a name="example-define-member-function-outside-class-template"></a>Exemple : définir une fonction membre en dehors d’un modèle de classe
...
## <a name="example-define-template-or-member-function-outside-namespace"></a>Exemple : définir une fonction de modèle ou de membre en dehors de l’espace de noms
...
## <a name="example-base-class-or-member-name-hides-template-argument"></a>Exemple : la classe de base ou le nom de membre masque l’argument de modèle
