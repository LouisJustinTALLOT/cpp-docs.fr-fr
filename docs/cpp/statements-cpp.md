...
- [Instructions étiquetées](../cpp/labeled-statements.md)
...
- Catégories d’instructions
   ...
   - [Les instructions de déclaration](declarations-and-definitions-cpp.md). Déclarations d’introduisent un nom dans un programme.
