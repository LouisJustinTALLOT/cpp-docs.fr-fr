...
ms.locfileid: "80178104"
---
# <a name="keywords-c"></a>Mots clésC++()

Les mots clés sont des identificateurs réservés prédéfinis qui ont des significations particulières. Ils ne peuvent pas être utilisés comme identificateurs dans votre programme. Les mots clés suivants sont réservés pour Microsoft C++. Les noms avec des traits de soulignement de début etC++les noms suivis de (/CLI) sont des extensions Microsoft.

|||||
|-|-|-|-|
|[__abstract](../dotnet/declaration-of-a-managed-class-type.md) <sup>2</sup>|[opérateur __alignof](alignof-operator.md) <sup>4</sup>|[__asm](../assembler/inline/asm.md) <sup>4</sup>|[__assume](../intrinsics/assume.md) <sup>4</sup>|
...
|[__virtual_inheritance](inheritance-keywords.md) <sup>4</sup>|[__w64](w64.md) <sup>4</sup>|[__wchar_t](fundamental-types-cpp.md)|[abstrait](../extensions/abstract-cpp-component-extensions.md)(C++/CLI)|
|[alignas](align-cpp.md)|[tableau](../extensions/arrays-cpp-component-extensions.md)(C++/CLI)|[auto](auto-keyword.md)|[bool](bool-cpp.md)|
...
|[default](switch-statement-cpp.md)|[délégué](../extensions/delegate-cpp-component-extensions.md)(C++/CLI)|[delete](delete-operator-cpp.md)|[obsolète](deprecated-cpp.md) <sup>1</sup>|
...
|[enum struct](../extensions/enum-class-cpp-component-extensions.md)|[événement](../extensions/event-cpp-component-extensions.md)(C++/CLI)|[explicit](user-defined-type-conversions-cpp.md)|[extern](using-extern-to-specify-linkage.md)|
|[false](false-cpp.md)|[finally](../dotnet/finally.md)|[float](fundamental-types-cpp.md)|[for](for-statement-cpp.md)|
|[pour chaque dans](../dotnet/for-each-in.md)|[friend](friend-cpp.md)|[friend_as](../preprocessor/hash-using-directive-cpp.md)|[gcnew](../extensions/ref-new-gcnew-cpp-component-extensions.md)(C++/CLI)|
|[générique](../extensions/generics-cpp-component-extensions.md)(C++/CLI)|[goto](goto-statement-cpp.md)|[if](if-else-statement-cpp.md)|[initonly](../dotnet/initonly-cpp-cli.md)|
|[Inline](inline-functions-cpp.md)|[int](fundamental-types-cpp.md)|[classe](../extensions/interface-class-cpp-component-extensions.md)d’interfaceC++(/CLI)|[struct](../extensions/interface-class-cpp-component-extensions.md)d’interfaceC++(/CLI)|
|[interior_ptr](../extensions/interior-ptr-cpp-cli.md)(C++/CLI)|[littéral](../extensions/literal-cpp-component-extensions.md)(C++/CLI)|[long](fundamental-types-cpp.md)|[mutable](mutable-data-members-cpp.md)|
|[Naked](naked-cpp.md) <sup>1</sup>|[namespace](namespaces-cpp.md)|[nouveau](../extensions/new-new-slot-in-vtable-cpp-component-extensions.md)(C++/CLI)|[nouveau](new-operator-cpp.md)|
...
|[propriété](../extensions/property-cpp-component-extensions.md)(C++/CLI)|[propriété](property-cpp.md) <sup>1</sup>|[protected](protected-cpp.md)|[public](public-cpp.md)|
...
|Déclaration [using](using-declaration.md)|[using](namespaces-cpp.md#using_directives) , directive|[UUID](uuid-cpp.md) <sup>1</sup>|[classe value](../extensions/classes-and-structs-cpp-component-extensions.md)(C++/CLI)|
|[struct value](../extensions/classes-and-structs-cpp-component-extensions.md)(C++/CLI)|[virtual](virtual-cpp.md)|[void](void-cpp.md)|[volatile](volatile-cpp.md)|
|[while](while-statement-cpp.md)|

<sup>1</sup> attributs étendus pour le mot clé **__declspec** .

<sup>2</sup> applicable aux extensions managées C++ pour uniquement. Cette syntaxe est maintenant déconseillée. Pour plus d’informations, consultez [extensions de composant pour les plateformes Runtime](../extensions/component-extensions-for-runtime-platforms.md) .

<sup>3</sup> fonction intrinsèque utilisée dans la gestion des événements.

<sup>4</sup> pour la compatibilité descendante avec les versions précédentes, ces mots clés sont disponibles à la fois avec deux traits de soulignement de début et un trait de soulignement simple lorsque les extensions Microsoft sont activées (valeur par défaut).
...
Lorsque les extensions Microsoft sont activées, vous pouvez utiliser les mots clés Microsoft spécifiques dans vos programmes. Pour la compatibilité ANSI, ces mots clés sont précédés d'un trait de soulignement double. Pour la compatibilité descendante, les versions à un seul trait de soulignement d’un grand nombre de mots clés à deux traits de soulignement sont prises en charge. En outre, **__cdecl** est disponible sans trait de soulignement de début.

Le **__asm** mot clé __asm C++ remplace `asm` syntaxe. `asm` est réservé pour la compatibilité avec d'autres implémentations C++, mais n'est pas implémenté. Utilisez **__asm**.
