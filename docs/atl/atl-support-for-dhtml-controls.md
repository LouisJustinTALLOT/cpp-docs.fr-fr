...
- Accède à l’objet WebBrowser et ses méthodes via son interface, [IWebBrowser2](/previous-versions/windows/internet-explorer/ie-developer/platform-apis/aa752127\(v=vs.85\)).
...
[Appel de code C++ à partir de DHTML](../atl/calling-cpp-code-from-dhtml.md)<br/>
...
[Test du contrôle modifié ATL DHTML](../atl/testing-the-modified-atl-dhtml-control.md)<br/>
