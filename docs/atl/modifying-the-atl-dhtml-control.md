...
1. Ajoutez une troisième méthode, `GoToURL`, à l’interface qui ne se termine pas dans « L’interface utilisateur. » Implémentez cette méthode en appelant [IWebBrowser2::Navigate](/previous-versions//aa752133\(v=vs.85\)), comme suit :
