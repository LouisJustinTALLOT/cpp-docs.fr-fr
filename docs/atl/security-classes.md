---
title: Classes de sécurité (ATL) | Documents Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-atl
...
-   [CSecurityAttributes](../atl/reference/csecurityattributes-class.md) cette classe est un wrapper mince pour le **SECURITY_ATTRIBUTES** structure.  
