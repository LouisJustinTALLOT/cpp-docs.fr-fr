...
#### <a name="parameters"></a>Paramètres  
 `StringType`  
 La classe de chaîne ATL/MFC à utiliser pour le chemin d’accès (voir [CStringT](../../atl-mfc-shared/reference/cstringt-class.md)).  
...
|[CPathT::CompactPath](#compactpath)|Appelez cette méthode pour tronquer un chemin d’accès de fichier pour s’ajuster au sein d’une largeur de pixel donné en remplaçant les composants de chemin d’accès avec les points de suspension.|  
|[CPathT::CompactPathEx](#compactpathex)|Appelez cette méthode pour tronquer un chemin d’accès de fichier pour tenir dans un certain nombre de caractères en remplaçant les composants de chemin d’accès avec les points de suspension.|  
|[CPathT::FileExists](#fileexists)|Appelez cette méthode pour vérifier si le fichier de ce nom de chemin d’accès existe.|  
...
|[CPathT::GetExtension](#getextension)|Appelez cette méthode pour obtenir de l’extension de fichier dans le chemin d’accès.|  
|[CPathT::IsDirectory](#isdirectory)|Appelez cette méthode pour vérifier si le chemin d’accès est un répertoire valide.|  
|[CPathT::IsFileSpec](#isfilespec)|Appelez cette méthode pour rechercher un chemin d’accès pour tous les caractères de délimitation de chemin d’accès (par exemple, ' :' ou '\\'). S’il n’y a aucun caractère délimiteur de chemin d’accès est présent, le chemin d’accès est considéré comme un chemin d’accès de la spécification de fichier.|  
...
|[CPathT::IsSameRoot](#issameroot)|Appelez cette méthode pour déterminer si un autre chemin est un composant racine commun avec le chemin d’accès actuel.|  
|[CPathT::IsUNC](#isunc)|Appelez cette méthode pour déterminer si le chemin d’accès est un chemin d’accès UNC (universal convention d’affectation de noms) valide pour un serveur et le partager.|  
|[CPathT::IsUNCServer](#isuncserver)|Appelez cette méthode pour déterminer si le chemin d’accès est un chemin d’accès UNC (universal convention d’affectation de noms) valide pour un seul serveur.|  
|[CPathT::IsUNCServerShare](#isuncservershare)|Appelez cette méthode pour déterminer si le chemin d’accès est un chemin de partage UNC (universal convention d’affectation de noms) valid, \\ \  *server*\ *partager*.|  
...
|[CPathT::RemoveFileSpec](#removefilespec)|Appelez cette méthode pour supprimer le chemin d’accès, le nom de fichier à droite et la barre oblique inverse si elle en possède.|  
...
|[CPathT::UnquoteSpaces](#unquotespaces)|Appelez cette méthode pour supprimer des guillemets au début et la fin d’un chemin d’accès.|  
...
##  <a name="addbackslash"></a>  CPathT::AddBackslash  
 Appelez cette méthode pour ajouter une barre oblique inverse à la fin d’une chaîne pour créer la syntaxe correcte pour un chemin d’accès. Si le chemin d’accès comporte déjà une barre oblique, aucune barre oblique inverse ne sera ajoutée.  
...
##  <a name="compactpath"></a>  CPathT::CompactPath  
 Appelez cette méthode pour tronquer un chemin d’accès de fichier pour s’ajuster au sein d’une largeur de pixel donné en remplaçant les composants de chemin d’accès avec les points de suspension.  
...
##  <a name="compactpathex"></a>  CPathT::CompactPathEx  
 Appelez cette méthode pour tronquer un chemin d’accès de fichier pour tenir dans un certain nombre de caractères en remplaçant les composants de chemin d’accès avec les points de suspension.  
...
##  <a name="fileexists"></a>  CPathT::FileExists  
 Appelez cette méthode pour vérifier si le fichier de ce nom de chemin d’accès existe.  
...
##  <a name="getextension"></a>  CPathT::GetExtension  
 Appelez cette méthode pour obtenir de l’extension de fichier dans le chemin d’accès.  
...
##  <a name="isfilespec"></a>  CPathT::IsFileSpec  
 Appelez cette méthode pour rechercher un chemin d’accès pour tous les caractères de délimitation de chemin d’accès (par exemple, ' :' ou '\\'). S’il n’y a aucun caractère délimiteur de chemin d’accès est présent, le chemin d’accès est considéré comme un chemin d’accès de la spécification de fichier.  
...
##  <a name="issameroot"></a>  CPathT::IsSameRoot  
 Appelez cette méthode pour déterminer si un autre chemin est un composant racine commun avec le chemin d’accès actuel.  
...
##  <a name="isunc"></a>  CPathT::IsUNC  
 Appelez cette méthode pour déterminer si le chemin d’accès est un chemin d’accès UNC (universal convention d’affectation de noms) valide pour un serveur et le partager.  
...
##  <a name="isuncserver"></a>  CPathT::IsUNCServer  
 Appelez cette méthode pour déterminer si le chemin d’accès est un chemin d’accès UNC (universal convention d’affectation de noms) valide pour un seul serveur.  
...
##  <a name="isuncservershare"></a>  CPathT::IsUNCServerShare  
 Appelez cette méthode pour déterminer si le chemin d’accès est un chemin de partage UNC (universal convention d’affectation de noms) valid, \\ \  *server*\ *partager*.  
...
### <a name="return-value"></a>Valeur de retour  
 Retourne la valeur TRUE si le chemin d’accès est sous la forme \\ \  *server*\ *partager*, ou FALSE dans le cas contraire.  
...
### <a name="parameters"></a>Paramètres  
 `pszSpec`  
 Pointeur vers une chaîne se terminant par null avec le type de fichier à rechercher. Par exemple, pour vérifier si le fichier sur le chemin d’accès actuel est un fichier DOC, `pszSpec` doit être défini sur « * .doc ».  
...
##  <a name="operator_const_stringtype_amp"></a>  StringType const de CPathT::operator &amp;  
...
##  <a name="removefilespec"></a>  CPathT::RemoveFileSpec  
 Appelez cette méthode pour supprimer le chemin d’accès, le nom de fichier à droite et la barre oblique inverse si elle en possède.  
...
##  <a name="skiproot"></a>  CPathT::SkipRoot  
 Appelez cette méthode pour analyser un chemin d’accès, en ignorant la lettre de lecteur ou les parties de chemin d’accès UNC (universal convention d’affectation de noms) / partage de serveur.  
...
### <a name="return-value"></a>Valeur de retour  
 Retourne la position de début de la sous-chemin qui suit la racine (lettre de lecteur ou UNC/partage de serveur).  
...
##  <a name="unquotespaces"></a>  CPathT::UnquoteSpaces  
 Appelez cette méthode pour supprimer des guillemets au début et la fin d’un chemin d’accès.  
