...
*rect*<br/>
[in] Un [RECT](/previous-versions/dd162897\(v=vs.85\)) structure spécifiant la position de la fenêtre. Le `RECT` peuvent être passés par pointeur ou par référence.
