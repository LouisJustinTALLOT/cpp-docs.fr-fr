...
*Rect*<br/>
[dans] Une structure [RECT](/previous-versions/dd162897\(v=vs.85\)) spécifiant la position de la fenêtre. Le `RECT` peut être passé par pointeur ou par référence.
