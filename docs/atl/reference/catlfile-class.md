...
|[CAtlFile::GetSize](#getsize)|Appelez cette méthode pour récupérer la taille en octets du fichier.|
...
|[CAtlFile::Read](#read)|Appelez cette méthode pour lire les données d’un fichier en commençant à la position indiquée par le pointeur de fichier.|
