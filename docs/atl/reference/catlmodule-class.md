...
Semblable à [CAtlModule :: UpdateRegistryFromResourceD](#updateregistryfromresourced) , sauf que `CAtlModule::UpdateRegistryFromResourceS` crée un lien statique vers le composant de Registre ATL.
