---
title: Fonctions ATL | Documents Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-atl
...
ms.locfileid: "34257098"
---
# <a name="atl-functions"></a>Fonctions ATL


Pour rechercher une fonction ATL par catégorie, consultez les rubriques suivantes.  
 ...
 Prendre en charge pour le mappage COM **IUnknown** implémentations.  
  
 [Fonctions globales de contrôle composite](../../atl/reference/composite-control-global-functions.md)  
 Prennent en charge pour la création de boîtes de dialogue et de création, d’hébergement et de licences des contrôles ActiveX.  
  
 [Fonctions globales de point de connexion](../../atl/reference/connection-point-global-functions.md)  
 Prennent en charge les points de connexion et les tables de récepteurs.  
 ...
 Fournir des fonctionnalités de débogage et le traçage utiles.  
  
 [Fonctions globales de contexte d’appareil](../../atl/reference/device-context-global-functions.md)  
 Crée un contexte de périphérique pour un périphérique donné.  
 ...
 Prennent en charge pour le marshaling et la conversion de marshaling des données dans des pointeurs d’interface.  
  
 [Fonctions de Conversion de pixel/HIMETRIC Global](../../atl/reference/pixel-himetric-conversion-global-functions.md)  
 Conversion vers et depuis le pixel et unités HIMETRIC prennent en charge.  
 ...
 Pour modifier des objets de SID et ACL, prennent en charge.  
 ...
 Prennent en charge l’inscription et la désinscription des objets serveur dans la table des objets.  
  
 [Fonctions globales WinModule](../../atl/reference/winmodule-global-functions.md)  
 Assure la prise en charge pour `_AtlCreateWndData` les opérations de la structure.  
