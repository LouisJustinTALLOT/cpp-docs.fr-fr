...
L’exemple suivant regroupe les entrées pour `IMyDual1` suivies d’une entrée pour `IMyDual2` . Le regroupement par interface double permet d’améliorer les performances.
