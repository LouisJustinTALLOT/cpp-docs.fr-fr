...
### <a name="remarks"></a>Notes  
 ATL entre cette description dans la table d’objets via le [OBJECT_ENTRY](http://msdn.microsoft.com/abd10ee2-54f0-4f94-9ec2-ddf8f4c8c8cd) macro.  
