...
*T*<br/>
Votre classe, dérivée `IConnectionPointImpl`de.
...
|[IConnectionPointImpl::Unadvise](#unadvise)|Met fin à une connexion précédemment établie `Advise`par le biais de.|
