...
|||
|-|-|
|[Create](#create)|Crée une boîte de dialogue non modale.|
...
**RECT &** *rect* [in] A [RECT](/previous-versions/dd162897\(v=vs.85\)) structure qui spécifie la taille et la position de la boîte de dialogue.
