...
*pUnkCP*<br/>
dans Pointeur vers le `IUnknown` de l’objet avec lequel le client souhaite se connecter.

*pUnk*<br/>
dans Pointeur vers le du client `IUnknown` .
...
*pUnkCP*<br/>
dans Pointeur vers le `IUnknown` de l’objet avec lequel le client est connecté.
