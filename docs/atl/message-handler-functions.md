---
description: 'En savoir plus sur : fonctions de gestionnaire de messages'
title: Fonctions de gestionnaire de messages
ms.date: 11/04/2016
ms.topic: reference
helpviewer_keywords:
...
ms.locfileid: "97159568"
---
# <a name="message-handler-functions"></a>Fonctions de gestionnaire de messages

ATL fournit trois types de fonctions de gestionnaire de messages :

|Type de gestionnaire de messages|Macro de message correspondante|
|-----------------------------|---------------------------------|
