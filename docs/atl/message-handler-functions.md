---
title: Fonctions gestionnaires de messages | Documents Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-atl
...
ms.locfileid: "32355605"
---
# <a name="message-handler-functions"></a>Fonctions gestionnaires de messages
ATL fournit trois types de fonctions gestionnaires de messages :  
