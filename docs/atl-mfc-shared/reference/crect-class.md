...
*size*<br/>
Structure de [taille](/windows/win32/api/windef/ns-windef-size) ou objet de `CSize` qui spécifie le nombre d’unités de déplacement de la valeur de retour.
