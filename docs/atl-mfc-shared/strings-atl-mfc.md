...
ms.locfileid: "57742568"
---
# <a name="strings-atlmfc"></a>Chaînes (ATL/MFC)

Presque tous les programmes fonctionnent avec les données de type chaîne. Visual C++ propose plusieurs façons de gérer les données de type chaîne.
