---
description: 'En savoir plus sur : fonctions intrinsèques de _InterlockedExchange'
...
Pour obtenir un exemple d’utilisation de `_InterlockedExchange` , consultez [_InterlockedDecrement](../intrinsics/interlockeddecrement-intrinsic-functions.md).
