...
Un fichier d’en-tête, \<intrin.h> , est disponible qui déclare des prototypes pour les fonctions intrinsèques communes. Les intrinsèques spécifiques au fabricant sont disponibles dans \<immintrin.h> les \<ammintrin.h> fichiers d’en-tête et. En outre, certains en-têtes Windows déclarent des fonctions qui mappent à une intrinsèque du compilateur.
...
- [Intrinsèques ARM64](../intrinsics/arm64-intrinsics.md)

- [Liste des intrinsèques x86](../intrinsics/x86-intrinsics-list.md)
...
- [Liste alphabétique des intrinsèques](../intrinsics/alphabetical-listing-of-intrinsic-functions.md)
