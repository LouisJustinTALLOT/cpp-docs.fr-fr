---
title: x64 (amd64) liste de fonctions intrinsèques
ms.date: 04/18/2019
helpviewer_keywords:
...
ms.locfileid: "59982406"
---
# <a name="x64-amd64-intrinsics-list"></a>x64 (amd64) liste de fonctions intrinsèques
...
|[_InterlockedCompareExchange_np](interlockedcompareexchange-intrinsic-functions.md)||intrin.h|_InterlockedCompareExchange_np long (long \*, long, long)|
...
|[__readgsword](readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin.h|__readgsword(unsigned long) court non signé|
...
[x86 intrinsèques](x86-intrinsics-list.md)