...
`_disable` Indique le processeur efface l’indicateur d’interruption. Sur les systèmes x86, cette fonction génère l'instruction d'effacement de l'indicateur d'interruption (`cli`).
