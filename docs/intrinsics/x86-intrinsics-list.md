---
title: x86 liste de fonctions intrinsèques
ms.date: 04/18/2019
helpviewer_keywords:
...
ms.locfileid: "62389643"
---
# <a name="x86-intrinsics-list"></a>x86 liste de fonctions intrinsèques

Ce document répertorie les intrinsèques que le Microsoft C /C++ compilateur prend en charge quand x86 est ciblé.
...
|_addcarry_u8||intrin.h|unsigned char _addcarry_u8 (unsigned char, char unsigned, unsigned char, char unsigned \*)|
...
|[_AddressOfReturnAddress](addressofreturnaddress.md)||intrin.h|void \* _AddressOfReturnAddress|
...
|[__indword](indword.md)||intrin.h|__indword(unsigned short) long non signé|
...
|[_InterlockedAnd8](interlockedand-intrinsic-functions.md)||intrin.h|char _InterlockedAnd8 (volatile de char \*, char)|
...
|[_InterlockedCompareExchange8](interlockedcompareexchange-intrinsic-functions.md)||intrin.h|char _InterlockedCompareExchange8 (volatile de char \*, char, char)|
...
|[_InterlockedExchange8](interlockedexchange-intrinsic-functions.md)||intrin.h|char _InterlockedExchange8 (volatile de char \*, char)|
...
|[_InterlockedExchangeAdd8](interlockedexchangeadd-intrinsic-functions.md)||intrin.h|char _InterlockedExchangeAdd8 (volatile de char \*, char)|
...
|[_InterlockedOr_HLEAcquire](interlockedor-intrinsic-functions.md)|HLE [2]|immintrin.h|_InterlockedOr_HLEAcquire long (long volatile \*, long)|
|[_InterlockedOr_HLERelease](interlockedor-intrinsic-functions.md)|HLE [2]|immintrin.h|_InterlockedOr_HLERelease long (long volatile \*, long)|
|[_InterlockedOr16](interlockedor-intrinsic-functions.md)||intrin.h|short _InterlockedOr16 (short volatile \*, short)|
|[_InterlockedOr8](interlockedor-intrinsic-functions.md)||intrin.h|char _InterlockedOr8 (volatile de char \*, char)|
...
|[_InterlockedXor8](interlockedxor-intrinsic-functions.md)||intrin.h|char _InterlockedXor8 (volatile de char \*, char)|
...
|[__inword](inword.md)||intrin.h|__inword(unsigned short) court non signé|
...
|_load_be_u16<br /><br /> [_loadbe_i16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_loadbe_i16&expand=3071)|MOVBE|immintrin.h|_load_be_u16 court non signé (void const\*) ;<br /><br /> short _loadbe_i16(void const\*); [3]|
...
|[_mm_set_pi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_set_pi16)|MMX|intrin.h|__m64 _mm_set_pi16 (court, court, short, short)|
...
|[_mm_setr_epi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_setr_epi16)|SSE2|intrin.h|__m128i _mm_setr_epi16 (short, short, short, bref, bref, bref, short, short)|
...
|[_mm_setr_pi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_setr_pi16)|MMX|intrin.h|__m64 _mm_setr_pi16 (court, court, short, short)|
...
|[__movsw](movsw.md)||intrin.h|void __movsw (unsigned short \*, const court non signé \*, size_t)|
...
|[__readfsword](readfsbyte-readfsdword-readfsqword-readfsword.md)||intrin.h|__readfsword(unsigned long) court non signé|
...
|[_ReturnAddress](returnaddress.md)||intrin.h|void \* _ReturnAddress|
|_rorx_u32|BMI [2]|immintrin.h|unsigned int _rorx_u32 (unsigned int, const int non signé)|
|[_rotl16](rotl8-rotl16.md)||intrin.h|unsigned short _rotl16 (unsigned short, unsigned char)|
|[_rotl8](rotl8-rotl16.md)||intrin.h|unsigned char _rotl8 (unsigned char, char unsigned)|
|[_rotr16](rotr8-rotr16.md)||intrin.h|unsigned short _rotr16 (unsigned short, unsigned char)|
|[_rotr8](rotr8-rotr16.md)||intrin.h|unsigned char _rotr8 (unsigned char, char unsigned)|
...
|_subborrow_u8||intrin.h|unsigned char _subborrow_u8 (unsigned char, char unsigned, unsigned char, char unsigned \*)|
...
[Intrinsèques du compilateur](compiler-intrinsics.md)<br/>
[Fonctions intrinsèques ARM](arm-intrinsics.md)<br/>
