...
ms.locfileid: "78215489"
---
# <a name="x86-intrinsics-list"></a>Liste des intrinsèques x86

Ce document répertorie les intrinsèques pris en chargeC++ par le compilateur Microsoft C/lorsque x86 est ciblé.
...
|[_m_pmovmskb](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_m_pmovmskb)|SSE|intrin.h|_m_pmovmskb int (\__m64)|
...
|[_m_to_int](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_m_to_int)|MMX|intrin.h|_m_to_int int (\__m64)|
