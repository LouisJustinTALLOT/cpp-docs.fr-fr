---
title: Intrinsèques disponibles sur toutes les architectures
ms.date: 09/02/2019
helpviewer_keywords:
...
ms.locfileid: "70217534"
---
# <a name="intrinsics-available-on-all-architectures"></a>Intrinsèques disponibles sur toutes les architectures

Le compilateur Microsoft CC++ /et la bibliothèque Runtime c universel (UCRT) rendent certaines fonctions intrinsèques disponibles sur toutes les architectures.

## <a name="compiler-intrinsics"></a>Intrinsèques du compilateur

Les intrinsèques suivants sont disponibles avec les architectures x86, AMD64, ARM et ARM64 :
...
__code_seg | [__debugbreak](../intrinsics/debugbreak.md)| Intro. h | | [Disable](../intrinsics/disable.md)| Intro. h | | _ [activer | Intro. h | |](../intrinsics/enable.md) [__fastfail](../intrinsics/fastfail.md)| Intro. h | | [_InterlockedAnd](../intrinsics/interlockedand-intrinsic-functions.md)| Intro. h | | [_InterlockedAnd16](../intrinsics/interlockedand-intrinsic-functions.md)| Intro. h | | [_InterlockedAnd8](../intrinsics/interlockedand-intrinsic-functions.md)| Intro. h | | [_interlockedbittestandreset](../intrinsics/interlockedbittestandreset-intrinsic-functions.md)| Intro. h | | [_interlockedbittestandset](../intrinsics/interlockedbittestandset-intrinsic-functions.md)| Intro. h | | [_InterlockedCompareExchange](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)| Intro. h | | [_InterlockedCompareExchange16](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)| Intro. h | | [_InterlockedCompareExchange8](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)| Intro. h | | [_InterlockedCompareExchangePointer](../intrinsics/interlockedcompareexchangepointer-intrinsic-functions.md)| Intro. h | | [_InterlockedDecrement](../intrinsics/interlockeddecrement-intrinsic-functions.md)| Intro. h | | [_InterlockedDecrement16](../intrinsics/interlockeddecrement-intrinsic-functions.md)| Intro. h | | [_InterlockedExchange](../intrinsics/interlockedexchange-intrinsic-functions.md)| Intro. h | | [_InterlockedExchange16](../intrinsics/interlockedexchange-intrinsic-functions.md)| Intro. h | | [_InterlockedExchange8](../intrinsics/interlockedexchange-intrinsic-functions.md)| Intro. h | | [_InterlockedExchangeAdd](../intrinsics/interlockedexchangeadd-intrinsic-functions.md)| Intro. h | | [_InterlockedExchangeAdd16](../intrinsics/interlockedexchangeadd-intrinsic-functions.md)| Intro. h | | [_InterlockedExchangeAdd8](../intrinsics/interlockedexchangeadd-intrinsic-functions.md)| Intro. h | | [_InterlockedExchangePointer](../intrinsics/interlockedexchangepointer-intrinsic-functions.md)| Intro. h | | [_InterlockedIncrement](../intrinsics/interlockedincrement-intrinsic-functions.md)| Intro. h | | [_InterlockedIncrement16](../intrinsics/interlockedincrement-intrinsic-functions.md)| Intro. h | | [_InterlockedOr](../intrinsics/interlockedor-intrinsic-functions.md)| Intro. h | | [_InterlockedOr16](../intrinsics/interlockedor-intrinsic-functions.md)| Intro. h | | [_InterlockedOr8](../intrinsics/interlockedor-intrinsic-functions.md)| Intro. h | | [_InterlockedXor](../intrinsics/interlockedxor-intrinsic-functions.md)| Intro. h | | [_InterlockedXor16](../intrinsics/interlockedxor-intrinsic-functions.md)| Intro. h | | [_InterlockedXor8](../intrinsics/interlockedxor-intrinsic-functions.md)| Intro. h | | [__nop](../intrinsics/nop.md)| Intro. h | | [_ReadBarrier](../intrinsics/readbarrier.md)| Intro. h | | [_ReadWriteBarrier](../intrinsics/readwritebarrier.md)| Intro. h | | [_ReturnAddress](../intrinsics/returnaddress.md)| Intro. h | | [_rotl16](../intrinsics/rotl8-rotl16.md)| Intro. h | | [_rotl8](../intrinsics/rotl8-rotl16.md)| Intro. h | | [_rotr16](../intrinsics/rotr8-rotr16.md)| Intro. h | | [_rotr8](../intrinsics/rotr8-rotr16.md)| Intro. h | | [_WriteBarrier](../intrinsics/writebarrier.md)| Intro. h |

## <a name="ucrt-intrinsics"></a>UCRT intrinsèques
...
[x86, liste de fonctions intrinsèques](../intrinsics/x86-intrinsics-list.md)<br/>
[x64 (amd64), liste de fonctions intrinsèques](../intrinsics/x64-amd64-intrinsics-list.md)<br/>
