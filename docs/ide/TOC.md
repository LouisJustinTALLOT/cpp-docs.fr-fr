...
# [Projets Ouvrir un dossier](non-msbuild-projects.md)
...
# [Projets CMake](cmake-tools-for-visual-cpp.md)
...
# [Projets MSBuild](creating-and-managing-visual-cpp-projects.md)
## [Types de projets dans Visual C++](visual-cpp-project-types.md)
## [Modèles Ajouter un nouvel élément dans Visual C++](using-visual-cpp-add-new-item-templates.md)
...
## [Étiquettes recommandées pour les commentaires de documentation (Visual C++)](recommended-tags-for-documentation-comments-visual-cpp.md)
...
## [Délimiteurs pour les étiquettes de documentation Visual C++](delimiters-for-visual-cpp-documentation-tags.md)
