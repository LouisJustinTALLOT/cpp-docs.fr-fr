...
# [CMake et autres projets non MSBuild dans Visual C++](non-msbuild-projects.md)
## [Projets CMake dans Visual C++](cmake-tools-for-visual-cpp.md)
# [Projets MSBuild dans Visual C++](creating-and-managing-visual-cpp-projects.md)
...
## [Parcours de la structure de classes (Visual C++)](navigating-the-class-structure-visual-cpp.md)
