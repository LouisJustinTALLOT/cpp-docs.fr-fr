...
- Créez un fichier .props qui spécifie les propriétés à remplacer. 
...
## <a name="see-also"></a>Voir aussi  
 [Création et gestion de projets Visual C++](../ide/creating-and-managing-visual-cpp-projects.md) [Structure des fichiers .vcxproj et .props](vcxproj-file-structure.md) [Page de propriétés, Fichiers XML](property-page-xml-files.md)