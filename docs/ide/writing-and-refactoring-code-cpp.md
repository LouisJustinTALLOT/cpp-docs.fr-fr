...
Certains symboles sont omis automatiquement afin de limiter les résultats dans la mesure du possible. Par exemple, lorsque vous accédez aux membres d’un objet de classe à l’extérieur de la classe, vous ne pourrez pas voir des membres privés par défaut ou des membres protégés (si vous n’êtes pas dans le contexte d’une classe d’enfants). Vous pouvez ajuster le filtrage en utilisant les boutons en bas.

Après avoir choisi le symbole de la liste de drop-down, vous pouvez l’autocompleter avec `{ } [ ] ( ) . , : ; + - * / % & | ^ ! = ? @ # \` **Onglet**, **Entrez**, ou l’un des autres personnages de validation (par défaut: ). Pour ajouter ou supprimer des caractères dans cette liste, recherchez « IntelliSense » dans **Lancement rapide** (Ctrl+Q) et choisissez l’option **Éditeur de texte > C/C++ > Avancé**. L’option **Caractères de validation des listes de membres** vous permet de personnaliser la liste avec les modifications de votre choix.
...
Dans Visual Studio 2019, IntelliCode est disponible en tant que composant facultatif dans la charge de travail **Développement Desktop en C++**. Pour vous assurer qu’IntelliCode est actif pour le C, rendez-vous sur **Tools** > **Options** > **IntelliCode** > **General** et définissez le modèle de base **CMD** sur **Activé**.
...
Pour passer outre **Prédictive IntelliSense** et montrer la liste plus longue, appuyez sur **Ctrl J**. Si **l’intelliSense prédictive** est allumé, invoquant **Ctrl J** supprime le filtre prédictif. Le fait de réappuyer sur **Ctrl+J** supprime le filtre d’accessibilité des résultats de la liste de membres le cas échéant. Le bouton ([]) sous la liste d’abandon IntelliSense fait la même chose que **Ctrl J**. Planer sur le bouton pour voir les informations tooltip sur ce qui est affiché.

![C&#43;&#43; IntelliSense prédictive](../ide/media/predictive-intellisense-cpp.png "IntelliSense prédictive")
...
![C&#43;&#43; Template IntelliSense Afficher les instantanés existants](../ide/media/template-intellisense-cpp-1.png "Template IntelliSense Afficher les instantanés existants")

Cliquez ** \<** sur l’icône T>pour étendre / effondrer la **barre Template**. Cliquez sur l’icône en forme de crayon ou double-cliquez sur la **Barre de modèles** pour ouvrir la fenêtre **Modifier**.

![C&#43;&#43; Template IntelliSense](../ide/media/template-intellisense-cpp-3.png "Modèle IntelliSense")
...
![C&#43;&#43; Template IntelliSense Results List](../ide/media/template-intellisense-cpp-2.png "Template Liste des résultats IntelliSense")

Une fenêtre en bas de l’éditeur indique où chaque instanciation a été trouvée et quels étaient ses arguments.

![Carte d’instantanéiation C&#43;&#43; Template IntelliSense](../ide/media/template-intellisense-cpp-4.png "Carte d’instantiation De Template IntelliSense")
...
![C&#43;&#43; solution rapide](../ide/media/quick-fix-for-header-cpp.png "Correction rapide de CMD")
...
![C&#43;&#43; solution rapide](../ide/media/quick-fix.png "Correction rapide de CMD")
...
![C&#43;&#43; le suivi des changements](../ide/media/change-tracking-cpp.png "Suivi des modifications")
...
![C&#43;&#43; Insérer Snippet Drop&#45;vers le bas](../ide/media/vs2015_cpp_surround_with.png "vs2015_cpp_surround_with")
...
- [Convertir en string analphabète](refactoring/convert-to-raw-string-literal.md)
...
![Lancement rapide Visual Studio](../ide/media/vs2015_cpp_quick_launch.png "Lancement rapide")
