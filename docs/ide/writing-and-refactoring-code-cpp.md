...
Pour remplacer la **fonctionnalité IntelliSense prédictive** afin d’afficher la liste plus longue, appuyez sur **Ctrl+J**. Si la **fonctionnalité IntelliSense prédictive** est activée, l’appel de **Ctrl+J** supprime le filtre prédictif. Le fait de réappuyer sur **Ctrl+J** supprime le filtre d’accessibilité des résultats de la liste de membres le cas échéant. Le bouton ([+]) sous la liste déroulante IntelliSense fait la même chose que **Ctrl+J**. Pointez sur le bouton pour voir une info-bulle sur ce qui est affiché.

![Fonctionnalité IntelliSense prédictive, C&#43;&#43;](../ide/media/predictive-intellisense-cpp.png "Fonctionnalité IntelliSense prédictive")
...
![Fonctionnalité IntelliSense du modèle pour l’affichage des instanciations existantes, C&#43;&#43;](../ide/media/template-intellisense-cpp-1.png "Fonctionnalité IntelliSense du modèle pour l’affichage des instanciations existantes")

Cliquez sur l’icône **<T>** pour développer/réduire la **Barre de modèles**. Cliquez sur l’icône en forme de crayon ou double-cliquez sur la **Barre de modèles** pour ouvrir la fenêtre **Modifier**. 

![Fonctionnalité IntelliSense du modèle, C&#43;&#43;](../ide/media/template-intellisense-cpp-3.png "Fonctionnalité IntelliSense du modèle")
...
![Liste des résultats de la fonctionnalité IntelliSense du modèle, C&#43;&#43;](../ide/media/template-intellisense-cpp-2.png "Liste des résultats de la fonctionnalité IntelliSense du modèle")

Une fenêtre en bas de l’éditeur indique où chaque instanciation a été trouvée et quels étaient ses arguments.

![Mappage des instanciations avec la fonctionnalité IntelliSense du modèle, C&#43; &#43;](../ide/media/template-intellisense-cpp-4.png "Mappage des instanciations avec la fonctionnalité IntelliSense du modèle")
...
![Correctif rapide C&#43;&#43;](../ide/media/quick-fix-for-header-cpp.png "Correctif rapide C++")
...
![Correctif rapide C&#43;&#43;](../ide/media/quick-fix.png "Correctif rapide C++")
...
![Liste déroulante Insérer un extrait de code, C&#43;&#43;](../ide/media/vs2015_cpp_surround_with.png "vs2015_cpp_surround_with")
...
![Ajouter une nouvelle classe dans C#&#43;&#43;](../ide/media/vs2017-add-class.png "vs2015_cpp_add_class")
...
![Format Clang, C&#43;&#43;](../ide/media/clang-format-cpp.png "Format Clang")
...
![Visual Studio Tools > Options](../ide/media/tools-options.png "Options de l’éditeur")
