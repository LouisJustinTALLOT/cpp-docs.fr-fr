...
ms.locfileid: "57740974"
---
# <a name="hint-files"></a>Fichiers hint

Un *fichier hint* contient des macros qui sinon entraîneraient l’omission de régions de code par l’Analyseur de base de données de navigation C++. Quand vous ouvrez un projet Visual C++, l’analyseur analyse le code de chaque fichier source du projet et crée une base de données avec les informations sur chaque identificateur. L’IDE utilise ces informations pour prendre en charge les fonctionnalités de navigation de code, comme le navigateur **Affichage de classes** et la **Barre de navigation**.
...
![Macro en surbrillance. ](../ide/media/hint-squiggle-and-actions.png "Tilde et Actions rapides")
...
![Option Macros dans les régions ignorées par la navigation. ](../ide/media/skipped-regions-squiggle-option.png "Option Tilde pour les régions ignorées.")
...
L’illustration montre certains des répertoires physiques d’un projet Visual C++. Des fichiers hint se trouvent dans les répertoires `vcpackages`, `Debug`, `A1` et `A2`.
