...
Correspond aux **variables**. Contient une paire nom-valeur de variables cmake passées en tant que valeur de * _nom_=* **-D** à cmake. Si les instructions de génération de votre projet CMake spécifient l’ajout de toutes les variables directement au fichier cache CMake, nous vous recommandons de les ajouter ici à la place.
