...
`S` représente le bit de signe, les `X`sont les bits d’exposant biaisés, et les `M`sont les bits mantisse. Notez que le bit le plus à gauche est pris en compte dans les formats à simple précision et à double précision, mais qu’il est présent en tant que « 1 » dans l’octet 3 du format de précision double.
...
- Valeur 6. Même exposant, mantisse est plus grand que la moitié (1.) 100 0000... 0000 0000, qui, étant donné qu’il s’agit d’une fraction binaire, est 1 1/2, car les valeurs des chiffres fractionnaires sont 1/2, 1/4, 1/8, etc.
