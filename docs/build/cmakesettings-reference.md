...
- `remoteCopySourcesConcurrentCopies`: Spécifie le nombre de copies simultanées utilisées durant la synchronisation des sources pour l’ordinateur distant (sftp uniquement).
