...
Clonez le référentiel vcpkg à partir [https://github.com/Microsoft/vcpkg](https://github.com/Microsoft/vcpkg)de GitHub :. Vous pouvez télécharger vers n’importe quel emplacement de dossier de votre choix.
...
Par défaut, la commande de **mise à niveau** répertorie uniquement les bibliothèques obsolètes ; Il n’est pas mis à niveau. Pour mettre à niveau les bibliothèques, utilisez l’option **--no-Dry-Run** .
...
|**fichier de \<hachage vcpkg \[> ALG]**|Hacher un fichier à l’aide d’un algorithme spécifique, par défaut SHA512|
...
|**vcpkg exporter \<le> pkg... \[opt]...**|Exporter un package|
