...
description: Installer la prise en charge de Visual Studio pour VisualC++
ms.custom: mvc
ms.date: 04/02/2019
ms.topic: tutorial
ms.devlang: cpp
...
ms.locfileid: "74857162"
---
# <a name="install-c-support-in-visual-studio"></a>Installer la prise en charge de C++ dans Visual Studio

Si vous n’avez pas encore téléchargé et installé Visual Studio C++ et les outils visuels, voici comment commencer.
...
Une fois le programme d’installation installé, vous pouvez l’utiliser pour personnaliser votre installation en sélectionnant les *charges de travail*ou ensembles de fonctionnalités de votre choix. Voici comment procéder.
...
1. Le programme d’installation vous présente une liste de charges de travail, qui sont des groupes d’options connexes pour des types de développement spécifiques. La prise C++ en charge de fait désormais partie des charges de travail facultatives qui ne sont pas installées par défaut.

   ![Développement bureautique avec C++ charge de travail](media/desktop-development-with-cpp.png "Développement Desktop avec C++")

   Pour C++, sélectionnez le **développement bureau avec C++**  une charge de travail, puis choisissez **installer**.

   ![Installer le développement bureautique avec C++ la charge de travail](media/vscpp-concierge-choose-workload.gif "Installer le développement bureautique avec C++ la charge de travail")

1. Une fois l’installation terminée, cliquez sur le bouton **lancer** pour démarrer Visual Studio.

   La première fois que vous exécutez Visual Studio, vous êtes invité à vous connecter avec un compte Microsoft. Si vous n'en avez pas, vous pouvez en créer un gratuitement. Vous devez également choisir un thème. Ne vous inquiétez pas, vous pouvez le modifier ultérieurement si vous le souhaitez.
...
> [!div class="nextstepaction"]
> [Créer un C++ projet](vscpp-step-1-create.md)
