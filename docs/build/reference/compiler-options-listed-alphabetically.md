...
|[/hotpatch](hotpatch-create-hotpatchable-image.md)|Crée une image corrigeable en chaud en mémoire.|
...
|[/openmp](openmp-enable-openmp-2-0-support.md)|Permet la [ `#pragma omp` ](../../preprocessor/omp.md) directive dans le code source.|
