---
title: -ARCHIVEMEMBERS | Documents Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-tools
...
## <a name="remarks"></a>Notes  
 Cette option affiche un minimum d’informations sur les objets membres dans une bibliothèque.  
