...
Pour plus d’informations sur l’accès à la **général** page de propriétés de l’éditeur de liens, consultez [propriétés de compilateur et de build C++ définie dans Visual Studio](../working-with-project-properties.md).
