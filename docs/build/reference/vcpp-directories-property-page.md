...
Pour plus d’informations, consultez ces billets de blog : [VC++ Directories](https://docs.microsoft.com/archive/blogs/vsproject/vc-directories), [Inherited Properties and Property Sheets](https://docs.microsoft.com/archive/blogs/vsproject/inherited-properties-and-property-sheets) et [Visual Studio 2010 C++ Project Upgrade Guide](https://devblogs.microsoft.com/cppblog/visual-studio-2010-c-project-upgrade-guide/).
