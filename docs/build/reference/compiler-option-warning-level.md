...
description: Informations de référence sur les optionsC++ Microsoft C/compiler:/W,/W0,/W1,/W2,/W3,/W4,/W1,/W2,/W3,/W4,/Wall,/WD,/we,/WO,/WV et/WX.
ms.date: 01/31/2020
f1_keywords:
...
Si vous utilisez des options d’avertissement lorsque vous créez un en-tête précompilé, il conserve ces paramètres. L’utilisation de l’en-tête précompilé met à nouveau ces mêmes options d’avertissement. Pour remplacer les options d’avertissement d’en-tête précompilé, définissez une autre option d’avertissement sur la ligne de commande.
...
1. Pour définir les options **/W0**, **/W1**, **/W2**, **/W3**, **/W4**, **/Wall**, **/WV**, **/WX**ou **/WX-** , sélectionnez **Propriétés de configuration** > **C/C++**  > **général**.
