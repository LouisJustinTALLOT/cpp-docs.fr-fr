---
title: -PDATA | Documents Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-tools
...
## <a name="remarks"></a>Notes  
 Processeurs RISC uniquement.  
  
 Cette option vide les tables d’exceptions (.pdata) à partir d’une image ou un objet.  
