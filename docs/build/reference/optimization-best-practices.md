---
title: Meilleures pratiques d’optimisation | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-tools
...
Pour plus d’informations, consultez [/GL (Whole Program Optimization)](../../build/reference/gl-whole-program-optimization.md) et [/O1, / O2 (réduire la taille, augmenter la vitesse)](../../build/reference/o1-o2-minimize-size-maximize-speed.md).
...
|**Fast**|Recommandé si les performances sont d’une importance capitale, par exemple dans les jeux. Cela entraîne des performances plus rapides.|
