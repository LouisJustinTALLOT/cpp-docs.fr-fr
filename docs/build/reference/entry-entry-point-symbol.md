...
Pour plus d’informations sur la façon de définir les vôtres `DllMain` point d’entrée, consultez [DLL et Visual C++ comportement de la bibliothèque du run-time](../../build/run-time-library-behavior.md) .
