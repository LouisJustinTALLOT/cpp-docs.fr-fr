...
Les macros `_M_IX86_FP`, `__AVX__`, `__AVX2__`, `__AVX512F__`, `__AVX512CD__`, `__AVX512BW__`, `__AVX512DQ__` et `__AVX512VL__` indiquent l’option du compilateur **/ARCH** , le cas échéant. Pour plus d'informations, consultez [Predefined Macros](../../preprocessor/predefined-macros.md). L’option **/arch : AVX2** et la macro `__AVX2__` ont été introduites dans Visual Studio 2013 Update 2, version 12.0.34567.1. Prise en charge limitée de **/arch : AVX512** a été ajoutée dans visual studio 2017 et développée dans visual studio 2019.
