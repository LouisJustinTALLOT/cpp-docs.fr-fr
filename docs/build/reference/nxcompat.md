...
Pour plus d’informations, consultez l’article [/NXCOMPAT (compatible avec la prévention de l’exécution des données)](nxcompat-compatible-with-data-execution-prevention.md).
