---
description: 'En savoir plus sur les éléments suivants : sortie de lien'
title: Sortie LINK
ms.date: 11/04/2016
helpviewer_keywords:
- mapfiles [C++]
...
## <a name="other-output"></a><a name="_core_other_output"></a> Autre sortie

Quand vous tapez `link` sans autre entrée de ligne de commande, Link affiche une instruction d’utilisation qui résume ses options.
