...
2. Sélectionnez le **propriétés de Configuration** > **C/C++** > **ligne de commande** page de propriétés.

3. Entrez l’option du compilateur dans le **des Options supplémentaires** boîte.
