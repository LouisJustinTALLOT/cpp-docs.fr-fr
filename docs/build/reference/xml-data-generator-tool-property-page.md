...
Pour plus d’informations sur la façon d’accéder à la **outil XML Data Generator Tool** page de propriétés, consultez [propriétés de compilateur et de build C++ définie dans Visual Studio](../working-with-project-properties.md).
