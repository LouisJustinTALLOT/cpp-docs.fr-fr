...
Cette option limite la sortie aux informations de la *section*spécifiée. Utilisez l’option [/headers](headers.md) pour obtenir une liste de sections dans le fichier.
