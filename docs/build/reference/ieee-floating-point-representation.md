...
|double précision|bit de signe, exposant de 11 bits, mantisse 52 bits|
|précision étendue double|bit de signe, exposant de 15 bits, 64 bits mantisse|
...
|Format|Octets 1|Octets 2|Octet 3|Octets 4|...|octet n|
|------------|------------|------------|------------|------------|---------|------------|
|simple précision| `SXXXXXXX`|`XMMMMMMM`|`MMMMMMMM`|`MMMMMMMM`|||
|double précision|`SXXXXXXX`|`XXXXMMMM`|`MMMMMMMM`|`MMMMMMMM`|...|`MMMMMMMM`|
|précision étendue double|`SXXXXXXX`|`XXXXXXXX`|`1MMMMMMM`|`MMMMMMMM`|...|`MMMMMMMM`|
