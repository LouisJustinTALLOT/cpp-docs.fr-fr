---
title: pages de propriétés Ligne de commande
ms.date: 11/04/2016
f1_keywords:
...
Pour plus d’informations sur la façon d’accéder à la **ligne de commande** pages de propriétés, consultez [propriétés de compilateur et de build C++ définie dans Visual Studio](../working-with-project-properties.md).
