...
L’option /VERSION indique à l’éditeur de liens de placer un numéro de version dans l’en-tête du fichier .exe ou .dll. Utilisez DUMPBIN [/HEADERS](headers.md) pour afficher le champ de version d’image de OPTIONAL HEADER VALUES pour voir le résultat de.
...
Une autre consiste à insérer un numéro de version avec le [VERSION](version-c-cpp.md) instruction de définition de module.
