...
Par défaut, un assembly est créé. Vous pouvez également utiliser le [/LN (Create MSIL Module)](../../build/reference/ln-create-msil-module.md) option du compilateur pour créer un module.
