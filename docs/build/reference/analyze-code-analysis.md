...
> **/analyze**[-] [ **: WX-** ] [ **:** *nom du fichier*journal] [ **: Quiet**] [ **: STACKSIZE** *nombre*] [ **: max_paths** *nombre*] [ **: uniquement**] [ **: RuleSet** *RuleSet*] [ **:p Lugin** *plugin-dll*]
...
**/analyze :** *nom du fichier* journal\
...
L’exemple d’ensemble de règles personnalisé suivant indique au moteur de règles de vérifier C6001 et C26494. Vous pouvez placer ce fichier n’importe où, à condition qu’il possède une extension de `.ruleset` et que vous fournissiez le chemin d’accès complet dans l’argument.
...
Pour plus d’informations, consultez [analyse du code pourC++ c/Overview](/cpp/code-quality/code-analysis-for-c-cpp-overview) et [analyse du codeC++ pour c/Warnings](/cpp/code-quality/code-analysis-for-c-cpp-warnings).
