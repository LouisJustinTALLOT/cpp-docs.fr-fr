...
Le `reserve` argument spécifie l’allocation totale des tas initiale dans la mémoire virtuelle. Par défaut, la taille du tas est de 1 Mo. [Référence EDITBIN](editbin-reference.md) arrondit la valeur spécifiée au multiple plus proche de 4 octets.
