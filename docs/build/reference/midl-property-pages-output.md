---
title: 'Pages de propriétés MIDL : Sortie'
ms.date: 11/04/2016
f1_keywords:
...
Pour plus d’informations sur la façon d’accéder à la **sortie** page de propriétés dans le **MIDL** dossier, consultez [propriétés de compilateur et de build C++ définie dans Visual Studio](../working-with-project-properties.md).
