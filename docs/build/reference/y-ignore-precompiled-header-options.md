---
description: En savoir plus sur les éléments suivants:/Y-(ignorer les options d’en-tête précompilé)
...
ms.locfileid: "97260837"
---
# <a name="y--ignore-precompiled-header-options"></a>/Y- (Ignorer les options d’en-têtes précompilés)

Entraîne l’ignorance de toutes les autres `/Y` Options du compilateur (et ne peut pas être substituée).
