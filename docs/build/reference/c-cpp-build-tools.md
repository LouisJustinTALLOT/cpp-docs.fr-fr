---
title: Outils de génération C/C++ | Documents Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-tools
...
-   [DUMPBIN. EXE](../../build/reference/dumpbin-reference.md) affiche des informations sur les fichiers binaires COFF (par exemple, une table de symboles).  
  
-   [NMAKE](../../build/nmake-reference.md) lit et exécute des makefiles.  
  
-   [ERRLOOK](../../build/reference/value-edit-control.md), l’utilitaire de recherche d’erreurs, récupère un message d’erreur système ou un message d’erreur de module selon la valeur entrée.  
