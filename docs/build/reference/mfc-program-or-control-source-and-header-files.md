---
description: 'En savoir plus sur : fichiers de source et d’en-tête de contrôle ou de programme MFC'
...
[Fichiers de source et d’en-tête de contrôle ou de programme ATL](atl-program-or-control-source-and-header-files.md)<br>
