---
description: 'En savoir plus sur : HEAPSIZE'
title: HEAPSIZE
ms.date: 11/04/2016
f1_keywords:
- HEAPSIZE
...
ms.locfileid: "97191587"
---
# <a name="heapsize"></a>HEAPSIZE

Expose les mêmes fonctionnalités que l’option de l’éditeur de liens [/Heap](heap-set-heap-size.md) .
