...
Pour plus d’informations sur les DLL non - MFC, consultez [Dynamic-Link Libraries](/windows/desktop/dlls/dynamic-link-libraries) dans le SDK Windows.
