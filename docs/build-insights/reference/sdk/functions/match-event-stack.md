...
description: Référence C++ de la fonction MatchEventStack du kit de développement logiciel (SDK) Build Insights.
ms.date: 02/12/2020
helpviewer_keywords:
- C++ Build Insights
...
Le dernier événement dans *eventStack* est toujours mis en correspondance avec la dernière entrée de la liste de types\] concaténés \[*TEvent*, *TEvents...* . Toutes les autres entrées *TEvent* et *TEvents* peuvent correspondre à n’importe quelle position dans *eventStack* , à l’exception de la dernière, à condition qu’elles soient dans le même ordre.
