...
description: La référence de fonction SDK Build Insights SDK StopAndAnalyzeTracingSessionW.
ms.date: 02/12/2020
helpviewer_keywords:
- C++ Build Insights
...
*Statistiques*\
Pointeur vers un [objet TRACING_SESSION_STATISTICS.](../other-types/tracing-session-statistics-struct.md) `StopAndAnalyzeTracingSessionW`écrit des statistiques de collecte de traces dans cet objet avant de revenir.

*analyseDescripteur*\
Pointeur vers un objet [ANALYSIS_DESCRIPTOR.](../other-types/analysis-descriptor-struct.md) Utilisez cet objet pour configurer la `StopAndAnalyzeTracingSessionW`session d’analyse qui a commencé par .
