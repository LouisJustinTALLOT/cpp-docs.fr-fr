---
title: Énumération EVENT_ID
description: Le kit de développement logiciel (SDK) C++ Build Insights EVENT_ID référence Enum.
ms.date: 02/12/2020
helpviewer_keywords:
- C++ Build Insights
...
ms.locfileid: "92921059"
---
# <a name="event_id-enum"></a>Énumération EVENT_ID
...
| Nom | Valeur | URL des détails de l’événement |
|--|--|--|
...
| `EVENT_ID_FUNCTION` | 15 (0x000000F) | [FONCTIONNALITÉS](../event-table.md#function) |
...
| `EVENT_ID_LINKER` | 18 (0x00000012) | [ÉDITEUR](../event-table.md#linker) |
...
Ces valeurs sont utilisées avec les fonctions du kit de développement logiciel (SDK) C.
