...
description: Le C++ Kit de développement logiciel (SDK) de Build Insights event_id référence Enum.
ms.date: 02/12/2020
helpviewer_keywords:
- C++ Build Insights
...
Énumération `EVENT_ID`.

## <a name="members"></a>Membres

| Name | Valeur | URL des détails de l’événement |
|--|--|--|
