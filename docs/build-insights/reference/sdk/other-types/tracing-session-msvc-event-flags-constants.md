---
title: Constantes TRACING_SESSION_MSVC_EVENT_FLAGS
description: Le C++ Kit de développement logiciel (SDK) de Build Insights TRACING_SESSION_MSVC_EVENT_FLAGS référence des constantes.
ms.date: 02/12/2020
helpviewer_keywords:
- C++ Build Insights
...
ms.locfileid: "78332214"
---
# <a name="tracing_session_msvc_event_flags-constants"></a>Constantes TRACING_SESSION_MSVC_EVENT_FLAGS
...
Les constantes de `TRACING_SESSION_MSVC_EVENT_FLAGS` sont utilisées pour décrire les événements MSVC à collecter au cours d’une trace. Utilisez-les pour initialiser le champ `MsvcEventFlags` de la structure [TRACING_SESSION_OPTIONS](tracing-session-options-struct.md) .
...
| `TRACING_SESSION_MSVC_EVENT_FLAGS_ALL` | Cet indicateur active tous les événements. |
