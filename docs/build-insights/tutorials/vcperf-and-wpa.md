...
description: Didacticiel sur l’utilisation de vcperf et WPA pour analyser C++ les traces de génération.
ms.date: 11/03/2019
helpviewer_keywords:
- C++ Build Insights
- throughput analysis
...
Dans ce didacticiel, vous allez apprendre à utiliser *vcperf. exe* pour collecter un suivi de votre C++ Build. Vous allez également apprendre à afficher ce suivi dans Windows Performance Analyzer.
