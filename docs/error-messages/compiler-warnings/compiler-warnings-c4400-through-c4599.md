...
|[Compilateur avertissement (niveau 3) C4554](../../error-messages/compiler-warnings/compiler-warning-level-3-c4554.md) C4554|«*opérateur*' : Vérifiez la priorité des opérateurs pour l’erreur possible ; utilisez des parenthèses pour clarifier la priorité|
