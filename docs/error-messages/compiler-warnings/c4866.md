...
À compter de C ++ 17, les opérandes des opérateurs __-> \*__,  **\[]**, **>>**, et **\< \<** doivent être évaluées dans l’ordre de gauche à droite. Il existe deux cas dans lesquels le compilateur est incapable de garantir cet ordre :
