---
title: Compilateur avertissement (niveau 4) C4517 | Documents Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "33297691"
---
# <a name="compiler-warning-level-4-c4517"></a>Avertissement du compilateur (niveau 4) C4517
les déclarations d’accès sont déconseillées ; déclarations using de membres constituent un meilleur choix  
