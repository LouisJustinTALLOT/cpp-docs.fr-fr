...
|-------------|-------------|
|Avertissement du compilateur C4000|AVERTISSEMENT INCONNU<br /><br /> Choisissez la commande support technique sur le visuelC++<br /><br /> Menu aide ou ouvrez le fichier d’aide du support technique pour plus d’informations|
...
|[Avertissement du compilateur (niveau 1) C4117](compiler-warning-level-1-c4117.md)|nom de macro’name’réservé, 'Command’ignoré|
