---
description: 'En savoir plus sur : avertissement du compilateur (niveau 4) C4245'
...
Vous avez essayé de convertir un type **`signed const`** qui a une valeur négative en un **`unsigned`** type.
