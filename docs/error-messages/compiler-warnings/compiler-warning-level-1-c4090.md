---
title: Compilateur avertissement (niveau 1) C4090 | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
Cet avertissement est émis pour les programmes C. Dans un programme C++, le compilateur émet une erreur : [l’erreur C2440](../../error-messages/compiler-errors-1/compiler-error-c2440.md).
