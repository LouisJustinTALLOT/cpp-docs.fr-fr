...
C4251 peut être ignorée si vous dérivez d’un type dans le C++ bibliothèque Standard, compilez une version debug (**/MTd**) et où le message d’erreur du compilateur fait référence à _Container_base.
