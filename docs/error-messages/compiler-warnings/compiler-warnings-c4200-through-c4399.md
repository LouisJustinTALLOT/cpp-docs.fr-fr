---
title: Avertissements du compilateur C4200 à C4399
ms.date: 04/21/2019
f1_keywords:
- C4203
- C4277
...
|[Avertissement du compilateur (niveau 4) C4205](../../error-messages/compiler-warnings/compiler-warning-level-4-c4205.md)|extension non standard utilisée : déclaration de fonction statique dans la portée de fonction|
...
|[Avertissement du compilateur (niveau 4) C4207](../../error-messages/compiler-warnings/compiler-warning-level-4-c4207.md)|extension non standard utilisée : étendue de forme de l’initialiseur|
...
|[Avertissement du compilateur (niveau 4) C4214](../../error-messages/compiler-warnings/compiler-warning-level-4-c4214.md)|extension non standard utilisée : types de champs autres qu’int de bits|
...
|[Avertissement du compilateur (niveau 1) C4218](../../error-messages/compiler-warnings/compiler-warning-level-1-c4218.md)|extension non standard utilisée : doit spécifier au moins une classe de stockage ou d’un type|
...
|[Avertissement du compilateur (niveau 1) C4224](../../error-messages/compiler-warnings/compiler-warning-level-1-c4224.md)|extension non standard utilisée : paramètre formel '*identificateur*' a déjà été défini en tant que type|
|[Avertissement du compilateur (niveau 1, erreur) C4226](../../error-messages/compiler-warnings/compiler-warning-level-1-c4226.md)|extension non standard utilisée : '*mot clé*' mot clé obsolète|
...
|[Avertissement du compilateur (niveau 1) C4229](../../error-messages/compiler-warnings/compiler-warning-level-1-c4229.md)|anachronisme utilisé : modificateurs de données sont ignorés.|
...
|[Avertissement du compilateur (niveau 4, erreur) C4233](../../error-messages/compiler-warnings/compiler-warning-level-4-c4233.md)|extension non standard utilisée : '*mot clé*' mot clé uniquement pris en charge en C++, non en C|
|[Avertissement du compilateur (niveau 4, erreur) C4234](../../error-messages/compiler-warnings/compiler-warning-level-4-c4234.md)|extension non standard utilisée : '*mot clé*' mot clé réservé pour un usage ultérieur|
|[Avertissement du compilateur (niveau 4, erreur) C4235](../../error-messages/compiler-warnings/compiler-warning-level-4-c4235.md)|extension non standard utilisée : '*mot clé*' mot clé non pris en charge sur cette architecture|
|[Avertissement du compilateur (niveau 1) C4237](../../error-messages/compiler-warnings/compiler-warning-level-1-c4237.md)|«*mot clé*' mot clé n’est pas encore pris en charge, mais réservé pour une utilisation ultérieure|
...
|[Avertissement du compilateur (niveau 3) C4240](../../error-messages/compiler-warnings/compiler-warning-level-3-c4240.md)|extension non standard utilisée : accès à '*classname*'défini maintenant comme'*access_specifier1*«, précédemment, il a été défini pour être »*access_specifier2*'|
|[Avertissement du compilateur (niveau 4) C4242](../../error-messages/compiler-warnings/compiler-warning-level-4-c4242.md)|'*identificateur*' : conversion de '*type1*'en'*type2*', perte possible de données|
|[Avertissement du compilateur (niveau 3) C4243](../../error-messages/compiler-warnings/compiler-warning-level-3-c4243.md)|«*conversion_type*'conversion à partir de'*type1*'en'*type2*' existe, mais n’est pas accessible|
...
|[Avertissement du compilateur (niveau 4) C4268](../../error-messages/compiler-warnings/compiler-warning-level-4-c4268.md)|«*identificateur*' : 'const' données static/global initialisées avec le constructeur de valeur par défaut généré par le compilateur remplissent l’objet de zéros non significatifs|
...
|[Avertissement du compilateur (niveau 1) C4288](../../error-messages/compiler-warnings/compiler-warning-level-1-c4288.md)|extension non standard utilisée : '*variable*' : variable de contrôle de boucle déclarée dans la boucle for est utilisé en dehors de la portée de la boucle ; il est en conflit avec la déclaration de la portée externe|
...
|[Avertissement du compilateur (niveau 3) C4290](../../error-messages/compiler-warnings/compiler-warning-level-3-c4290.md)|C++spécification d’exception ignorée excepté to indiquer qu’une fonction n’est pas __declspec (nothrow)|
|[Avertissement du compilateur (niveau 1) C4291](../../error-messages/compiler-warnings/compiler-warning-level-1-c4291.md)|«*déclaration*' : aucun opérateur delete correspondant n’introuvable ; la mémoire ne sera pas libérée si l’initialisation lève une exception|
|[Avertissement du compilateur (niveau 1) C4293](../../error-messages/compiler-warnings/compiler-warning-level-1-c4293.md)|«*shift_operator*' : shift nombre négatif ou trop important, comportement non défini|
...
|[Avertissement du compilateur (niveau 1) C4297](../../error-messages/compiler-warnings/compiler-warning-level-1-c4297.md)|«*fonction*' : fonction supposé ne pas pour lever une exception, mais pas|
|Avertissement du compilateur (niveau 4) C4298|«*identificateur*' : identificateur de la bibliothèque de types '*bibliothèque*'est déjà une macro ; changement de nom à'*__identifier*»|
...
|Avertissement C4301 du compilateur|'*derived_class*::*fonction*' : fonction virtuelle de substitution ne diffère de '*base_class*::*fonction*' par const/volatile qualificateur de nom|
|[Avertissement du compilateur (niveau 2) C4302](../../error-messages/compiler-warnings/compiler-warning-level-2-c4302.md)|«*conversion*' : troncation de '*type1*'en'*type2*»|
|Avertissement de l’erreur C4303 du compilateur|Effectuer un cast de style C à partir de '*type1*'en'*type2*' est déconseillée, utilisez statique\_cast, \_ \_essayez\_de cast ou de dynamique\_cast|
|[Avertissement du compilateur (niveau 1) C4305](../../error-messages/compiler-warnings/compiler-warning-level-1-c4305.md)|«*conversion*' : troncation de '*type1*'en'*type2*»|
...
|[Avertissement C4335](../../error-messages/compiler-warnings/compiler-warning-c4335.md)|Format de fichier Mac détecté : convertissez le fichier source au format DOS ou UNIX|
...
|[Avertissement du compilateur (niveau 4) C4337](../../error-messages/compiler-warnings/compiler-warning-level-4-c4337.md)|bibliothèque de types à références croisées '*bibliothèque1*'in'*bibliothèque2*» est automatiquement importé|
...
|[Avertissement du compilateur (niveau 1) C4350](../../error-messages/compiler-warnings/compiler-warning-level-1-c4350.md)|changement de comportement : '*member1*'appelé à la place de'*member2*'|
...
|[Avertissement C4355](../../error-messages/compiler-warnings/compiler-warning-c4355.md)Avertissement du compilateur (niveaux 1 et 4) C4355|'this' : utilisé dans la liste d’initialiseurs membre de base|
...
|[Avertissement du compilateur (niveau 4) C4366](../../error-messages/compiler-warnings/compiler-warning-level-4-c4366.md)|Le résultat de l’unaire «*opérateur*' opérateur peut ne pas être aligné|
|Avertissement du compilateur (niveau 3) C4367|Conversion de '*type1*'en'*type2*' peut entraîner l’exception d’alignement de type de données|
|[Avertissement (erreur) C4368](../../error-messages/compiler-warnings/compiler-warning-c4368.md)|Impossible de définir '*membre*'comme membre de « gérés par*type*' : types mixtes ne sont pas pris en charge.|
...
|[Avertissement du compilateur (niveau 1) C4384](../../error-messages/compiler-warnings/compiler-warning-level-1-c4384.md)|#pragma 'make_public' doit uniquement être utilisé avec une portée globale|
|Avertissement du compilateur (niveau 3) C4387|«*autre*' : a été considéré comme|
...
|[Avertissement du compilateur (niveau 3) C4390](../../error-messages/compiler-warnings/compiler-warning-level-3-c4390.md)|' ;': vide instruction contrôlée est trouvée ; est-ce l’intention ?|
...
|[Avertissement du compilateur (niveau 1) C4392](../../error-messages/compiler-warnings/compiler-warning-level-1-c4392.md)|«*function_signature*' : nombre incorrect d’arguments de fonction intrinsèque, attendu '*argument_count*' arguments|
...
|[Avertissement C4394](../../error-messages/compiler-warnings/compiler-warning-c4394.md)|«*fonction*' : symbole par appdomain ne doit pas être marqué avec __declspec('dllexport')|
