...
|[Avertissement (niveau 1, erreur) du compilateur C4226](../../error-messages/compiler-warnings/compiler-warning-level-1-c4226.md)|extension non standard utilisée : '*mot clé*' mot clé obsolète|
...
|[Avertissement (niveau 4, erreur) du compilateur C4233](../../error-messages/compiler-warnings/compiler-warning-level-4-c4233.md)|extension non standard utilisée : '*mot clé*' mot clé uniquement pris en charge en C++, non en C|
|[Avertissement (niveau 4, erreur) du compilateur C4234](../../error-messages/compiler-warnings/compiler-warning-level-4-c4234.md)|extension non standard utilisée : '*mot clé*' mot clé réservé pour un usage ultérieur|
...
|[Avertissement (erreur) du compilateur C4368](../../error-messages/compiler-warnings/compiler-warning-c4368.md)|Impossible de définir '*membre*'comme membre de « gérés par*type*' : types mixtes ne sont pas pris en charge.|
