...
|Warning|Message|
|-------------|------------|
|[Avertissement (niveau 4) du compilateur C4800](compiler-warning-level-3-c4800.md)| Conversion implicite de '*type*» en valeur booléenne. Perte d’informations possible |
