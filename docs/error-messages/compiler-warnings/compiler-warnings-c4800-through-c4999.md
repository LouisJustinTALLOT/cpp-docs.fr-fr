...
|[Avertissement du compilateur (niveau 4) C4932](compiler-warning-level-4-c4932.md)|Impossible de*distinguer*_ _ identifier \_(identifier) et _Identifier (*identifier*)|
