---
title: Compilateur avertissement (niveau 1) C4935 | Documents Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "33290515"
---
# <a name="compiler-warning-level-1-c4935"></a>Avertissement du compilateur (niveau 1) C4935
...
C4935 est uniquement accessible à l’aide de l’option du compilateur obsolète **oldSyntax ;**.  
