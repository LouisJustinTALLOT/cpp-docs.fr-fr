---
title: Compilateur avertissement (niveau 3) C4637 | Documents Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
Cible de commentaire de document XML : \<inclure > balise ignorée.  raison  
 ...
 La syntaxe d’une [ \<inclure >](../../ide/include-visual-cpp.md) balise n’est pas correcte.  
