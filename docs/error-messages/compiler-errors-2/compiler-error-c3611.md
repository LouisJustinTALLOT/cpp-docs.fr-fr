...
Une fonction sealed a été correctement déclarée.  Pour plus d’informations, consultez [sealed](../../extensions/sealed-cpp-component-extensions.md).
