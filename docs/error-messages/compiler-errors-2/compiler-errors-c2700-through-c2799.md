...
|[Erreur du compilateur C2703](compiler-error-c2703.md)|instruction a __leave non conforme|
...
|[Erreur du compilateur C2790](compiler-error-c2790.md)|'super' : ce mot clé peut être utilisé uniquement dans le corps de la fonction membre de classe|
...
|[Erreur du compilateur C2794](compiler-error-c2794.md)|'*identificateur*' : n’est pas un membre d’une classe de base directe ou indirecte de '*classe*'|
