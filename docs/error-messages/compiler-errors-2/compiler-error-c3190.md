---
title: Erreur du compilateur C3190 | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
Le compilateur a détecté une tentative pour établir une instanciation de fonction explicite ; Toutefois, les arguments de type fournis ne correspondent pas toutes les fonctions possibles.

L’exemple suivant génère l’erreur C3190 :
