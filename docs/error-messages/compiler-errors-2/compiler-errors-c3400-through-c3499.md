...
|C3401 d’erreur du compilateur|«*spécificateur*' : spécificateur d’accès d’assembly non valide - seul 'private' n’est autorisée sur les modèles de classe|
|C3402 d’erreur du compilateur|«*fonction*' : ne peut pas résoudre la surcharge sauf dans la portée actuelle|
|C3403 d’erreur du compilateur|thread_local ne peut pas être utilisé avec/clr : pure ou/CLR : safe|
|C3404 d’erreur du compilateur|«*construire*' : erreur de syntaxe inattendue|
|C3405 d’erreur du compilateur|«*fonction*' : Impossible de résoudre la surcharge sans un descripteur complet|
|C3406 d’erreur du compilateur|«*mot clé*' : ne peut pas être utilisé dans un spécificateur de type élaboré|
|C3407 d’erreur du compilateur|«*type*' ne peut pas être utilisé dans ce contexte|
...
|C3410 d’erreur du compilateur|«*identificateur*' : le type de l’instanciation explicite '*type*'ne correspond pas au type du modèle de variable'*type*»|
|C3411 d’erreur du compilateur|«*type*' n’est pas valide en tant que la taille d’un tableau comme il n’est pas un type entier|
...
|C3419 d’erreur du compilateur|Obsolète.|
...
|C3422 d’erreur du compilateur|«*déclaration*' : incompatibilité de types'*type*'et'*type*»|
|C3423 d’erreur du compilateur|Obsolète.|
|C3424 d’erreur du compilateur|«*type*' : un cast de style fonction à un type de tableau n’est pas autorisé.|
|C3425 d’erreur du compilateur|ne peut pas lever le pointeur à l’objet de type incomplet '*type*'|
|C3426 d’erreur du compilateur|Impossible de lever l’objet de type incomplet '*type*'|
|C3427 d’erreur du compilateur|«*contexte*' : '*mot clé*' ne peut pas être utilisé avec layout_version (*nombre*)|
|C3428 d’erreur du compilateur|«*contexte*' : '*mot clé*' peut uniquement être appliqué aux définitions ou déclarations de classe|
|C3429 d’erreur du compilateur|«*contexte*' : '*mot clé*' ne peut pas être appliqué à une union|
|C3430 d’erreur du compilateur|une énumération délimitée doit avoir un nom|
...
|C3434 d’erreur du compilateur|«*contexte*' : valeur de l’énumérateur '*nombre*« ne peut pas être représentée en tant que »*type*«, la valeur est »*nombre*»|
...
|C3441 d’erreur du compilateur|«*déclaration*' : '*mot clé*' ne peut pas être appliqué une fois que la classe a été définie.|
|C3442 d’erreur du compilateur|Initialisation de plusieurs membres d’union : '*member1*'et'*member2*'|
|C3443 d’erreur du compilateur|L’initialiseur de membre par défaut pour '*classe*' est récursif|
|C3444 d’erreur du compilateur|Vide la classe d’agrégation*classe*'doit être initialisée avec'{}'|
...
|C3472 d’erreur du compilateur|nouveau nom de fichier de sortie *filename* (défini sur la ligne de commande) des conflits avec le nom de fichier précédent *nom de fichier*|
|C3473 d’erreur du compilateur|Aucun nom chemin d’accès ou le module de sortie spécifié.|
|C3474 d’erreur du compilateur|Impossible d’ouvrir le fichier de sortie '*filename*'|
|C3475 d’erreur du compilateur|Erreur de syntaxe dans le fichier d’entrée '*filename*'|
|C3476 d’erreur du compilateur|pas pu ouvrir le fichier '*filename*» pour l’entrée|
|C3477 d’erreur du compilateur|une expression lambda ne peut pas apparaître dans un contexte non évalué|
|C3478 d’erreur du compilateur|«*identificateur*' : un tableau ne peut pas être capturé par copie|
|C3479 d’erreur du compilateur|Annotations SAL sur les expressions lambda ne sont pas pris en charge.|
...
|C3497 d’erreur du compilateur|Vous ne pouvez pas construire une instance d’une expression lambda|
