...
|[Erreur du compilateur C2803](compiler-error-c2803.md)|' opérateur *opérateur*' doit avoir au moins un paramètre de type de classe|
...
|[Erreur du compilateur C2806](compiler-error-c2806.md)|' opérateur *opérateur*' a un trop grand nombre de paramètres formel|
...
|[Erreur du compilateur C2808](compiler-error-c2808.md)|unaire ' opérateur *opérateur*' a un trop grand nombre de paramètres formel|
...
|[Erreur du compilateur C2811](compiler-error-c2811.md)|'*type1*' : ne peut pas hériter de '*type2*», une classe ref peut uniquement hériter d’une classe ref ou d’une classe interface|
...
|[Erreur du compilateur C2857](compiler-error-c2857.md)|' #include ' instruction spécifiée avec le/Yc*filename* option de ligne de commande est introuvable dans le fichier source|
|[Erreur du compilateur C2858](compiler-error-c2858.md)|option de ligne de commande ' /Yc (/Fd*filename*) » incohérent avec l’en-tête précompilé, qui utilisait ' /Fd*filename*'|
...
|[Erreur du compilateur C2864](compiler-error-c2864.md)|«*identificateur*' : une variable de membre/modèle de données statiques avec un initialiseur de classe doit avoir un type intégral const non volatile|
