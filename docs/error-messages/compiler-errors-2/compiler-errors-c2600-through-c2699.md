---
title: Erreurs du compilateur de C2600 à C2699
ms.date: 11/17/2017
f1_keywords:
- C2604
- C2606
...
|C2604 d’erreur du compilateur|«*identificateur*' : ne peut pas implémenter plusieurs méthodes d’interface|
...
|C2606 d’erreur du compilateur|«*class1*' : ne peut pas ré-implémenter '*membre*', car il est hérité à partir de la base de runtime'*classe2*»|
...
|C2610 d’erreur du compilateur|«*classe*::*membre*' : n’est pas une fonction membre spéciale qui peut être une valeur par défaut|
...
|C2631 d’erreur du compilateur|«*identificateur*' : une classe ou une enum ne peuvent pas être défini dans un modèle d’alias|
...
|[Erreur du compilateur C2691](compiler-error-c2691.md)|«*type*' : un tableau géré/WinRT ne peut pas avoir ce type d’élément|
