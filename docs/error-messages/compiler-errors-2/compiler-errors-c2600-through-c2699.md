---
title: Erreurs du compilateur C2600 à C2699
ms.date: 04/21/2019
f1_keywords:
- C2604
- C2606
...
---
# <a name="compiler-errors-c2600-through-c2699"></a>Erreurs du compilateur C2600 à C2699
...
|[Erreur du compilateur C2601](compiler-error-c2601.md)|«*fonction*' : les définitions de fonction locale ne sont pas conformes|
...
|Erreur du compilateur C2604|«*identificateur*» : Ne peut pas implémenter plusieurs méthodes d’interface|
...
|Erreur du compilateur C2606|«*class1*' : ne peut pas ré-implémenter '*membre*', car il est hérité à partir de la base de runtime'*classe2*»|
|Erreur du compilateur C2607|échoué de l’assertion statique|
|Erreur du compilateur C2608|Obsolète.|
|Erreur du compilateur C2609|Obsolète.|
|Erreur du compilateur C2610|«*classe*::*membre*' : n’est pas une fonction membre spéciale qui peut être une valeur par défaut|
...
|[Erreur du compilateur C2613](compiler-error-c2613.md)|de fin '*caractère*' non conforme dans une liste de classe de base|
...
|[Erreur du compilateur C2616](compiler-error-c2616.md)|'*conversion*' : Impossible de convertir implicitement une non-lvalue '*type1*' à une «*type2*' qui n’est pas const|
...
|Erreur du compilateur C2625|«*identificateur*' : membre d’union illégal ; le type '*type*' est de type référence|
|[Erreur du compilateur C2626](compiler-error-c2626.md)|«*identificateur*' : un membre de données privé/protégé n’est pas autorisé dans une struct/union anonyme|
...
|Erreur du compilateur C2629|«*identificateur*' : une struct/union anonyme ne peut pas déclarer un type imbriqué|
|[Erreur du compilateur C2630](compiler-error-c2630.md)|«*symbole*' trouvé à la place d’une liste séparée par des virgules|
|Erreur du compilateur C2631|«*identificateur*' : une classe ou une enum ne peuvent pas être défini dans un modèle d’alias|
|[Erreur du compilateur C2632](compiler-error-c2632.md)|«*type1*'suivi de'*type2*' n’est pas conforme|
...
|[Erreur du compilateur C2634](compiler-error-c2634.md)|«*classe*::*membre*' : pointeur vers membre de référence n’est pas conforme|
|[Erreur du compilateur C2635](compiler-error-c2635.md)|Impossible de convertir un '*type1*\*' à une «*type2*\*' ; conversion à partir de la classe de base virtuelle implicite|
|[Erreur du compilateur C2636](compiler-error-c2636.md)|«*identificateur*' : pointeur vers membre de référence n’est pas conforme|
|[Erreur du compilateur C2637](compiler-error-c2637.md)|«*identificateur*' : ne peut pas modifier les pointeurs vers des membres de données|
...
|[Erreur du compilateur C2648](compiler-error-c2648.md)|«*identificateur*' : utilisation d’un membre comme paramètre par défaut nécessite un membre static|
|[Erreur du compilateur C2649](compiler-error-c2649.md)|«*identificateur*' : n’est pas une 'class/struct/union'|
...
|[Erreur du compilateur C2662](compiler-error-c2662.md)|'*fonction*' : Impossible de convertir un pointeur 'this' à partir de '*type1*'en'*type2*'|
...
|[Erreur du compilateur C2664](compiler-error-c2664.md)|'*fonction*' : ne peut pas convertir l’argument *nombre* à partir de '*type1*'en'*type2*'|
...
|[Erreur du compilateur C2667](compiler-error-c2667.md)|«*fonction*' : aucune des *nombre* surcharges ont une meilleure conversion|
...
|[Erreur du compilateur C2672](compiler-error-c2672.md)|«*fonction*' : fonction aucun correspondante ne surchargée introuvable|
...
|[Erreur du compilateur C2678](compiler-error-c2678.md)|binaire '*opérateur*' : aucun opérateur trouvé qui accepte un opérande gauche de type '*type*' (ou il n’existe aucune conversion acceptable)|
|[Erreur du compilateur C2679](compiler-error-c2679.md)|binaire '*opérateur*' : aucun opérateur trouvé qui accepte un opérande de droite de type '*type*' (ou il n’existe aucune conversion acceptable)|
...
|[Erreur du compilateur C2682](compiler-error-c2682.md)|Impossible d’utiliser '*cast*' pour convertir'*type1*'en'*type2*'|
|[Erreur du compilateur C2683](compiler-error-c2683.md)|«*cast*' : '*type*' n’est pas un type polymorphe|
|Erreur du compilateur C2684|«*déclarateur*' : les fonctions supprimées et définies par défaut ne sont pas pris en charge dans les classes managées/WinRT|
|Erreur du compilateur C2685|«*déclarateur*' : les fonctions supprimées et définies par défaut ne sont pas pris en charge avec les spécificateurs de restriction explicites|
...
|[Erreur du compilateur C2690](compiler-error-c2690.md)|«*opérateur*' : Impossible d’effectuer des opérations arithmétiques de pointeur sur un tableau géré/WinRT|
|[Erreur du compilateur l’erreur C2691](compiler-error-c2691.md)|«*type*' : un tableau géré/WinRT ne peut pas avoir ce type d’élément|
...
|[Erreur du compilateur C2693](compiler-error-c2693.md)|«*opérateur*' : comparaison non conforme entre des références et un tableau géré/WinRT|
...
|[Erreur du compilateur C2696](compiler-error-c2696.md)|Impossible de créer un objet temporaire de type de gérés/WinRT '*type*'|
