...
Les destructeurs ou finaliseurs ne peut pas être substituées explicitement. Pour plus d’informations, consultez [substitutions explicites](../../extensions/explicit-overrides-cpp-component-extensions.md).
