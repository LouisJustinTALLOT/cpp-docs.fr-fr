---
title: Erreur du compilateur C3619 | Documents Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
C3619 est uniquement accessible à l’aide de l’option du compilateur obsolète **oldSyntax ;**.  
