...
ms.locfileid: "62227120"
---
# <a name="compiler-error-c3655"></a>Erreur du compilateur C3655

'fonction' : fonction déjà substituée explicitement

Une fonction peut uniquement être substituée explicitement qu’une seule fois. Pour plus d’informations, consultez [substitutions explicites](../../extensions/explicit-overrides-cpp-component-extensions.md).
