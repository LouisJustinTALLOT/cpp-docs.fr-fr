---
title: Erreurs du compilateur C3500 à C3999 | Microsoft Docs
ms.date: 11/17/2017
ms.technology:
- cpp-diagnostics
...
|C3502 d’erreur du compilateur|Impossible d’obtenir LIBID pour le ProgID «*progid*'|
|C3503 d’erreur du compilateur|caractère ' 0 x*valeur*' n'est pas autorisé dans une chaîne brute littéral|
|C3504 d’erreur du compilateur|Impossible de créer des GUID à partir de la chaîne «*chaîne*'|
...
|C3511 d’erreur du compilateur|«*identificateur*' : un appel à un constructeur de délégation doit être le seul initialiseur de membre|
|C3512 d’erreur du compilateur|la séquence de caractères de délimitation pour un littéral de chaîne brute n’aura pas plus de 16 caractères|
|C3513 d’erreur du compilateur|«*chaîne*' : non pris en charge de caractère de délimiteur de littéral de chaîne brute|
|C3514 d’erreur du compilateur|«*caractère*» (*valeur*) : non pris en charge de caractère de délimiteur de littéral de chaîne brute|
|C3515 d’erreur du compilateur|Si un argument pour une spécialisation partielle de modèle de classe est une expansion, il doit être le dernier argument|
|C3516 d’erreur du compilateur|fin de fichier inattendue rencontrée lors du traitement de la chaîne brute littérale ; séquence de délimiteur '*chaîne*' ne correspond pas|
|Erreur C3517 erreur de compilateur|«*identificateur*' une déclaration d’alias ne peut pas avoir un type contenant 'auto'|
|C3518 d’erreur du compilateur|«*identificateur*' : dans un contexte d’initialisation de liste directe du type pour '*type*' ne peut être déduit qu’à partir d’une seule expression d’initialiseur|
|[Erreur du compilateur C3519](compiler-error-c3519.md)|«*paramètre*' : paramètre non valide pour l’attribut embedded_idl|
|C3520 d’erreur du compilateur|«*identificateur*' : package de paramètres doit être développé dans ce contexte|
|C3521 d’erreur du compilateur|«*identificateur*' n’est pas un package de paramètres|
|C3522 d’erreur du compilateur|«*type*' : Impossible de développer un package de paramètres dans ce contexte|
|C3523 d’erreur du compilateur|'sizeof...' requiert comme argument un pack de paramètres non développé|
|C3524 d’erreur du compilateur|«*identificateur*' : 'sizeof' ne peut pas être appliqué à un package de paramètres. Souhaitiez-vous utiliser 'sizeof...' ?|
|C3525 d’erreur du compilateur|«*paramètre*' : si un modèle de classe a un pack de paramètres de modèle qu’il doit apparaître à la fin de la liste de paramètres de modèle|
|C3526 d’erreur du compilateur|'...' ne peut pas être appliqué à 'this'|
|C3527 d’erreur du compilateur|«*identificateur*' n’est pas un opérande valide pour 'sizeof...'. Souhaitiez-vous utiliser 'sizeof' ?|
|C3528 d’erreur du compilateur|«*identificateur1*' : le nombre d’éléments dans cette expansion ne correspond pas au nombre d’éléments dans «*identificateur2*»|
|C3529 d’erreur du compilateur|«*paramètre*' : un package de paramètres de modèle ne peut pas avoir un argument par défaut|
...
|C3542 d’erreur du compilateur|«*identificateur*' : une fonction membre virtuelle n’aura pas un type de retour qui contient «*type*»|
|C3543 d’erreur du compilateur|«*type*' : ne contient pas d’un package de paramètres|
|C3544 d’erreur du compilateur|«*paramètre*' : package de paramètres attend un argument de modèle de type|
|C3545 d’erreur du compilateur|«*paramètre*' : package de paramètres attend un argument de modèle sans type|
|C3546 d’erreur du compilateur|'...' : il en existe aucun package de paramètres disponibles pour développer|
...
|C3549 d’erreur du compilateur|«*valeur*' : un package de paramètres de fonction ne peut pas avoir un argument par défaut|
...
|[Erreur du compilateur C3552](compiler-error-c3552.md)|attendu 'decltype (auto)'|
...
|C3561 d’erreur du compilateur|vignette d’opération de cloisonnement trouvée dans le flux de contrôle qui n’est pas uniforme de la vignette lors de la compilation du graphique des appels pour Concurrency::parallel_for_each à l’emplacement : '*fonction*'|
|C3562 d’erreur du compilateur|fonction intrinsèque '*fonction*' est limité à n’ont pas plus de *nombre* paramètres|
...
|C3564 d’erreur du compilateur|lecture de la valeur non initialisée lors de la compilation du graphique des appels pour Concurrency::parallel_for_each à l’emplacement : '*fonction*'|
|C3565 d’erreur du compilateur|La quantité totale de mémoire tile_static (*nombre* octets) dépasse la limite de *nombre* octets lors de la compilation du graphique des appels pour Concurrency::parallel_for_each l’emplacement|
|C3566 d’erreur du compilateur|blocs avec effets imbriqués trop profondément lors de la compilation de l’appel de graphique pour Concurrency::parallel_for_each à l’emplacement : '*fonction*'|
...
|C3570 d’erreur du compilateur|utilisation non conforme d’amp restreint la portée lors de la compilation avec/CLR|
|C3571 d’erreur du compilateur|«*type*' : argument de domaine de calcul non conforme ; pas un type de classe|
|C3572 d’erreur du compilateur|«*type*' : argument de domaine de calcul non conforme ; membre public manquant : 'static const int rank' ou la valeur de classement n’est pas positif|
|C3573 d’erreur du compilateur|Le nombre d’instances de Concurrency::Graphics :: Sampler passées à concurrency::parallel_for_each ne peut pas dépasser *nombre*|
|C3574 d’erreur du compilateur|«*type*' : étendues de mosaïque non conforme : doivent être positives et (1) Z < = *nombre*; (2) Z*Y*X < = *nombre*|
|C3575 d’erreur du compilateur|«*type*' : argument de domaine de calcul non conforme ; membre public manquant : ' concurrency::index <*nombre*> _map_index (const concurrency::index <*nombre*> &) Restrict (amp) '|
|C3576 d’erreur du compilateur|«*type*' : argument Concurrency::Details :: _parallel_for_each #*nombre* a type non pris en charge|
|C3577 d’erreur du compilateur|argument de noyau Concurrency::parallel_for_each n’est pas conforme : ne peut pas résoudre l’appel au membre ' void operator() (*type*) Restrict (amp) '|
|C3578 d’erreur du compilateur|La taille de l’objet de fonction passée à concurrency::parallel_for_each ne peut pas dépasser *nombre* octets|
...
|C3581 d’erreur du compilateur|«*type*' : type non pris en charge dans amp le code restreint|
|C3582 d’erreur du compilateur|Obsolète.|
|C3583 d’erreur du compilateur|«*identificateur*' : la taille de la variable (*nombre* octets) est supérieure à la taille maximale (*nombre* octets) prise en charge dans le code restreint amp|
|C3584 d’erreur du compilateur|non pris en charge de l’utilisation de tile_static sur '*identificateur*'|
|C3585 d’erreur du compilateur|«*identificateur*' code restreint à la classe de stockage non pris en charge dans amp-a|
...
|C3587 d’erreur du compilateur|dynamic_cast non pris en charge dans le code restreint amp|
|C3588 d’erreur du compilateur|conversion de '*type1*'en'*type2*' non pris en charge dans le code restreint amp|
|C3589 d’erreur du compilateur|«*chaîne*' : le code non pris en charge l’utilisation de littéraux de chaîne dans amp restreint|
|C3590 d’erreur du compilateur|«*jeton*' : la capture par référence ou capture de 'thie' est non pris en charge si l’expression lambda est restreinte à amp|
|C3591 d’erreur du compilateur|opérateur typeid non pris en charge dans le code restreint amp|
|C3592 d’erreur du compilateur|L’assembly natif inline ('__asm') non pris en charge dans le code restreint amp|
|C3593 d’erreur du compilateur|'goto' non pris en charge dans le code restreint amp|
|C3594 d’erreur du compilateur|gestion des exceptions (try, catch, throw, etc.) non pris en charge dans le code restreint amp|
|C3595 d’erreur du compilateur|valeur de constante est hors plage prise en charge dans le code restreint amp|
...
|C3597 d’erreur du compilateur|«*paramètre*' : '*identificateur*' ne peut pas être capturées par valeur si l’expression lambda est restreinte à amp|
|C3598 d’erreur du compilateur|instruction d’étiquette non pris en charge dans le code restreint amp|
|C3599 d’erreur du compilateur|«*opérateur*' : Impossible d’effectuer des opérations arithmétiques de pointeur sur pointeur vers booléen dans le code restreint amp|
|C3600 d’erreur du compilateur|'*(fonction)*' : utiliser de vignette\_mémoire statique détectée lors de la compilation du graphique des appels pour le concurrency::parallel non en mosaïque\_for_each à : '*fonction*'|
|C3601 d’erreur du compilateur|«*type*' : est de type d’argument non valide pour la fonction de diagnostic amp '*fonction*»|
...
|C3605 d’erreur du compilateur|Le nombre total d’échantillons (*nombre* capturées et *nombre* prédéfinis) dépassent *nombre* lors de la compilation du graphique des appels pour Concurrency::parallel_for_each à l’emplacement : ' *fonction*'|
...
|C3614 d’erreur du compilateur|Valeurs différentes pour la taille de pack dans la même classe. précédent était «*valeur*«, nouvelle valeur est »*valeur*'|
...
|C3620 d’erreur du compilateur|«*type*' : définition de l’alignement n’est pas autorisée sur les types WinRT|
|C3621 d’erreur du compilateur|«*type*' : uniquement la compression par défaut valeur (*nombre*) n’est autorisée pour les types WinRT|
...
|C3629 d’erreur du compilateur|«*jeton*' : une capture par défaut ne peut apparaître au début d’une liste de capture lambda|
...
|C3647 d’erreur du compilateur|Obsolète.|
...
|C3660 d’erreur du compilateur|«*member1*' : masque le membre hérité '*member2*»|
...
|C3676 d’erreur du compilateur|«*classe*' : classe ref et la classe de base ont des attributs incompatibles ' [*attribut*] »|
|C3677 d’erreur du compilateur|littéral de chaîne après que 'operator' ne peut pas avoir un préfixe d’encodage|
|C3678 d’erreur du compilateur|littéral de chaîne après 'operator' doit être une chaîne vide « « « « »|
|C3679 d’erreur du compilateur|attendait un identificateur de suffixe littéral après ' opérateur « « « »|
|C3680 d’erreur du compilateur|Impossible de concaténer des littéraux de chaîne définie par l’utilisateur avec les identificateurs de suffixe littéral incompatibles|
|C3681 d’erreur du compilateur|'fallthrough' : attribut peut uniquement apparaître dans une instruction switch englobante|
|C3682 d’erreur du compilateur|' opérateur *identificateur*' : modèle d’opérateur littéral opérateur/littéral ne peut pas être déclaré comme ayant 'C linkage'|
|C3683 d’erreur du compilateur|Impossible de définir un opérateur littéral brut et modèle d’opérateur littéral avec le même identificateur de suffixe littéral|
|C3684 d’erreur du compilateur|' opérateur *identificateur*' : déclaration d’opérateur de littéral a une liste de paramètres non valides|
...
|C3688 d’erreur du compilateur|suffixe littéral non valide '*suffixe*' ; littéral opérateur ou modèle d’opérateur littéral ' opérateur *identificateur*' introuvable|
...
|C3690 d’erreur du compilateur|une littéral de chaîne attendu, mais trouvé une chaîne définie par l’utilisateur littéral à la place|
|C3691 d’erreur du compilateur|préfixe de littéral non valide '*préfixe*'|
...
|C3742 d’erreur du compilateur|«*token1*' : dans l’argument d’attribut de séquence de jeton déséquilibrée '*attribut*«, attendu »*token2*»|
...
|C3758 d’erreur du compilateur|«*membre*' : fonction virtuelle ne peut pas être déclarée 'constexpr'|
|Erreur C3759 erreur de compilateur|«*membre*' : fonction membre de type non littéral ne peut pas être déclarée 'constexpr'|
|C3760 d’erreur du compilateur|Utilisez le mot clé __property pour déclarer la propriété dans gérés/WinRT '*classe*'|
...
|C3773 d’erreur du compilateur|Veuillez utiliser / await de commutateur de compilateur pour activer les coroutines|
...
|C3777 d’erreur du compilateur|«*fonction*' : une coroutine ne peut pas accepter une liste d’arguments variable|
|C3778 d’erreur du compilateur|alloca : ne peut pas être utilisé dans une coroutine|
|C3779 d’erreur du compilateur|«*fonction*' : une fonction qui retourne '*type*' ne peut pas être utilisé avant d’être définie|
|C3780 d’erreur du compilateur|«*fonction*' : une conversion de fonction qui retourne*type*' ne peut pas être utilisé avant d’être définie|
...
|C3795 d’erreur du compilateur|Obsolète.|
...
|C3806 d’erreur du compilateur|«*jeton*' : jeton inattendu, attendu un ' {' ou un initialiseur de membre|
...
|C3827 d’erreur du compilateur|attribut standard 'deprecated' peut avoir aucun argument ou un littéral de chaîne décrivant la raison|
...
|C3829 d’erreur du compilateur|l’attribut standard 'noreturn' peut uniquement être appliqué aux fonctions|
...
|C3837 d’erreur du compilateur|les attributs ne sont pas autorisés dans ce contexte|
...
|C3843 d’erreur du compilateur|«*identificateur*' : qualificateurs ref sur les fonctions membres de types / WinRT gérées ne sont pas pris en charge.|
|C3844 d’erreur du compilateur|«*identificateur*' : ne peut pas importer le symbole de '*source*' : en tant que*identificateur*' existe déjà dans la portée actuelle|
...
|C3863 d’erreur du compilateur|type de tableau '*type*' n’est pas attribuable|
...
|C3870 d’erreur du compilateur|«*paramètre*' : ' __declspec (*spécificateur*)' peut uniquement être appliqué aux paramètres de type intégral|
...
|C3875 d’erreur du compilateur|appel d’une fonction membre non statique liste d’arguments manquante|
|C3876 d’erreur du compilateur|Obsolète.|
|C3877 d’erreur du compilateur|Obsolète.|
|C3878 d’erreur du compilateur|Obsolète.|
|C3879 d’erreur du compilateur|«*membre*' : ne peut pas être une donnée membre initonly|
|[Erreur du compilateur C3880](compiler-error-c3880.md)|«*membre*' : ne peut pas être une donnée membre littérale|
|C3881 d’erreur du compilateur|peut uniquement hériter de constructeur de base directe|
...
|C3906 d’erreur du compilateur|le type intrinsèque '*type*' n’est pas un type de retour ou argument pris en charge pour les fonctions vararg ou non prototypées|
...
|C3925 d’erreur du compilateur|attendu d’une boucle (pour, while ou do) suivant '*directive*» (directive)|
|C3926 d’erreur du compilateur|constante non valide dans la directive 'parallel'|
|C3927 d’erreur du compilateur|'->' : type de retour de fin n’est pas autorisée après un déclarateur de fonction non|
|C3928 d’erreur du compilateur|'->' : type de retour de fin n’est pas autorisée après un déclarateur entre parenthèses|
...
|C3934 d’erreur du compilateur|une fonction qui se trouve dans n’importe quel formulaire de 'main' ne peut pas avoir de spécificateurs de restriction autres que Restrict (CPU)|
...
|C3937 d’erreur du compilateur|spécificateur de restriction vide n’est pas autorisée.|
...
|C3939 d’erreur du compilateur|«*identificateur*' : pointeur aux fonctions membres, pointeurs de fonction, les références aux fonctions avec spécificateur de restriction 'amp' ne sont pas autorisées|
|C3940 d’erreur du compilateur|«*identificateur*' : identificateur introuvable - incompatibilité possible entre le compilateur et les versions de la bibliothèque. Vérifiez que vccorlib.h/.lib, vccorlib120.dll et c1xx.dll correspondent|
|C3941 d’erreur du compilateur|«*condition*' : requiert ' / clr' option de ligne de commande|
|C3942 d’erreur du compilateur|Obsolète.|
|C3943 d’erreur du compilateur|Obsolète.|
...
|C3948 d’erreur du compilateur|«*mot clé*' : une expansion de package ne peut pas apparaître dans ce contexte|
...
|C3951 d’erreur du compilateur|Impossible d’utiliser le pointeur vers membre dans type WinRT projeté '*type*». Utilisez un délégué à la place.|
...
|C3953 d’erreur du compilateur|Ne peut pas utiliser une classe managée*type*» dans le module de WinRT.|
...
|C3959 d’erreur du compilateur|'ref new' peut uniquement être utilisé pour créer un objet avec le type de WinRT|
|C3960 d’erreur du compilateur|Obsolète.|
|C3961 d’erreur du compilateur|constructeur statique n’est pas pris en charge.|
|C3962 d’erreur du compilateur|classe générique n’est pas pris en charge.|
|C3963 d’erreur du compilateur|tableau multidimensionnel n’est pas pris en charge.|
|C3964 d’erreur du compilateur|tableau en escalier n’est pas pris en charge.|
|C3965 d’erreur du compilateur|tableau de paramètres n’est pas pris en charge.|
|C3966 d’erreur du compilateur|«*fonction*' : fonction générique n’est pas pris en charge.|
|C3967 d’erreur du compilateur|lors de l’importation '*identificateur*'de module'*module*'|
...
|C3969 d’erreur du compilateur|noms de modules incohérents : '*module1*'et'*module1*'|
|C3970 d’erreur du compilateur|«*identificateur*' : '*mot clé*' peut uniquement être appliqué à 'ref class' ou 'ref struct' dans la portée globale ou de la portée espace de noms|
|C3971 d’erreur du compilateur|«*type*' : définition partielle ne peut pas apparaître après une définition complète|
...
|C3976 d’erreur du compilateur|«*identificateur1*'doit être déclarée comme étant « public » afin d’utiliser'*identificateur2*»|
...
|C3979 d’erreur du compilateur|'*type*' : utilisez l’attribut '*attribut*« au lieu de »*valeur*'|
|C3980 d’erreur du compilateur|«*type*' ne peut pas être émis dans des métadonnées|
|C3981 d’erreur du compilateur|«*type*' : un type valeur ne peut pas avoir des données membres static*identificateur*»|
|C3982 d’erreur du compilateur|«*type*' : un type valeur ne peut pas avoir tous les membres données non publiques*identificateur*»|
|C3983 d’erreur du compilateur|«*type*' : un type valeur ne peut pas avoir de des membres de données non publics*identificateur*»|
|C3984 d’erreur du compilateur|«*type*' : un type non-valeur ne peut pas avoir des données membres publiques*identificateur*»|
|C3985 d’erreur du compilateur|«*identificateur*' : signature du membre public contient un type privé '*membre*»|
|C3986 d’erreur du compilateur|«*identificateur*' : signature du membre public contient un type natif '*membre*»|
|C3987 d’erreur du compilateur|«*identificateur*' : signature du membre public contient un type natif '*type*»|
...
|C3991 d’erreur du compilateur|«*type*' : ne peut pas implémenter une interface non publique ni imbriquée '*interface*»|
|C3992 d’erreur du compilateur|«*identificateur*' : signature du membre public contient le type non valide '*type*»|
...
|C3999 d’erreur du compilateur|Erreur inconnue choisissez la commande Support technique dans le menu aide de Visual C++ ou ouvrez le fichier d’aide de Support technique pour plus d’informations|
