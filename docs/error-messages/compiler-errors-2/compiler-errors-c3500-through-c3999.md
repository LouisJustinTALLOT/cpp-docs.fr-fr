...
|[Erreur du compilateur C3507](compiler-error-c3507.md)|un ProgID ne peut être pas dépasser 39 caractères*progid*' ; ni contenir n’importe quel signe de ponctuation différencient de '.'; ni commencer par un chiffre|
...
|[Erreur du compilateur C3510](compiler-error-c3510.md)|ne peut pas trouver la bibliothèque de types dépendante *bibliothèque*|
...
|C3516 d’erreur du compilateur|fin de fichier inattendue rencontrée lors du traitement de la chaîne brute littérale ; séquence du délimiteur '*chaîne*' ne correspond pas|
|Erreur C3517 erreur de compilateur|'*identificateur*' une déclaration d’alias ne peut pas avoir un type contenant 'auto'|
|C3518 d’erreur du compilateur|'*identificateur*' : dans un contexte d’initialisation de liste directe le type de '*type*' ne peut être déduit qu’à partir d’une seule expression d’initialiseur|
|[Erreur du compilateur C3519](compiler-error-c3519.md)|'*paramètre*' : paramètre non valide pour l’attribut embedded_idl|
|C3520 d’erreur du compilateur|'*identificateur*' : pack de paramètre doit être développé dans ce contexte|
|C3521 d’erreur du compilateur|'*identificateur*' n’est pas un package de paramètres|
|C3522 d’erreur du compilateur|'*type*' : package de paramètres ne peut pas être développé dans ce contexte|
|C3523 d’erreur du compilateur|'sizeof...' requiert comme argument d’un package de paramètres non développé|
...
|C3525 d’erreur du compilateur|'*paramètre*' : si un modèle de classe a un pack de paramètre de modèle qu’il doit apparaître à la fin de la liste de paramètres de modèle|
...
|C3529 d’erreur du compilateur|'*paramètre*' : un pack de paramètre de modèle ne peut pas avoir d’argument par défaut|
...
|[Erreur du compilateur C3535](compiler-error-c3535.md)|ne peut pas déduire le type de '*type1*'de'*type2*'|
|[Erreur du compilateur C3536](compiler-error-c3536.md)|'*identificateur*' : ne peut pas être utilisée avant d’être initialisée|
...
|C3546 d’erreur du compilateur|'...' : il n’existe aucun package de paramètres à développer|
...
|C3570 d’erreur du compilateur|utilisation non conforme de l’amp la portée restreinte lors de la compilation avec /clr|
...
|C3591 d’erreur du compilateur|typeid (opérateur) non pris en charge dans le code restreint amp|
...
|C3594 d’erreur du compilateur|exceptions (try, catch, throw, etc.) non pris en charge dans le code restreint amp|
|C3595 d’erreur du compilateur|valeur de constante est en dehors de la plage prise en charge dans le code restreint amp|
...
|[Erreur du compilateur C3610](compiler-error-c3610.md)|'*identificateur*' : type de valeur doit être 'boxed' avant la méthode '*méthode*' peut être appelé|
...
|[C3615 d’erreur du compilateur](compiler-error-c3615.md)|la fonction constexpr '*fonction*' ne peut pas produire une expression constante|
...
|[Erreur du compilateur C3627](compiler-error-c3627.md)|Seul un type valeur peut être convertie (boxed)|
...
|[Erreur du compilateur C3661](compiler-error-c3661.md)|liste de substitution explicite n’a pas trouvé toutes les méthodes à substituer|
...
|[Erreur du compilateur C3672](compiler-error-c3672.md)|l’expression pseudo-destructeur peut uniquement être utilisée dans le cadre d’un appel de fonction|
...
|C3684 d’erreur du compilateur|' opérateur *identificateur*' : déclaration d’opérateur de littéral a une liste de paramètres non valide|
...
|[Erreur du compilateur C3702](compiler-error-c3702.md)|ATL est requis pour les événements COM|
...
|[Erreur du compilateur C3724](compiler-error-c3724.md)|doit #include < windows.h > pour utiliser multi-threading avec les événements|
...
|[Erreur du compilateur C3768](compiler-error-c3768.md)|ne peut pas prendre l’adresse d’une fonction vararg virtuelle dans du code managé pur|
...
|[Erreur du compilateur C3825](compiler-error-c3825.md)|'*type*' : une classe gérée/WinRT peut prennent uniquement en charge les événements gérés/WinRT|
...
|[Erreur du compilateur C3832](compiler-error-c3832.md)|'*typelib*' : bibliothèque de types semble comme si elle a été créée pour des pointeurs 32 bits ; Veuillez modifier le qualificateur 'ptrsize'|
...
|[Erreur du compilateur C3836](compiler-error-c3836.md)|un constructeur statique ne peut pas avoir une liste d’initialiseurs de membres|
...
|[Erreur du compilateur C3853](compiler-error-c3853.md)|'=' : réinitialisation d’une référence ou une assignation via une référence de fonction est non conforme|
...
|[Erreur du compilateur C3869](compiler-error-c3869.md)|liste de paramètres vide '()' est manquant pour le gcnew contrainte|
...
|[Erreur du compilateur C3904](compiler-error-c3904.md)|'*propriété*' : doit spécifier *nombre* ou des paramètres|
|C3905 d’erreur du compilateur|accès non alignés ne sont pas pris en charge pour le type intrinsèque '*type*'|
|C3906 d’erreur du compilateur|type intrinsèque '*type*' n’est pas un type de retour ou argument pris en charge pour les fonctions vararg ou non prototypées|
...
|C3927 d’erreur du compilateur|'->' : type de retour de fin n’est pas autorisé après un déclarateur de fonction non|
|C3928 d’erreur du compilateur|'->' : type de retour de fin n’est pas autorisé après un déclarateur entre parenthèses|
...
|C3934 d’erreur du compilateur|une fonction qui est dans un format de 'main' ne peut pas avoir de spécificateurs de restriction autres que Restrict (CPU)|
...
|C3949 d’erreur du compilateur|une expansion, '...' ne peut pas apparaître dans un déclarateur abstrait entre parenthèses|
...
|C3959 d’erreur du compilateur|'ref new' peut uniquement être utilisé pour créer un objet avec un type WinRT|
