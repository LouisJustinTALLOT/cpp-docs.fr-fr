...
```  
 ...
 Pour corriger cette erreur, appliquez le [objet](../../windows/object-cpp.md), [coclasse](../../windows/coclass.md), [event_source](../../windows/event-source.md), et [event_receiver](../../windows/event-receiver.md) attributs convenablement pour rendre le classes dans lesquelles vous utilisez les classes d’interface COM. Par exemple :  
