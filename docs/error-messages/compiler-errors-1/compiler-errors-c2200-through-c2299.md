...
|[Erreur du compilateur C2219](compiler-error-c2219.md)|Erreur de syntaxe : le qualificateur de type doit être postérieure à ' *'|
...
|[Erreur du compilateur C2246](compiler-error-c2246.md)|«*identificateur*' : membre de données statiques non conforme dans une classe définie localement|
|[Erreur du compilateur C2247](compiler-error-c2247.md)|«*identificateur*' non accessible, car '*class1*'utilisations'*spécificateur*' pour hériter de'*classe2*»|
...
|[Erreur du compilateur C2252](compiler-error-c2252.md)|une instanciation explicite d’un modèle peut se produire uniquement à la portée de l’espace de noms|
|[Erreur du compilateur C2253](compiler-error-c2253.md)|«*fonction*' : spécificateur pure ou abstraite spécificateur de substitution uniquement autorisé sur une fonction virtuelle|
