...
ms.locfileid: "73633195"
---
# <a name="fatal-error-c1049"></a>Erreur irrécupérable C1049

> argument numérique non valide '*value*'

CL. L’analyseur de ligne de commande EXE a trouvé une *valeur* alors qu’il attendait un argument numérique.
...
[/constexpr : profondeur](/cpp/build/reference/constexpr-control-constexpr-evaluation)\
[/constexpr :](/cpp/build/reference/constexpr-control-constexpr-evaluation)\ de trace
[/constexpr : étapes](/cpp/build/reference/constexpr-control-constexpr-evaluation)
