...
Vous pouvez obtenir C2059 si un symbole prend la valeur Nothing, comme cela peut se produire lorsque le symbole **/d**_symbol_ **=** est utilisé pour la compilation.
