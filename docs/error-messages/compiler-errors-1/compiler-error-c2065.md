...
Cette erreur peut également être due à la mise en conformité du compilateur pour Visual Studio 2005 : vérification des paramètres des Visual C++ attributs.
