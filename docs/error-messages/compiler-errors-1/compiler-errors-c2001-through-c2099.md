---
title: Erreurs du compilateur C2000 à C2099
ms.date: 04/21/2019
f1_keywords:
- C2000
- C2016
...
ms.locfileid: "62360487"
---
# <a name="compiler-errors-c2000-through-c2099"></a>Erreurs du compilateur C2000 à C2099
...
|Error|Message|
|-----------|-------------|
|Erreur du compilateur C2000|Erreur inconnue choisissez la commande Support technique dans le menu aide de Visual C++ ou ouvrez le fichier d’aide de Support technique pour plus d’informations|
...
|[Erreur du compilateur C2014](compiler-error-c2014.md)|commande de préprocesseur doit commencer comme premier espace blanc|
|[Erreur du compilateur C2015](compiler-error-c2015.md)|trop de caractères dans la constante|
|Erreur du compilateur C2016|C requiert qu’un struct ou une union possède au moins un membre|
...
|[Erreur du compilateur C2021](compiler-error-c2021.md)|pas de valeur d’exposant, d’attendue '*caractère*'|
|[Erreur du compilateur C2022](compiler-error-c2022.md)|«*nombre*' : trop grand pour un caractère|
|Erreur du compilateur C2023|«*identificateur*» : Alignement (*number1*) diffère de la déclaration antérieure (*number2*)|
|Erreur du compilateur C2024|l’attribut 'alignas' s’applique aux variables, les membres de données et les types de balises uniquement|
...
|Erreur du compilateur C2029|gauche de '*jeton*'spécifie la classe/struct/interface non défini'*identificateur*'|
...
|Erreur du compilateur C2031|un destructeur virtuel avec '*accessibilité*' accessibilité n’est pas autorisée pour ce type|
|[Erreur du compilateur C2032](compiler-error-c2032.md)|«*identificateur*' : fonction ne peut pas être membre de struct/union '*type*»|
...
|Erreur du compilateur C2035|un destructeur non virtuel avec '*accessibilité*' accessibilité n’est pas autorisée pour ce type|
|[Erreur du compilateur C2036](compiler-error-c2036.md)|«*identificateur*' : taille inconnue|
|Erreur du compilateur C2037|gauche de '*identificateur*'Spécifie un struct/union non défini'*type*'|
...
|[Erreur du compilateur C2040](compiler-error-c2040.md)|«*opérateur*' : '*identificateur1*'diffère dans les niveaux d’indirection de'*identificateur2*»|
...
|Erreur du compilateur C2049|«*identificateur*' : espace de noms non inline ne peut pas être rouverte comme inline|
...
|[Erreur du compilateur C2064](compiler-error-c2064.md)|le terme ne correspond pas à une prise de fonction *nombre* arguments|
|[Erreur du compilateur C2065](compiler-error-c2065.md)|«*identificateur*' : identificateur non déclaré|
|[Erreur du compilateur C2066](compiler-error-c2066.md)|cast en type fonction n’est pas conforme|
|[Erreur du compilateur C2067](compiler-error-c2067.md)|cast en type tableau non conforme|
|Erreur du compilateur C2068|utilisation non conforme d’une fonction surchargée. Liste d’arguments manquante ?|
...
|[Erreur du compilateur C2073](compiler-error-c2073.md)|«*identificateur*' : les éléments d’un tableau partiellement initialisé doivent avoir un constructeur par défaut|
|[Erreur du compilateur C2074](compiler-error-c2074.md)|«*identificateur*' : '*type*' initialisation nécessite une liste d’initialiseurs entre accolades|
...
|Erreur du compilateur C2080|«*identificateur*' : le type de '*type*' ne peut être déduit qu’à partir d’une seule expression d’initialiseur|
...
|[Erreur du compilateur C2095](compiler-error-c2095.md)|«*fonction*' : le paramètre réel a le type 'void' : paramètre *nombre*|
...
|Erreur du compilateur C2098|jeton inattendu après le membre de données '*identificateur*'|
