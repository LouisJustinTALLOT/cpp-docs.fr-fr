...
Cette erreur se produira également erreur PRJ0007 suivante : Impossible de créer la sortie répertoire 'répertoire'. Erreur PRJ0007 signifie que le répertoire $ (IntDir) n’a pas pu être créé, ce qui implique la création de fichiers temporaires échouera également.
