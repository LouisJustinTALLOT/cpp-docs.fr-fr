...
ms.locfileid: "34569954"
---
# <a name="linker-tools-errors-and-warnings"></a>Erreurs et avertissements des outils Éditeur de liens

LIEN, LIB, DUMPBIN et EDITBIN génèrent ces erreurs et avertissements.

[!INCLUDE[error-boilerplate](../../error-messages/includes/error-boilerplate.md)]

## <a name="linker-errors"></a>Erreurs de l’éditeur de liens
...
[Erreur des outils Éditeur de liens LNK1104](../../error-messages/tool-errors/linker-tools-error-lnk1104.md)

[Erreur des outils Éditeur de liens LNK1106](../../error-messages/tool-errors/linker-tools-error-lnk1106.md)

[Erreur des outils Éditeur de liens LNK1107](../../error-messages/tool-errors/linker-tools-error-lnk1107.md)

[Erreur des outils Éditeur de liens LNK1112](../../error-messages/tool-errors/linker-tools-error-lnk1112.md)

[Erreur des outils Éditeur de liens LNK1113](../../error-messages/tool-errors/linker-tools-error-lnk1113.md)

[Erreur des outils Éditeur de liens LNK1120](../../error-messages/tool-errors/linker-tools-error-lnk1120.md)

[Erreur des outils Éditeur de liens LNK1123](../../error-messages/tool-errors/linker-tools-error-lnk1123.md)

[Erreur des outils Éditeur de liens LNK1127](../../error-messages/tool-errors/linker-tools-error-lnk1127.md)

[Erreur des outils Éditeur de liens LNK1136](../../error-messages/tool-errors/linker-tools-error-lnk1136.md)

[Erreur des outils Éditeur de liens LNK1140](../../error-messages/tool-errors/linker-tools-error-lnk1140.md)

[Erreur des outils Éditeur de liens LNK1141](../../error-messages/tool-errors/linker-tools-error-lnk1141.md)

[Erreur des outils Éditeur de liens LNK1143](../../error-messages/tool-errors/linker-tools-error-lnk1143.md)

[Erreur des outils Éditeur de liens LNK1152](../../error-messages/tool-errors/linker-tools-error-lnk1152.md)

[Erreur des outils Éditeur de liens LNK1158](../../error-messages/tool-errors/linker-tools-error-lnk1158.md)

[Erreur des outils Éditeur de liens LNK1164](../../error-messages/tool-errors/linker-tools-error-lnk1164.md)

[Erreur des outils Éditeur de liens LNK1166](../../error-messages/tool-errors/linker-tools-error-lnk1166.md)

[Erreur des outils Éditeur de liens LNK1168](../../error-messages/tool-errors/linker-tools-error-lnk1168.md)

[Erreur des outils Éditeur de liens LNK1169](../../error-messages/tool-errors/linker-tools-error-lnk1169.md)

[Erreur des outils Éditeur de liens LNK1179](../../error-messages/tool-errors/linker-tools-error-lnk1179.md)

[Erreur des outils Éditeur de liens LNK1181](../../error-messages/tool-errors/linker-tools-error-lnk1181.md)

[Erreur des outils Éditeur de liens LNK1188](../../error-messages/tool-errors/linker-tools-error-lnk1188.md)

[Erreur des outils Éditeur de liens LNK1189](../../error-messages/tool-errors/linker-tools-error-lnk1189.md)

[Erreur des outils Éditeur de liens LNK1196](../../error-messages/tool-errors/linker-tools-error-lnk1196.md)

[Erreur des outils Éditeur de liens LNK1200](../../error-messages/tool-errors/linker-tools-error-lnk1200.md)

[Erreur des outils Éditeur de liens LNK1201](../../error-messages/tool-errors/linker-tools-error-lnk1201.md)

[Erreur des outils Éditeur de liens LNK1211](../../error-messages/tool-errors/linker-tools-error-lnk1211.md)

[Erreur des outils Éditeur de liens LNK1215](../../error-messages/tool-errors/linker-tools-error-lnk1215.md)

[Erreur des outils Éditeur de liens LNK1218](../../error-messages/tool-errors/linker-tools-error-lnk1218.md)

[Erreur des outils Éditeur de liens LNK1221](../../error-messages/tool-errors/linker-tools-error-lnk1221.md)

[Erreur des outils Éditeur de liens LNK1223](../../error-messages/tool-errors/linker-tools-error-lnk1223.md)

[Erreur des outils Éditeur de liens LNK1224](../../error-messages/tool-errors/linker-tools-error-lnk1224.md)

[Erreur des outils Éditeur de liens LNK1237](../../error-messages/tool-errors/linker-tools-error-lnk1237.md)

[Erreur des outils Éditeur de liens LNK1240](../../error-messages/tool-errors/linker-tools-error-lnk1240.md)

[Erreur des outils Éditeur de liens LNK1241](../../error-messages/tool-errors/linker-tools-error-lnk1241.md)
...
[Erreur des outils Éditeur de liens LNK1296](../../error-messages/tool-errors/linker-tools-error-lnk1296.md)

[Erreur des outils Éditeur de liens LNK1301](../../error-messages/tool-errors/linker-tools-error-lnk1301.md)

[Erreur des outils Éditeur de liens LNK1302](../../error-messages/tool-errors/linker-tools-error-lnk1302.md)

[Erreur des outils Éditeur de liens LNK1306](../../error-messages/tool-errors/linker-tools-error-lnk1306.md)

[Erreur des outils Éditeur de liens LNK1309](../../error-messages/tool-errors/linker-tools-error-lnk1309.md)
...
[Erreur des outils Éditeur de liens LNK2005](../../error-messages/tool-errors/linker-tools-error-lnk2005.md)

[Erreur des outils Éditeur de liens LNK2008](../../error-messages/tool-errors/linker-tools-error-lnk2008.md)

[Erreur des outils Éditeur de liens LNK2011](../../error-messages/tool-errors/linker-tools-error-lnk2011.md)

[Erreur des outils Éditeur de liens LNK2013](../../error-messages/tool-errors/linker-tools-error-lnk2013.md)

[Erreur des outils Éditeur de liens LNK2017](../../error-messages/tool-errors/linker-tools-error-lnk2017.md)

[Erreur des outils Éditeur de liens LNK2019](../../error-messages/tool-errors/linker-tools-error-lnk2019.md)

[Erreur des outils Éditeur de liens LNK2020](../../error-messages/tool-errors/linker-tools-error-lnk2020.md)

[Erreur des outils Éditeur de liens LNK2022](../../error-messages/tool-errors/linker-tools-error-lnk2022.md)

[Erreur des outils Éditeur de liens LNK2023](../../error-messages/tool-errors/linker-tools-error-lnk2023.md)

[Erreur des outils Éditeur de liens LNK2026](../../error-messages/tool-errors/linker-tools-error-lnk2026.md)

[Erreur des outils Éditeur de liens LNK2027](../../error-messages/tool-errors/linker-tools-error-lnk2027.md)

[Erreur des outils Éditeur de liens LNK2028](../../error-messages/tool-errors/linker-tools-error-lnk2028.md)

[Erreur des outils Éditeur de liens LNK2031](../../error-messages/tool-errors/linker-tools-error-lnk2031.md)

[Erreur des outils Éditeur de liens LNK2033](../../error-messages/tool-errors/linker-tools-error-lnk2033.md)

[Erreur des outils Éditeur de liens LNK2039](../../error-messages/tool-errors/linker-tools-error-lnk2039.md)

## <a name="linker-warnings"></a>Avertissements de l’éditeur de liens
...
[Outils de l’éditeur de liens LNK4020 d’avertissement](../../error-messages/tool-errors/linker-tools-warning-lnk4020.md)
