...
Pour plus d’informations personnalisé des étapes de génération et événements de build, consultez [compréhension des étapes de génération personnalisée et des événements de Build](../../build/understanding-custom-build-steps-and-build-events.md).