...
Lors de la génération d’une application ATL, l’utilisation de la macro `_ATL_MIXED` est requise dans tous les compilands, si elle est utilisée dans au moins un.
