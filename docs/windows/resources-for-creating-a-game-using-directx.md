---
title: Ressources pour la création C++ d’un jeu à l’aide de DirectX
ms.date: 06/08/2018
helpviewer_keywords:
- games [C++]
...
[Applications Windows Win32](../windows/windows-desktop-applications-cpp.md) contient des articles qui décrivent comment créer une application de bureau Windows de base.
