...
|[Module::releaseNotifier_, données de membre](../windows/module-releasenotifier-data-member.md)|Contient un pointeur vers un `ReleaseNotifier` objet.|
