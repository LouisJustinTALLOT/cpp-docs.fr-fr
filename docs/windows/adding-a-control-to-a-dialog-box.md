---
title: Ajout d’un contrôle à une boîte de dialogue | Documents Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
2.  Sous l’ [onglet de l’Éditeur de boîtes de dialogue](../windows/dialog-editor-tab-toolbox.md) de la [fenêtre Boîte à outils](/visualstudio/ide/reference/toolbox), sélectionnez le contrôle souhaité, puis :  
    ...
    -   Effectuez un glisser-déplacer du contrôle de la fenêtre Boîte à outils vers l’emplacement souhaité dans votre boîte de dialogue. Pour plus d’informations, consultez [Dimensionnement d’un contrôle pendant son ajout](../windows/sizing-a-control-while-you-add-it.md).  
  
         \- ou -  
  
    -   Double-cliquez sur le contrôle dans la fenêtre Boîte à outils (il apparaît dans votre boîte de dialogue), puis repositionnez le contrôle à l’emplacement de votre choix.  
  
 Pour plus d’informations sur les types de contrôle disponibles dans la fenêtre Boîte à outils, consultez [Onglet de l’Éditeur de boîtes de dialogue, fenêtre Boîte à outils](../windows/dialog-editor-tab-toolbox.md).  
