---
title: Répartition de l’espacement entre les contrôles | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
2.  À partir de la **Format** menu, choisissez **Espace uniformément**, puis choisissez un des espacements suivants :  
