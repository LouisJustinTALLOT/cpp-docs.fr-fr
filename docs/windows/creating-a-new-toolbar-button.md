---
title: Création d’un nouveau bouton de barre d’outils (C++) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "44314324"
---
# <a name="creating-a-new-toolbar-button-c"></a>Création d’un nouveau bouton de barre d’outils (C++)
