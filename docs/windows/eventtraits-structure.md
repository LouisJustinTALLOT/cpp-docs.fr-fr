---
title: EventTraits (Structure) | Documents Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "33873740"
---
# <a name="eventtraits-structure"></a>EventTraits (structure)
Définit les caractéristiques d’un handle de classe d’événements.  
