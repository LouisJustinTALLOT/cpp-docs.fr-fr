...
### <a name="to-create-a-256-color-icon-or-cursor"></a>Pour créer un curseur ou une icône de 256 couleurs  
...
2.  Dans le [boîte de dialogue Ajouter une ressource](../windows/add-resource-dialog-box.md), sélectionnez **icône** ou **curseur** et cliquez sur **nouveau**.  
