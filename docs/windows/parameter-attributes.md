---
title: Attributs de paramètre | Documents Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
|[iid_is](../windows/iid-is.md)|Spécifie l’index du premier élément du tableau doit être transmis.|  
