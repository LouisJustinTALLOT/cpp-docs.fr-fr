---
title: 'Comment : créer un fichier de Script de ressources (C++) | Microsoft Docs'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "44313238"
---
# <a name="how-to-create-a-resource-script-file-c"></a>Comment : créer un fichier de Script de ressources (C++)
