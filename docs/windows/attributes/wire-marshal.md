---
title: wire_marshal (C++ attribut COM)
ms.date: 10/02/2018
f1_keywords:
...
Le **wire_marshal** C++ attribut a les mêmes fonctionnalités que le [wire_marshal](/windows/desktop/Midl/wire-marshal) attribut MIDL.
