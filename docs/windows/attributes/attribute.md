...
> [!NOTE]
> Le **attribut** attribute est maintenant déconseillé.  Utilisez l’attribut runtime de langage commun `System.Attribute` à directement pour créer des attirbutes défini par l’utilisateur. Pour plus d’informations, consultez [User-Defined Attributes](../user-defined-attributes-cpp-component-extensions.md).

Vous définissez un [attribut personnalisé](custom-attributes-cpp.md) en plaçant le **attribut** attribut sur une définition de classe ou un struct managée. Le nom de la classe est l’attribut personnalisé. Exemple :
...
Pour obtenir la liste des types de paramètre d’attribut possibles, consultez [attributs personnalisés](custom-attributes-cpp.md).

Consultez [User-Defined Attributes](../user-defined-attributes-cpp-component-extensions.md) pour une discussion sur les cibles d’attribut.
