---
title: transmit_as (attribut de COM C++) | Microsoft Docs
ms.custom: ''
ms.date: 10/02/2018
ms.technology:
- cpp-windows
...
Le **transmit_as** attribut C++ a les mêmes fonctionnalités que le [transmit_as](/windows/desktop/Midl/transmit-as) attribut MIDL.
