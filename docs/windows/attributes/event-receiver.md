...
Le **event_receiver** C++ attribut spécifie que la classe ou structure à laquelle il est appliqué est un récepteur d’événements, à l’aide de l’élément visuel C++ modèle d’événement unifié.
