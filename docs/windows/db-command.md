...
> &nbsp;&nbsp;continuation de commande OLE DB  
...
Si la chaîne de commande contient un ou plusieurs paramètres comme \[db_column] ou \[bindto], **db_command** génère un ensemble de lignes et une table d’accesseurs pour traiter ces variables liées. Pour plus d’informations, consultez [db_accessor](../windows/db-accessor.md) .  
