...
- Pour afficher le **couleurs** fenêtre, avec le bouton droit dans une **Éditeur d’images** volet et choisissez **afficher la fenêtre des couleurs**, ou sélectionnez **afficher la fenêtre des couleurs**sur le [menu Image](../windows/image-menu-image-editor-for-icons.md).
...
1. Sur le **Éditeur d’images** barre d’outils (ou utilisez **Image** > **outils**), sélectionnez le **remplir** outil.
...
Pour inverser les couleurs dans la sélection actuelle, sur le **Image** menu, sélectionnez **inverser les couleurs**.
