...
2.  Dans le **rechercher** zone, sélectionnez une chaîne de recherche antérieure dans la liste déroulante ou tapez les données que vous souhaitez rechercher.  
