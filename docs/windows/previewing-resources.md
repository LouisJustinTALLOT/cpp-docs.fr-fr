...
3.  Dans le menu **vue**, cliquez sur **Pages de propriétés**.  
     ...
     La Page de propriétés pour la ressource s’ouvre, affichant un aperçu de cette ressource. Vous pouvez puis utilisez le haut et bas des touches de direction pour naviguer le contrôle d’arborescence dans l’affichage des ressources ou la fenêtre de document. La Page de propriétés reste ouverte et affiche toutes les ressources qui a le focus et sont en mesure d’afficher un aperçu.  
