...
|---------------------|-------------------------|----------------------------------------|---------------------------|--------------------|
|**Projet vide**|Oui|Oui|Oui|Aucune|
|**Symboles d’exportation**|Aucune|Non|Oui|Aucune|
|**En-tête précompilé**|Aucune|Non|Non|Oui|
|**prise en charge ATL**|Oui|Non|Non|Aucune|
