...
|---------------|-----------------|
|[Attributs de module](../windows/module-attributes.md)|S’applique à la [module](../windows/module-cpp.md) attribut.|
|[Attributs d’interface](../windows/interface-attributes.md)|S’applique à la [__interface](../cpp/interface.md) mot clé C++.|
|[Attributs de classe](../windows/class-attributes.md)|S’applique au mot clé C++.|
|[Attributs de méthode](../windows/method-attributes.md)|S’applique aux méthodes dans une classe, une coclasse ou une interface.|
