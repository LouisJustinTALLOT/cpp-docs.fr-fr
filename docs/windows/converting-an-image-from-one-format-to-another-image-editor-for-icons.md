...
### <a name="to-convert-an-image-from-one-format-to-another"></a>Convertir une image d’un format à un autre  
  
1.  Ouvrir l’image dans le **Image** éditeur.  
  
2.  À partir de la **fichier** menu, choisissez **enregistrer *nom de fichier* comme**.  
  
3.  Dans le **enregistrer le fichier sous** boîte de dialogue le **nom de fichier** , tapez le nom de fichier et l’extension correspondant au format souhaité.  
