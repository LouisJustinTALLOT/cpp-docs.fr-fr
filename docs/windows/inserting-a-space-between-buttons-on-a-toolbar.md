---
title: Insertion d’un espace entre les boutons sur une barre d’outils | Documents Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
1.  Faites glisser le bouton à droite ou vers le bas jusqu'à ce qu’il chevauche le bouton suivant sur la moitié.  
