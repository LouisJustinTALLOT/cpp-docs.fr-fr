---
title: Symboles de programmation de base de données MFC | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
|AFX_IDP_SQL_FIELD_NOT_FOUND|INCOMPATIBILITÉ DE AFX_IDP_SQL_FILED_SCHEMA_|
...
|MISES À JOUR AFX_IDP_SQL_NO_POSITIONED_|AFX_IDP_SQL_NO_ROWS_AFFECTED|
