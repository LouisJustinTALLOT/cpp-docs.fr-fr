...
L' **éditeur d’images** contient des outils de dessin et d’effacement FreeHand qui fonctionnent tous de la même façon. Vous sélectionnez l’outil et, si nécessaire, vous sélectionnez les couleurs de premier plan et d' [arrière-plan](./image-editor-for-icons.md) , ainsi que les options de taille et de forme. Vous déplacez ensuite le pointeur vers l’image, puis cliquez ou faites glisser pour dessiner et effacer.
...
> [!TIP]
> Les info-bulles s’affichent lorsque vous pointez votre curseur sur les boutons de la [barre d’outils de l’éditeur d’images](./image-editor-for-icons.md). Ces conseils vous aideront à identifier les boutons spécifiques mentionnés ici.
...
1. Si nécessaire, sélectionnez les couleurs et un pinceau :
   ...
   - Dans la [palette de couleurs](./image-editor-for-icons.md), sélectionnez le bouton gauche de la souris pour sélectionner une couleur de premier plan ou le bouton droit de la souris pour sélectionner une couleur d’arrière-plan.

   - Dans le [Sélecteur d’options](./image-editor-for-icons.md), sélectionnez une forme représentant le pinceau que vous souhaitez utiliser.
...
Appuyez sur la touche signe **plus** ( **+** ) pour doubler la taille du pinceau, ou sur la touche signe **moins** ( **-** ) pour la diviser en deux.
