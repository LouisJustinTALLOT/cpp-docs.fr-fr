---
title: Ajout d'une image pour un autre périphérique d'affichage (Éditeur d'images pour les icônes)
ms.date: 11/04/2016
helpviewer_keywords:
...
1. Sur le **Image** menu, cliquez sur **nouvelle Image de périphérique** (ou avec le bouton droit dans le **Éditeur d’images** volet et choisissez **nouvelle Image de périphérique** à partir de la menu contextuel).
