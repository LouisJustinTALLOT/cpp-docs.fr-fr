...
|----------------|----------------|
|[Éditeur d’accélérateurs](../windows/accelerator-editor.md)|Tables d’accélérateurs dans C++ les projets Visual Studio.|
...
|[Éditeur de boîtes de dialogue](../windows/dialog-editor.md)|Boîtes de dialogue dans les C++ projets Visual Studio.|
|[Éditeur d’image](../windows/image-editor-for-icons.md)|Bitmaps, icônes, curseurs et autres fichiers image dans des projets Visual C++, Visual Basic ou Visual C#.|
|[Éditeur de menus](../windows/menu-editor.md)|Ressources de menu dans les C++ projets Visual Studio.|
|[Éditeur Ribbon](../mfc/ribbon-designer-mfc.md)|Ressources de ruban dans les projets MFC.|
|[Éditeur de chaînes](../windows/string-editor.md)|Tables de chaînes dans les C++ projets Visual Studio.|
|[Éditeur de barres d’outils](../windows/toolbar-editor.md)|Ressources de barre d’outils C++ dans les projets Visual Studio. L' **éditeur de barres d’outils** fait partie de l' **éditeur d’images**.|
|[Éditeur d’informations sur la version](../windows/version-information-editor.md)|Informations de version dans les C++ projets Visual Studio.|
...
Les ressources peuvent également être modifiées en dehors du projet sans avoir ouvert le projet, consultez [Comment : créer des ressources](../windows/how-to-open-a-resource-script-file-outside-of-a-project-standalone.md).
...
1. Accédez à la **vue** de menu > autres **affichage des ressources** **Windows** > .
...
1. Dans le [fenêtre Propriétés](/visualstudio/ide/reference/properties-window), sélectionnez le bouton **pages de propriétés** .
   ...
   > [!TIP]
   > Utilisez un raccourci, accédez à la **vue** de menu > **pages de propriétés**.
