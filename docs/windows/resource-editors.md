...
1. Accédez au menu **vue** > **affichage des ressources**.
...
- Pour afficher une ressource managée dans un éditeur de ressources dans **l’Explorateur de solutions**, double-cliquez sur la ressource, par exemple, *Bitmap1.bmp*, et la ressource s’ouvre dans l’éditeur approprié.
