...
1. Dans le [fenêtre Propriétés](/visualstudio/ide/reference/properties-window), sélectionnez le bouton **pages de propriétés** .
   ...
   > [!TIP]
   > Utilisez un raccourci, accédez à la **vue**de menu @no__t**pages de propriétés**de-1.
