---
description: 'En savoir plus sur : détermination des dll à redistribuer'
...
|--------------------------|-----------------|----------------|
|*version* de vcruntime. dll|Bibliothèque Runtime pour le code natif.|Applications qui utilisent les services de démarrage et d’arrêt des langages C et C++ standard.|
