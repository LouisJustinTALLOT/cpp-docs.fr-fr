---
title: Suppression d’un bouton de barre d’outils | Documents Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "33871599"
---
# <a name="deleting-a-toolbar-button"></a>Suppression d'un bouton de barre d'outils
### <a name="to-delete-a-toolbar-button"></a>Pour supprimer un bouton de barre d’outils  
  
1.  Sélectionnez le bouton de barre d’outils et faites-le glisser en dehors de la barre d’outils.  
