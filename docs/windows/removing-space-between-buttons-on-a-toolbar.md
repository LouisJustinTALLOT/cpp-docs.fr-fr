---
title: Suppression d’un espace entre les boutons sur une barre d’outils | Documents Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
1.  Faites glisser le bouton sur le côté « un » de l’espace vers le bouton de l’autre côté de l’espace jusqu'à ce qu’il chevauche le bouton suivant de moitié.  
  
     Si aucun espace sur le côté du bouton que vous déplacez et que vous faites glisser le bouton plus de la moitié du bouton adjacent, l’éditeur de la barre d’outils insère également un espace sur le côté opposé du bouton que vous faites glisser.  
