...
1. Avec le bouton gauche de la souris, cliquez sur la couleur souhaitée dans le [palette de couleurs](../windows/colors-window-image-editor-for-icons.md).
