---
title: Modification du facteur d’agrandissement (Éditeur d’images pour les icônes) | Documents Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
2.  Sur le [barre d’outils Éditeur d’images](../windows/toolbar-image-editor-for-icons.md), cliquez sur la flèche située à droite de la [outil Loupe](../windows/toolbar-image-editor-for-icons.md) et sélectionnez le facteur d’agrandissement dans le sous-menu : **1 X**, **2 X**, **6 X**, ou **8 X**.  
  
    > [!NOTE]
    >  Pour sélectionner un facteur d’agrandissement autre que ceux répertoriés dans le **loupe** outil, utilisez les touches accélérateur.  
