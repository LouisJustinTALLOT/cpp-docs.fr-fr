---
title: Modification de la grille de disposition | Documents Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
### <a name="to-turn-the-layout-grid-on-or-off"></a>Pour activer ou désactiver la la grille de disposition  
...
2.  Dans le [repère, boîte de dialogue Paramètres](../windows/guide-settings-dialog-box.md), tapez la hauteur et la largeur dans DLU des cellules dans la grille. La largeur ou la hauteur minimale est 4 DLU. Pour plus d’informations sur DLU, consultez [organisation des contrôles dans les boîtes de dialogue](../windows/arrangement-of-controls-on-dialog-boxes.md).  
