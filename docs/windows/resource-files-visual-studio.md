...
## <a name="editable-resource-file-types"></a>Types de fichiers de ressources modifiables
...
L’environnement Visual Studio fonctionne avec et affecte les fichiers suivants pendant votre session de modification de ressources :
...
1. Accédez à **l’Explorateur de solutions** et développez le **fichiers de ressources** dossier.

   - Pour l’éditeur de texte, double-cliquez sur le fichier .manifest.

   - Pour d’autres éditeurs, cliquez sur le fichier .manifest, puis sélectionnez **ouvrir avec...** , puis spécifiez l’éditeur à utiliser et sélectionnez **Open**.
