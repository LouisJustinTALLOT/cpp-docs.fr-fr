...
## <a name="saving-bitmaps-as-gifs-or-jpegs"></a>Enregistrement de bitmaps au format GIF ou JPEG
...
1. Avec la bitmap est ouverte dans le **Image** éditeur, choisissez **enregistrer *filename*.bmp comme** sur le **fichier** menu.
...
## <a name="converting-an-image-from-one-format-to-another"></a>Conversion d'une image d'un format à un autre
...
1. À partir de la **fichier** menu, choisissez **enregistrer *filename* comme**.
