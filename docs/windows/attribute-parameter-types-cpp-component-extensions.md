---
title: Types de paramètre d’attribut (C++ / c++ / CLI et c++ / CX) | Microsoft Docs
ms.custom: ''
ms.date: 10/12/2018
ms.technology:
- cpp-windows
...
ms.locfileid: "49328166"
---
# <a name="attribute-parameter-types--ccli-and-ccx"></a>Types de paramètre d’attribut (C++ / c++ / CLI et c++ / CX)
