---
title: Ajout de contrôles à une boîte de dialogue entraîne la boîte de dialogue ne fonctionne plus | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
## <a name="the-fix-for-richedit-controls"></a>Le correctif pour les contrôles RichEdit  
 Vous devez appeler `LoadLibrary` des contrôles RichEdit. Pour plus d’informations, consultez [à l’aide du contrôle RichEdit 1.0 avec MFC](../windows/using-the-richedit-1-0-control-with-mfc.md), [sur les contrôles RichEdit](http://msdn.microsoft.com/library/windows/desktop/bb787873) dans le [!INCLUDE[winsdkshort](../atl-mfc-shared/reference/includes/winsdkshort_md.md)], et [vue d’ensemble du contrôle RichEdit](../mfc/overview-of-the-rich-edit-control.md).  
