---
title: Centrage des contrôles dans une boîte de dialogue (C++) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "46391291"
---
# <a name="centering-controls-in-a-dialog-box-c"></a>Centrage des contrôles dans une boîte de dialogue (C++)
...
2. À partir de la **Format** menu, choisissez **Centrer dans la boîte de dialogue**, puis choisissez une des options suivantes :
