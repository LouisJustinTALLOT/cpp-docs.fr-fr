...
1. Dans la barre de menus, choisissez **fichier**  >  **nouveau**  >  **projet** pour ouvrir la boîte de dialogue **nouveau projet** . Ensuite, dans le volet gauche de la boîte de dialogue, **Installed** développez le  >  nœud **autres types de projets** installés, puis sélectionnez **Visual Studio installer** . Dans le volet central, sélectionnez **Projet d’installation** .
