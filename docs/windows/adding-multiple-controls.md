---
title: Ajout de plusieurs contrôles | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
2. Mise en production la **Ctrl** clé et cliquez sur la boîte de dialogue autant de fois que vous souhaitez ajouter ce contrôle.
