---
title: Console d’Applications dans Visual C++ | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
|Titre|Description|
|-----------|-----------------|
|[Procédure pas à pas : création d’un programme C++ standard (C++)](../windows/walkthrough-creating-a-standard-cpp-program-cpp.md)|Explique comment créer une application console que les utilisateurs peuvent exécuter à partir de la ligne de commande.|
|[Création d’une application console](../windows/creating-a-console-application.md)|Fournit des informations sur les applications console.|