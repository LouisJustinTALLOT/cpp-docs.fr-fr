...
ms.locfileid: "56320677"
---
# <a name="editing-an-image"></a>Modification d’une Image
...
## <a name="selecting-an-image"></a>Sélection d’une image

1. Sur le **Éditeur d’images** barre d’outils (ou à partir de la **Image** menu, **outils** commande), choisissez l’outil de sélection que vous souhaitez.
...
1. Sélectionnez l’image en dehors de la sélection actuelle. La bordure de sélection met le focus et englobe l’image entière une fois encore.

## <a name="editing-parts-of-an-image"></a>Modification de parties d'une image
...
Sélectionnez **couper** sur le **modifier** menu.
...
1. Pour copier la sélection dans l’image à son emplacement actuel, cliquez à l’extérieur du curseur de sélection.
...
À partir de la **modifier** menu, choisissez **supprimer**.
...
## <a name="flipping-an-image"></a>Retournement d'une image
...
- Pour retourner l’image horizontalement (image miroir), à partir de la **Image** menu, choisissez **retournement Horizontal**.

- Pour retourner l’image verticalement (renverser), à partir de la **Image** menu, choisissez **retournement Vertical**.

- Faire pivoter de 90 degrés, l’image à partir de la **Image** menu, choisissez **pivoter de 90 degrés**.
...
## <a name="editing-an-image-outside-of-a-project"></a>Modification d'une image en dehors d'un projet
...
1. À partir de la **fichier** menu, sélectionnez **Open**.
...
## <a name="changing-image-properties"></a>Modification des propriétés d'une image
...
1. Dans le **propriétés** fenêtre, modifiez les propriétés de votre image.
   ...
   |**Height**|Définit la hauteur de l’image (en pixels). La valeur par défaut est 48. L’image est rognée ou espace vide est ajouté en dessous de l’image existante.|
   ...
   |**Width**|Définit la largeur de l’image (en pixels). La valeur par défaut pour les bitmaps est 48. L’image est rognée ou espace vide est ajouté à droite de l’image existante.|
