---
title: Dimensionnement d’un contrôle pendant son ajout | Documents Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
2.  Placez votre curseur (qui apparaît comme forme de croix) à l’emplacement souhaité pour l’angle supérieur gauche du nouveau contrôle dans votre boîte de dialogue.  
...
4.  Relâchez le bouton de la souris. Le contrôle est placé dans la boîte de dialogue dans la taille spécifiée.  
    ...
    > [!TIP]
    >  Vous pouvez redimensionner le contrôle après déposant sur la boîte de dialogue en déplaçant les poignées de redimensionnement sur la bordure du contrôle. Pour plus d’informations, consultez [dimensionnement de contrôles individuels](../windows/sizing-individual-controls.md).  
