...
Une instance du prédicat de type a la valeur true si le type *Ty* est un type arithmétique, autrement dit, un type intégral ou flottante point type, ou un `cv-qualified` forme d’un d’eux, sinon, sa valeur est false.
