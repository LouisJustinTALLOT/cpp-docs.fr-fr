...
Une instance du prédicat de type a la valeur true si le type *Ty* est un type arithmétique, autrement dit un type intégral ou un type à virgule flottante, `cv-qualified` ou une forme de l’un d’eux. sinon, sa valeur est false.
