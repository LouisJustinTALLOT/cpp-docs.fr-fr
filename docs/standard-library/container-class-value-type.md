---
title: Conteneur Class::value_type | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
ms.locfileid: "33841459"
---
# <a name="container-classvaluetype"></a>Conteneur Class::value_type
...
Est un synonyme du paramètre de modèle **Ty**.
...
Il est décrit ici comme un synonyme du type non spécifié **T4** (généralement, **Alloc::value_type**).
