...
*BidIt*<br/>
Type d'itérateur pour les sous-correspondances. Pour les cas courants de `string::const_iterator`, `wstring::const_iterator`, `const char*` ou `const wchar_t*`.
