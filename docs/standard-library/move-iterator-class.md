...
`right` L’itérateur à utiliser en tant que l’itérateur stocké.
...
`_Off` Un offset à ajouter à la position actuelle pour déterminer la nouvelle position actuelle.
