---
description: 'En savoir plus sur : classe is_enum'
...
ms.locfileid: "97231145"
---
# <a name="is_enum-class"></a>is_enum, classe
...
Une instance du prédicat de type a la valeur true si le type *Ty* est un type énumération ou une `cv-qualified` forme d’un type énumération. sinon, sa valeur est false.
