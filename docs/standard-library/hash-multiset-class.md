---
description: 'En savoir plus sur : classe hash_multiset'
...
*Oui*\
[hash_multiset](../standard-library/hash-multiset-class.md) copié dans le `hash_multiset`.
