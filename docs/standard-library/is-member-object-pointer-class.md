---
description: 'En savoir plus sur : classe is_member_object_pointer'
...
ms.locfileid: "97230928"
---
# <a name="is_member_object_pointer-class"></a>is_member_object_pointer, classe
...
Une instance du prédicat de type a la valeur true si le type *Ty* est un pointeur vers un objet membre ou un `cv-qualified` pointeur vers un objet membre. sinon, sa valeur est false. Notez que `is_member_object_pointer` contient false si *Ty* est un pointeur vers une fonction membre.
