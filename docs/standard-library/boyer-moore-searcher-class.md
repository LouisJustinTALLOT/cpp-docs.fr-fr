...
## <a name="boyer_moore_searcher-constructor"></a><a name="boyer-moore-searcher-constructor"></a>boyer_moore_searcher constructeur

Construit un `boyer_moore_searcher` objet de fonction en utilisant la séquence à rechercher, un objet de fonction de hachage, et une égalité prédicate.
