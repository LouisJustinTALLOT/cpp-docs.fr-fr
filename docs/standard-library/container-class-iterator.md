---
title: Conteneur Class::iterator | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
Il est décrit ici comme un synonyme du type non spécifié **T5**. Un objet de type **iterator** peut être casté en objet de type [const_iterator](../standard-library/container-class-const-iterator.md).
