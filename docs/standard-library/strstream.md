...
ms.locfileid: "68459087"
---
# <a name="ltstrstreamgt"></a>&lt;strstream&gt;

Définit plusieurs classes qui prennent en charge les opérations iostreams sur les séquences stockées dans un tableau alloué d’objets **char** . Ces séquences sont facilement converties vers et à partir de chaînes C.
...
> [!NOTE]
> Les classes dans \<strstream > sont déconseillées. Envisagez d’utiliser \<les classes dans sstream > à la place.
...
|||
|-|-|
|[strstreambuf, classe](../standard-library/strstreambuf-class.md)|La classe décrit une mémoire tampon de flux qui contrôle la transmission d’éléments vers et à partir d’une séquence d’éléments stockés dans un objet tableau de **caractères** .|
