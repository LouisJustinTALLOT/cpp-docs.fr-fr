---
description: 'En savoir plus sur : classe is_floating_point'
...
ms.locfileid: "97230976"
---
# <a name="is_floating_point-class"></a>is_floating_point, classe
...
Un type à virgule flottante est un de **`float`** , **`double`** ou **`long double`** .
