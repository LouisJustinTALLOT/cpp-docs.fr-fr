---
description: 'En savoir plus sur : classe is_member_pointer'
title: is_member_pointer, classe
ms.date: 11/04/2016
f1_keywords:
...
ms.locfileid: "97323644"
---
# <a name="is_member_pointer-class"></a>is_member_pointer, classe
...
Une instance du prédicat de type a la valeur true si le type *Ty* est un pointeur vers une fonction membre ou un pointeur vers un objet membre, ou une `cv-qualified` forme de l’un d’eux. sinon, sa valeur est false.
