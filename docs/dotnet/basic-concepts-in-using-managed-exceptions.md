...
2.  Une fois que le gestionnaire approprié est trouvé, la pile est déroulée à ce point. Pour chaque appel de fonction sur la pile, ses objets locaux sont détruits et __finally blocs sont exécutés à partir de la plupart imbriqué vers l’extérieur.  
