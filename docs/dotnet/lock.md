---
description: 'En savoir plus sur : verrouiller'
title: lock
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
ms.locfileid: "97344469"
---
# <a name="lock"></a>lock

Définit la `lock` classe qui automatise la synchronisation de l’accès à un objet.
...
[Lock, classe](../dotnet/lock-class.md)
