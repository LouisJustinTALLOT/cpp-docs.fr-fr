---
title: 'Comment : itérer une Collection définie par l’utilisateur avec for each | Microsoft Docs'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-cli
...
Pour une classe doit être une collection managée, il a besoin d’une fonction de GetEnumerator non privée qui retourne un handle vers une classe d’énumérateur ou une interface.  Une classe d’énumérateur doit contenir la déclaration de fonction de MoveNext non statique et une propriété Current.
