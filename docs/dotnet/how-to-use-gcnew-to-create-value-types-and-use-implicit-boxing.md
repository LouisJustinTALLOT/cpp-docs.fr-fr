...
À l’aide de [gcnew](../extensions/ref-new-gcnew-cpp-component-extensions.md) sur une valeur de type va créer un type valeur boxed, qui peut ensuite être placé sur le tas managé, le garbage collector.
