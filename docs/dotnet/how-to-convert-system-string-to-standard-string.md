---
title: 'Procédure : Convertir System::String en chaîne Standard'
...
ms.locfileid: "57749272"
---
# <a name="how-to-convert-systemstring-to-standard-string"></a>Procédure : Convertir System::String en chaîne Standard
