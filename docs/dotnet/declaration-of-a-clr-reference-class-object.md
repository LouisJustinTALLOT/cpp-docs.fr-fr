...
```  
 ...
 Dans la nouvelle syntaxe, toute initialisation ou assignation d’une valeur de type à un `Object` entraîne la conversion boxing implicit de ce type de valeur. Dans la nouvelle syntaxe, les deux `obj` et `obj2` sont initialisés en objets Int32 boxed les valeurs 0 et 1, respectivement. Par exemple :  
