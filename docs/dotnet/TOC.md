...
## [Procédure pas à pas : Compiler un programme C++/CLI qui cible le CLR](walkthrough-compiling-a-cpp-program-that-targets-the-clr-in-visual-studio.md)
## [Tâches C++/CLI](cpp-cli-tasks.md)
### [Guide pratique pour créer des projets vides CLR](how-to-create-clr-empty-projects.md)
### [Guide pratique pour créer des applications console CLR](how-to-create-clr-console-applications-cpp-cli.md)
...
### [Guide pratique pour définir et consommer des classes et des structs](how-to-define-and-consume-classes-and-structs-cpp-cli.md)
### [Sémantique de pile C++ pour les types de référence](cpp-stack-semantics-for-reference-types.md)
### [Opérateurs définis par l'utilisateur](user-defined-operators-cpp-cli.md)
### [Conversions définies par l’utilisateur](user-defined-conversions-cpp-cli.md)
### [initonly](initonly-cpp-cli.md)
### [Guide pratique pour définir et utiliser des délégués](how-to-define-and-use-delegates-cpp-cli.md)
...
### [Guide pratique pour définir un constructeur d’interface statique](how-to-define-an-interface-static-constructor-cpp-cli.md)
### [Guide pratique pour déclarer des spécificateurs de substitution dans les compilations natives](how-to-declare-override-specifiers-in-native-compilations-cpp-cli.md)
...
### [Expressions régulières](regular-expressions-cpp-cli.md)
### [Gestion de fichiers et E/S](file-handling-and-i-o-cpp-cli.md)
### [Opérations graphiques](graphics-operations-cpp-cli.md)
### [Opérations Windows](windows-operations-cpp-cli.md)
### [Accès aux données à l'aide d'ADO.NET](data-access-using-adonet-cpp-cli.md)
## [Interopérabilité native et .NET](native-and-dotnet-interoperability.md)
### [Interopérabilité avec d'autres langages .NET](interoperability-with-other-dotnet-languages-cpp-cli.md)
...
## [Code pur et vérifiable](pure-and-verifiable-code-cpp-cli.md)
### [Guide pratique pour créer des projets C++ vérifiables](how-to-create-verifiable-cpp-projects-cpp-cli.md)
### [Utilisation d'assemblys vérifiables avec SQL Server](using-verifiable-assemblies-with-sql-server-cpp-cli.md)
...
## [Sérialisation](serialization-cpp-cli.md)
## [Assemblys friend (C++)](friend-assemblies-cpp.md)
## [Types managés](managed-types-cpp-cli.md)
## [Réflexion](reflection-cpp-cli.md)
## [Assemblys de nom fort (signature d'assembly)](strong-name-assemblies-assembly-signing-cpp-cli.md)
## [Classe de débogage](debug-class-cpp-cli.md)
