---
title: Développement de jeux en C++
ms.date: 02/26/2019
...
ms.locfileid: "80079377"
---
# <a name="game-development-with-c"></a>Développement de jeux en C++
...
Le développement de jeux est documenté dans le [Centre de développement Windows](https://docs.microsoft.com/windows/uwp/gaming/getting-started).
