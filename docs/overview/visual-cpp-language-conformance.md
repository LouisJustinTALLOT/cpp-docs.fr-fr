...
description: Tableau des mises C++ à jour de conformité de Microsoft par version de Visual Studio.
ms.date: 03/17/2020
...
ms.locfileid: "80079370"
---
# <a name="microsoft-c-language-conformance-table"></a>Tableau de conformité du langage Microsoft C++

La conformité aux normes pour le compilateur C++ Microsoft dans Visual Studio (MSVC) est un travail en cours. Voici un résumé de la conformité de notre C++ langue et de votre bibliothèque ISO standard par rapport à Visual Studio version. Chaque nom de fonctionnalité du compilateur et de la bibliothèque standard est C++ lié au document de la proposition standard ISO qui décrit la fonctionnalité, si celle-ci est disponible au moment de la publication. La colonne **pris en charge** répertorie la version de Visual Studio dans laquelle la prise en charge de la fonctionnalité est apparue pour la première fois.

Pour plus d’informations sur les améliorations apportées à Visual Studio 2017 ou à Visual Studio 2019 MSVC, consultez [ C++ améliorations de la conformité dans Visual Studio](cpp-conformance-improvements.md). Pour obtenir la liste des autres modifications, consultez [nouveautés pour Visual C++ dans Visual Studio](what-s-new-for-visual-cpp-in-visual-studio.md). Pour passer en revue les changements de conformité dans les versions antérieures, consultez [Historique des modifications de Visual C++](../porting/visual-cpp-change-history-2003-2015.md) et [Nouveautés de Visual C++ entre 2003 et 2015](../porting/visual-cpp-what-s-new-2003-through-2015.md). Pour connaître l’actualité de l’équipe C++, visitez le [blog de l’équipe C++](https://devblogs.microsoft.com/cppblog/).

> [!NOTE]
> Aucun changement binaire cassant n’a été effectué entre Visual Studio 2015, Visual Studio 2017 et Visual Studio 2019. Pour plus d’informations, consultez [ C++ compatibilité binaire entre Visual Studio 2015, 2017 et 2019](../porting/binary-compat-2015-2017.md)
...
| &nbsp;&nbsp;[N1653 Préprocesseur C99](https://wg21.link/N1653) | Partiel <sup>[C](#note_C)</sup> |
...
| &nbsp;&nbsp;[N3760 \[\[attribut\]\] déconseillé](https://wg21.link/n3760) | VS 2015 |
...
| &nbsp;&nbsp;[P0188R1 \[\[attribut\]\] fallthrough](https://wg21.link/p0188r1) | VS 2017 15.0 <sup>[17](#note_17)</sup> |
...
| &nbsp;&nbsp;[P0212R1 \[\[attribut\]\] maybe_unused](https://wg21.link/p0212r1) | VS 2017 15.3 <sup>[17](#note_17)</sup> |
...
| &nbsp;&nbsp;[N4268 Autorisation de plusieurs arguments de modèle sans type](https://wg21.link/n4268) | VS 2017 15.5 <sup>[17](#note_17)</sup> |
...
| &nbsp;&nbsp;[N4261 Correction des conversions de qualifications](https://wg21.link/n4261) | VS 2017 15.7 <sup>[17](#note_17)</sup> |
...
| &nbsp;&nbsp;[P1771R1 \[\[noignore\]\] pour les constructeurs](https://wg21.link/p1771r1) | VS 2019 16,4 <sup> [17](#note_17)</sup> |
| &nbsp;&nbsp;[P1825R0 de texte de la fusion pour P0527R1 et P1155R3, plus les déplacements implicites](https://wg21.link/p1825r0) | VS 2019 16,4 <sup> [17](#note_17)</sup> |
...
| &nbsp;&nbsp;[P0806R2 Déconseiller cette capture implicite via \[=\]](https://wg21.link/P0806R2) | VS 2019 16,2 <sup> [20](#note_20)</sup> |
...
| &nbsp;&nbsp;[P0306R4 Ajout de \_\_VA_OPT\_\_ pour l’omission de virgule et la suppression de virgule](https://wg21.link/P0306R4) | VS 2019 16,5 <sup> [20](#note_20)</sup> |
...
| &nbsp;&nbsp;[P1161R3 déprécient les utilisations de l’opérateur virgule dans les expressions de sous-script](https://wg21.link/P1161R3) | VS 2019 16,5 <sup> [20](#note_20)</sup> |
| &nbsp;&nbsp;[P1301R4 \[\[noignore (« message »)\]\]](https://wg21.link/P1301R4) | VS 2019 16,5 <sup> [20](#note_20)</sup> |
| &nbsp;&nbsp;[P1703R1 reconnaissant les importations d’unités d’en-tête requiert un prétraitement complet](https://wg21.link/P1703R1) | VS 2019 16,5 <sup> [20](#note_20)</sup> |
| &nbsp;&nbsp;[P1946R0 autorisent les comparaisons par défaut par valeur](https://wg21.link/P1946R0) | VS 2019 16,5 <sup> [20](#note_20)</sup> |
...
| &nbsp;&nbsp;[P0388R4 autorisent les conversions en tableaux de limites inconnues](https://wg21.link/P0388R4) | Non |
...
| &nbsp;&nbsp;l' [interaction P0735R1 des memory_order_consume avec les séquences de mise en version](https://wg21.link/P0735R1) | Non |
| &nbsp;&nbsp;[P0784R7 plus conteneurs de constexpr](https://wg21.link/P0784R7) | Non |
| &nbsp;&nbsp;[P0840R2 \[\[attribut\]\] no_unique_address](https://wg21.link/P0840R2) | Non |
| &nbsp;&nbsp;[P0848R3 fonctions membres spéciales conditionnellement triviales](https://wg21.link/P0848R3) | Non |
...
| &nbsp;&nbsp;[P1152R4 dépréciant volatile](https://wg21.link/P1152R4) | Non |
...
| &nbsp;&nbsp;[P1331R2 autorisant l’initialisation triviale par défaut dans les contextes constexpr](https://wg21.link/P1331R2) | Non |
...
| &nbsp;&nbsp;[P1452R2 sur la sémantique non uniforme des exigences de type de retour](https://wg21.link/P1452R2) | Non |
| &nbsp;&nbsp;[P1616R1 à l’aide de cybercriminels sans contrainte avec des modèles concontraints](https://wg21.link/P1616R1) | Non |
| &nbsp;&nbsp;[P1668R1 autorisant l’assembly inline non évalué dans les fonctions constexpr](https://wg21.link/P1668R1) | Non |
| &nbsp;&nbsp;[P1766R1 atténuation des modules mineurs maladies](https://wg21.link/P1766R1) | Non |
| &nbsp;&nbsp;[des restrictions de redéfinition de P1811R0 pour la robustesse de](https://wg21.link/P1811R0) réexportation | Non |
| &nbsp;&nbsp;[P1814R0 CTAD pour les modèles d’alias](https://wg21.link/P1814R0) | Non |
| &nbsp;&nbsp;[P1816R0 CTAD pour les agrégats](https://wg21.link/P1816R0) | Non |
| &nbsp;&nbsp;[ordre d’initialisation dynamique P1874R1 des variables non locales dans les modules](https://wg21.link/P1874R1) | Non |
| &nbsp;&nbsp;[des incohérences P1907R1 avec des paramètres de modèle sans type](https://wg21.link/P1907R1) | Non |
| &nbsp;&nbsp;[P1971R0 les modifications de base pour NB commentaires à la réunion de novembre 2019 (Belfast)](https://wg21.link/P1971R0) | Non |
| &nbsp;&nbsp;[P1972R0 US105 vérifier la satisfaction des contraintes pour les non-modèles lors de la formation d’un pointeur vers une fonction](https://wg21.link/P1972R0) | Non |
| &nbsp;&nbsp;[P1975R0 de correction du libellé de l’initialisation d’agrégat entre parenthèses](https://wg21.link/P1975R0) | Non |
| &nbsp;&nbsp;[résolution P1979R0 en US086](https://wg21.link/P1979R0) | Non |
| &nbsp;&nbsp;[P1980R0 CA096 : correspondance de déclaration pour les clauses requires non dépendantes](https://wg21.link/P1980R0) | Non |
...
| &nbsp;&nbsp;[P1164R1 rendre create_directory () intuitif](https://wg21.link/P1164R1) | VS 2019 16.0 <sup>[20](#note_20)</sup> |
...
| &nbsp;&nbsp;[P0482R6 char8_t : type pour les chaînes et les caractères UTF-8](https://wg21.link/P0482R6) | VS 2019 16,2 <sup> [20](#note_20)</sup> |
| &nbsp;&nbsp;[P0600R1 \[\[nodiscard\]\] pour STL (première partie)](https://wg21.link/p0600r1) | VS 2019 16,2 <sup> [20](#note_20)</sup> |
...
| &nbsp;&nbsp;[P1754R1 renommer les concepts en standard_case](https://wg21.link/P1754R1) | VS 2019 16,4 <sup> [20](#note_20)</sup> |
| &nbsp;&nbsp;[P0325R4 to_array à partir de LFTS avec des mises à jour](https://wg21.link/P0325R4) | VS 2019 16,5 <sup> [20](#note_20)</sup> |
...
| &nbsp;&nbsp;[P0553R4 \<bits > fonctions de rotation et de comptage](https://wg21.link/P0553R4) | VS 2019 16,5 <sup> [20](#note_20)</sup> |
| &nbsp;&nbsp;[P0556R3 \<bits > ispow2 (), ceil2 (), floor2 (), log2p1 ()](https://wg21.link/P0556R3) | VS 2019 16,5 <sup> [20](#note_20)</sup> |
| &nbsp;&nbsp;[P0595R2 is_constant_evaluated ()](https://wg21.link/P0595R2) | VS 2019 16,5 <sup> [20](#note_20)</sup> |
| &nbsp;&nbsp;[P0631R8 \<nombres > constantes mathématiques](https://wg21.link/P0631R8) | VS 2019 16,5 <sup> [20](#note_20)</sup> |
...
| &nbsp;&nbsp;[contrat étroit P1355R2 pour ceil2 ()](https://wg21.link/P1355R2) | VS 2019 16,5 <sup> [20](#note_20)</sup> |
| &nbsp;&nbsp;[P1357R1 is_bounded_array, is_unbounded_array](https://wg21.link/P1357R1) | VS 2019 16,5 <sup> [20](#note_20)</sup> |
| &nbsp;&nbsp;[P1612R1 de réadressage de l’endian à \<bits >](https://wg21.link/P1612R1) | VS 2019 16,5 <sup> [20](#note_20)</sup> |
| &nbsp;&nbsp;[P1651R0 bind_front () ne doit pas être désencapsulée reference_wrapper](https://wg21.link/P1651R0) | VS 2019 16,5 <sup> [20](#note_20)</sup> |
| &nbsp;&nbsp;[P1690R1 affiner la recherche hétérogène pour les conteneurs non ordonnés](https://wg21.link/P1690R1) | VS 2019 16,5 <sup> [20](#note_20)</sup> |
| &nbsp;&nbsp;[P1902R1 de fonctionnalités manquantes-macros de Test 2017-2019](https://wg21.link/P1902R1) | VS 2019 16,5 <sup> [14](#note_14)</sup> |
...
| &nbsp;&nbsp;[P0768R1 Prise en charge des bibliothèques pour l’opérateur de comparaison spaceship \<=>](https://wg21.link/p0768r1) | Non |
...
| &nbsp;&nbsp;[P0435R1 Remaniant de common_type](https://wg21.link/p0435r1)<br/>&nbsp;&nbsp;[P0548R1 Adaptation de common\_type et de duration](https://wg21.link/p0548r1) | VS 2017 15.3 <sup>[14](#note_14)</sup> |
...
| &nbsp;&nbsp;[P0513R0 Empoisonnement du hachage](https://wg21.link/p0513r0)<br/>&nbsp;&nbsp;[P0599R1 Hash noexcept](https://wg21.link/p0599r1) | VS 2017 15.3 <sup>[14](#note_14)</sup> |
...
| &nbsp;&nbsp;[P0618R0 Dépréciation de \<codecvt>](https://wg21.link/p0618r0) | VS 2017 15.5 <sup>[17](#note_17)</sup> |
...
- VS 2019 16,4 : la surcharge de `to_chars()` à virgule flottante pour la précision générale.
...
[améliorations de la conformité dans Visual Studio\ C++ ](cpp-conformance-improvements.md)
[Nouveautés de Visual C++ Studio](what-s-new-for-visual-cpp-in-visual-studio.md)\
[Historique C++ des modifications visuelles 2003 à 2015](../porting/visual-cpp-change-history-2003-2015.md)\
[Nouveautés C++ de Visual 2003 à 2015](../porting/visual-cpp-what-s-new-2003-through-2015.md)\
