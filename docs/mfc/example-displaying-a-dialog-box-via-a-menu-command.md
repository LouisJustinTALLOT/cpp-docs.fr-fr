---
title: 'Exemple : Affichage d’une boîte de dialogue via une commande de Menu | Microsoft Docs'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
- Q251059 : Comment : fournir votre propre nom de classe de fenêtre pour une boîte de dialogue MFC
