...
4.  Utilisez la fenêtre Propriétés pour mapper des fonctions de gestionnaire de la classe de boîte de dialogue pour toute notification de contrôle header messages vous devez gérer (consultez [mappage des Messages à des fonctions](../mfc/reference/mapping-messages-to-functions.md)).  
...
4.  Utilisez la fenêtre Propriétés pour mapper des fonctions de gestionnaire de la classe d’affichage pour les messages de notification de n’importe quel contrôle header vous devez gérer (consultez [mappage des Messages à des fonctions](../mfc/reference/mapping-messages-to-functions.md)).  
