---
title: Procédures pas à pas (MFC) | Microsoft Docs
ms.custom: ''
ms.date: 09/20/2018
ms.technology:
- cpp-mfc
...
Cette section contient des articles qui vous guident tout au long de différentes tâches associées aux nouvelles fonctionnalités de la bibliothèque MFC.
...
Montre comment ajouter un objet graphique à un projet et explique comment animer.
