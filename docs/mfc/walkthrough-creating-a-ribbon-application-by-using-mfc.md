...
[Procédure : Personnaliser la barre d’outils Accès rapide](../mfc/how-to-customize-the-quick-access-toolbar.md)

[Procédure : Personnaliser le bouton d’Application](../mfc/how-to-customize-the-application-button.md)
