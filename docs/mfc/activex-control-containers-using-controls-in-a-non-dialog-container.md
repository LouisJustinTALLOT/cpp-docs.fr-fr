...
3.  Ajouter un `WM_CREATE` Gestionnaire de messages pour la classe `CMyView`.  
...
5.  Regénérez le projet. Un contrôle CERC est créé dynamiquement chaque fois que la vue de l’application est créée.  
