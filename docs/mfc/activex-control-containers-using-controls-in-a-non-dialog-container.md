...
1. Dans la fonction gestionnaire, `CMyView::OnCreate` , effectuez un appel à la fonction du contrôle `Create` à l’aide du pointeur **This** comme fenêtre parente :
