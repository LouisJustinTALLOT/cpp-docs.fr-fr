...
`RFX_Long` et `RFX_Int`: ce sont les fonctions RFX la plus simple. La valeur de données n’a pas besoin toute interprétation spéciale, et la taille des données est fixe.
