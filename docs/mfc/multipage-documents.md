---
description: En savoir plus sur les documents multipages
...
## <a name="print-time-pagination"></a><a name="_core_print.2d.time_pagination"></a> Pagination Print-Time
