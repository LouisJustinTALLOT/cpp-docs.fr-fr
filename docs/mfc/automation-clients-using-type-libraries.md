...
2.  Dans le **ajouter une classe** boîte de dialogue, sélectionnez le **c++ de Visual c++ / MFC** dossier dans le volet gauche. Sélectionnez le **classe MFC à partir de la TypeLib** icône dans le volet droit, cliquez sur **Open**.  
  
3.  Dans le **Assistant Ajouter une classe à partir d’une Typelib** boîte de dialogue, sélectionnez une bibliothèque de types à partir de la **bibliothèques de types disponibles** liste déroulante. Le **Interfaces** zone affiche les interfaces disponibles pour la bibliothèque de types sélectionnée.  
