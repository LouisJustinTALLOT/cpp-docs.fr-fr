---
description: 'En savoir plus sur : gestionnaires de messages'
...
Vous pouvez utiliser toutes les fonctionnalités de Microsoft Visual C++ et MFC pour écrire vos gestionnaires. Pour obtenir la liste de toutes les classes, consultez [vue d’ensemble](class-library-overview.md) de la bibliothèque de classes dans la *référence MFC*.
