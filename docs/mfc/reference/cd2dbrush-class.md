...
### <a name="return-value"></a>Valeur de retour  
 Une valeur entre 0 et 1 qui indique l’opacité du pinceau. Cette valeur est un multiplicateur constant qui met à l’échelle linéaire la valeur alpha de tous les pixels remplis par le pinceau. Les valeurs d’opacité sont ancrées dans la plage 0 à 1 avant qu’ils sont multipliés.  
