---
description: 'En savoir plus sur : création d’une application Web Browser-Style MFC'
...
> [!NOTE]
> Le contrôle ActiveX WebBrowser (et par conséquent `CHtmlView` ) est uniquement disponible pour les applications qui s’exécutent sous les versions de Windows dans lesquelles Internet Explorer 4,0 ou version ultérieure a été installé.
...
[MFC, exemple MFCIE](https://github.com/Microsoft/VCSamples/tree/master/VC2010Samples/MFC/internet)<br/>
