...
Pour communiquer avec un serveur Internet Gopher, vous devez d’abord créer une instance de [CInternetSession](../../mfc/reference/cinternetsession-class.md), puis appeler [CInternetSession :: GetGopherConnection](../../mfc/reference/cinternetsession-class.md#getgopherconnection), qui crée l’objet `CGopherConnection` et retourne un pointeur vers celui-ci. Vous ne créez jamais un objet `CGopherConnection` directement.
...
Cette fonction membre est appelée pour construire un objet `CGopherConnection`.
...
Vous ne créez jamais de `CGopherConnection` directement. Au lieu de cela, appelez [CInternetSession :: GetGopherConnection](../../mfc/reference/cinternetsession-class.md#getgopherconnection), qui crée un objet `CGopherConnection` et retourne un pointeur vers celui-ci.
...
*dwFlags*<br/>
N’importe quelle combinaison d’indicateurs de INTERNET_FLAG_*. Pour plus d’informations sur les indicateurs de\* INTERNET_FLAG_, consultez [CInternetSession :: OpenURL](../../mfc/reference/cinternetsession-class.md#openurl) .
