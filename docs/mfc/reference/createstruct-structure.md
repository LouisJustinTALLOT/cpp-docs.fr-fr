...
*lpszClass*<br/>
Pointe vers une chaîne se terminant par null qui spécifie le nom de la classe de la nouvelle fenêtre Windows (un [WNDCLASS](/windows/desktop/api/winuser/ns-winuser-tagwndclassa) structure ; pour plus d’informations, consultez le Kit de développement logiciel Windows).
