...
|**<**|Supprime la classe actuellement sélectionnée de la liste **Classes générées**. Estompé si aucune classe n’est actuellement sélectionné dans le **classes générées** liste.|  
|**<\<**|Supprime toutes les classes de la liste **Classes générées**. If grisé le **classes générées** liste est vide.|  
