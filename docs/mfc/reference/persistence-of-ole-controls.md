...
### <a name="remarks"></a>Notes  
 ...
 `PX_VBXFontConvert` doit être appelée uniquement lorsque le contrôle est réellement en cours de conversion à partir d’une application de formulaire VBX. Par exemple :  
