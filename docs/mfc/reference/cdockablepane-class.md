---
title: Classe CDockablePane | Documents Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
|Nom|Description|  
|----------|-----------------|  
|[CDockablePane::AttachToTabWnd](#attachtotabwnd)|Attache un volet à un autre volet. Cette opération crée un volet à onglets.|  
|[CDockablePane::CalcFixedLayout](#calcfixedlayout)|Retourne la taille du rectangle de volet.|  
|[CDockablePane::CanAcceptMiniFrame](#canacceptminiframe)|Détermine si le frame mini spécifié peut être ancré dans le volet.|  
|[CDockablePane::CanAcceptPane](#canacceptpane)|Détermine si un autre volet peut être ancré dans le volet actif.|  
...
|[CDockablePane::ConvertToTabbedDocument](#converttotabbeddocument)|Convertit un ou plusieurs volets ancrables à des documents avec onglet MDI.|  
...
|[CDockablePane::CreateDefaultPaneDivider](#createdefaultpanedivider)|Crée un séparateur par défaut dans le volet de car elle est en cours ancrée à une fenêtre frame.|  
...
|[CDockablePane::EnableAutohideAll](#enableautohideall)|Active ou désactive le mode de masquage automatique de ce volet, ainsi que d’autres volets dans le conteneur.|  
|[CDockablePane::EnableGripper](#enablegripper)|Affiche ou masque la légende (barre de redimensionnement).|  
|[CDockablePane::GetAHRestoredRect](#getahrestoredrect)|Spécifie la position du volet lorsqu’elle est visible dans le mode de masquage automatique.|  
...
|[CDockablePane::GetDockingStatus](#getdockingstatus)|Détermine la possibilité d’un volet ancré en fonction de l’emplacement du pointeur fourni.|  
|[CDockablePane::GetDragSensitivity](#getdragsensitivity)|Retourne le respect de glissement d’un volet d’ancrage.|  
...
|[CDockablePane::GetTabArea](#gettabarea)|Récupère la zone d’onglet pour le volet.|  
|[CDockablePane::GetTabbedPaneRTC](#gettabbedpanertc)|Retourne les informations de classe d’exécution sur une fenêtre à onglets qui est créée quand un autre volet est ancré dans le volet en cours.|  
...
|[CDockablePane::IsResizable](#isresizable)|Spécifie si le volet est redimensionnable.|  
...
|[CDockablePane::OnAfterChangeParent](#onafterchangeparent)|Appelé par le framework lorsque le parent d’un volet a été modifiée. (Substitue [CPane::OnAfterChangeParent](../../mfc/reference/cpane-class.md#onafterchangeparent).)|  
|[CDockablePane::OnAfterDockFromMiniFrame](#onafterdockfromminiframe)|Appelé par le framework lorsqu’une barre d’ancrage flottante est ancré à une fenêtre frame.|  
|[CDockablePane::OnBeforeChangeParent](#onbeforechangeparent)|Appelé par le framework lorsque le parent du volet est sur le point de changer. (Substitue [CPane::OnBeforeChangeParent](../../mfc/reference/cpane-class.md#onbeforechangeparent).)|  
|[CDockablePane::OnBeforeFloat](#onbeforefloat)|Appelé par l’infrastructure lorsqu’un volet est sur float. (Substitue [CPane::OnBeforeFloat](../../mfc/reference/cpane-class.md#onbeforefloat).)|  
|[CDockablePane::RemoveFromDefaultPaneDividier](#removefromdefaultpanedividier)|L’infrastructure appelle cette méthode lorsqu’un volet est en cours Annuler l’ancrage.|  
|[CDockablePane::ReplacePane](#replacepane)|Remplace le volet par un volet spécifié.|  
|[CDockablePane::RestoreDefaultPaneDivider](#restoredefaultpanedivider)|L’infrastructure appelle cette méthode comme un volet est désérialisé afin de restaurer le diviseur de volet par défaut.|  
...
|[CDockablePane::SetTabbedPaneRTC](#settabbedpanertc)|Définit les informations de classe runtime pour une fenêtre à onglets qui est créée lorsque deux volets ancrer ensemble.|  
|[CDockablePane::ShowPane](#showpane)|Affiche ou masque un volet.|  
|[CDockablePane::Slide](#slide)|Affiche ou masque un volet avec une animation glissante qui affiche uniquement lorsque le volet est en mode de masquage automatique.|  
|[CDockablePane::ToggleAutoHide](#toggleautohide)|Active ou désactive automatiquement le mode de masquage. (Substitue [CPane::ToggleAutoHide](../../mfc/reference/cpane-class.md#toggleautohide) .)|  
|[CDockablePane::UndockPane](#undockpane)|Détache un volet à partir de la fenêtre frame principale ou un conteneur de fenêtre mini-frame.|  
...
|[CDockablePane::CheckStopSlideCondition](#checkstopslidecondition)|Détermine quand un volet d’ancrage masquage automatique doit s’arrêter glissante.|  
|[CDockablePane::DrawCaption](#drawcaption)|Dessine la légende volet d’ancrage (barre de redimensionnement).|  
|[CDockablePane::OnPressButtons](#onpressbuttons)|Appelé lorsque l’utilisateur appuie sur un bouton de légende autre que le `AFX_HTCLOSE` et `AFX_HTMAXBUTTON` boutons.|  
|[CDockablePane::OnSlide](#onslide)|Appelé par le framework pour rendre l’effet de masquage automatique lorsque le volet est affiché ou masqué.|  
...
|[CDockablePane::m_nSlideSteps](#m_nslidesteps)|Spécifie la vitesse d’animation du volet lorsqu’elle est affichée ou masquée en mode de masquage automatique.|  
...
-   Passe un volet en mode de masquage automatique.  
  
-   Attachement d’un volet à une fenêtre à onglets.  
  
-   Flottante un volet dans une fenêtre mini-frame.  
...
-   Création d’un volet avec ou sans légende. La légende peut avoir une étiquette de texte et il peut être remplie avec un dégradé de couleur.  
...
-   Faites glisser un volet lors de l’affichage d’un rectangle de glissement.  
 ...
 Pour utiliser un volet d’ancrage dans votre application, dérivez votre classe de volet de la `CDockablePane` classe. Soit incorporer l’objet dérivé que dans l’objet de fenêtre frame principale ou dans un objet window qui contrôle l’instance de votre volet. Puis appelez le [CDockablePane::Create](#create) méthode ou la [CDockablePane::CreateEx](#createex) méthode lorsque vous traitez le message WM_CREATE dans la fenêtre frame principale. Pour finir, configurez l’objet de volet en appelant [CBasePane::EnableDocking](../../mfc/reference/cbasepane-class.md#enabledocking), [CBasePane::DockPane](../../mfc/reference/cbasepane-class.md#dockpane), ou [CDockablePane::AttachToTabWnd](#attachtotabwnd).  
  
## <a name="customization-tips"></a>Conseils de personnalisation  
 Les conseils suivants s’appliquent à `CDockablePane` objets :  
  
-   Si vous appelez [CDockablePane::AttachToTabWnd](#attachtotabwnd) pour deux volets à onglets non, ancrables, un pointeur vers une fenêtre à onglets s’affichera dans le `ppTabbedControlBar` paramètre. Vous pouvez continuer à ajouter des onglets dans la fenêtre à onglets à l’aide de ce paramètre.  
  
-   Le type d’un volet à onglets qui est créé par [CDockablePane::AttachToTabWnd](#attachtotabwnd) est déterminée par le `CDockablePane` de l’objet dans le *pTabControlBarAttachTo* paramètre. Vous pouvez appeler [CDockablePane::SetTabbedPaneRTC](#settabbedpanertc) pour définir le type de volet à onglets qui le `CDockablePane` va créer. Le type par défaut est déterminé par le `dwTabbedStyle` de [CDockablePane::Create](#create) lorsque vous créez le `CDockablePane`. Si *dwTabbedStyle* est le type par défaut est de AFX_CBRS_OUTLOOK_TABS [CMFCOutlookBar, classe](../../mfc/reference/cmfcoutlookbar-class.md); si *dwTabbedStyle* AFX_CBRS_REGULAR_TABS le type par défaut est [ Classe de CTabbedPane](../../mfc/reference/ctabbedpane-class.md).  
  
-   Si vous souhaitez ancrer un volet ancrable vers un autre, appelez le [CDockablePane::DockToWindow](#docktowindow) (méthode). Le volet d’origine doit être ancré à un emplacement avant d’appeler cette méthode.  
  
-   La variable membre [CDockablePane::m_bHideInAutoHideMode](#m_bhideinautohidemode) contrôles de comportement des volets ancrables dans automatique masquer en mode lorsque vous appelez [CDockablePane::ShowPane](#showpane). Si cette variable de membre est définie sur `TRUE`, volets ancrables et des boutons de masquage automatique seront masquées. Dans le cas contraire, ils glisser et l’extraction.  
  
-   Vous pouvez désactiver l’animation de masquage automatique en définissant le [CDockablePane::m_bDisableAnimation](#m_bdisableanimation) variable membre avec `TRUE`.  
...
##  <a name="attachtotabwnd"></a>  CDockablePane::AttachToTabWnd  
 Attache le volet actif à un volet cible, création d’un volet à onglets.  
...
1.  Les vérifications de framework si le volet cible *pTabControlBarAttachTo* est une expression régulière d’ancrage volet ou si elle est dérivée de [CBaseTabbedPane](../../mfc/reference/cbasetabbedpane-class.md).  
  
2.  Si le volet de la cible est un volet à onglets, le framework ajoute le volet actif sous forme d’onglet.  
  
3.  Si le volet de la cible est un volet d’ancrage standard, l’infrastructure crée un volet à onglets.  
  
    -   Le framework appelle `pTabControlBarAttachTo->CreateTabbedPane`. Le style du nouveau volet à onglets varie selon le `m_pTabbedControlBarRTC` membre. Par défaut, ce membre est défini à la classe d’exécution de [CTabbedPane](../../mfc/reference/ctabbedpane-class.md). Si vous passez le `AFX_CBRS_OUTLOOK_TABS` style en tant que le *dwTabbedStyle* paramètre à la [CDockablePane::Create](#create) méthode, l’objet de classe runtime est définie à la classe d’exécution de [CMFCOutlookBar ](../../mfc/reference/cmfcoutlookbar-class.md). Vous pouvez modifier ce membre à tout moment pour modifier le style du nouveau volet.  
  
    -   Lorsque cette méthode crée un volet à onglets, le framework remplace le pointeur vers `pTabControlBarAttachTo` (si le volet est ancré ou flottant dans une fenêtre mini-frame de multiples) avec un pointeur vers le nouveau volet à onglets.  
  
    -   Le framework ajoute le `pTabControlBarAttachTo` volet vers le volet à onglets en tant que le premier onglet. Le framework ajoute ensuite le volet actif en tant que deuxième onglet.  
...
4.  Si le volet actif est dérivé de `CBaseTabbedPane`, tous ses onglets sont déplacés vers `pTabControlBarAttachTo` et le volet actif est détruit. Par conséquent, soyez prudent lorsque vous appelez cette méthode, car un pointeur vers le volet actif peut être non valide lorsque la méthode retourne.  
 ...
 Si vous attachez un volet à un autre lors de la création d’une mise en page d’accueil, définissez `dockMethod` à `DM_SHOW`.  
  
 Le premier volet doivent être ancrés avant de joindre un autre volet à elle.  
...
### <a name="return-value"></a>Valeur de retour  
 A `CSize` objet qui contient la taille du rectangle de volet.  
...
### <a name="remarks"></a>Notes  
 L’infrastructure appelle cette méthode avant un volet est ancré sur le volet actif.  
...
-   Le Gestionnaire d’ancrage n’autorise pas les volets à masquage automatique.  
...
### <a name="return-value"></a>Valeur de retour  
 `TRUE` Si le volet ancrable peut être ancré à un autre volet ou à la fenêtre frame principale. dans le cas contraire, `FALSE`.  
...
### <a name="parameters"></a>Paramètres  
 [in] *bActiveTabOnly*  
 Lorsque vous convertissez un `CTabbedPane`, spécifiez `TRUE` pour convertir uniquement l’onglet actif. Spécifiez `FALSE` pour convertir tous les onglets dans le volet.  
...
### <a name="return-value"></a>Valeur de retour  
 `TRUE` Si la condition de masquage est satisfaite ; dans le cas contraire, `FALSE`.  
  
### <a name="remarks"></a>Notes  
 L’infrastructure utilise un minuteur à vérifier régulièrement s’il faut masquer un volet ancrable masquage automatique. La méthode retourne `TRUE` lorsque le volet n’est pas actif, le volet n’est pas en cours de redimensionnement et le pointeur de la souris ne se trouve pas sur le volet.  
...
##  <a name="checkstopslidecondition"></a>  CDockablePane::CheckStopSlideCondition  
 Détermine quand un volet d’ancrage masquage automatique doit s’arrêter glissante.  
...
### <a name="return-value"></a>Valeur de retour  
 `TRUE` Si la condition d’arrêt est satisfaite ; dans le cas contraire, `FALSE`.  
  
### <a name="remarks"></a>Notes  
 Lorsqu’un volet ancrable est défini en mode de masquage automatique, l’infrastructure utilise les effets glissantes pour afficher ou masquer le volet. L’infrastructure appelle cette fonction lorsque le volet est décalée. `CheckStopSlideCondition` Retourne `TRUE` lorsque le volet est totalement visible ou lorsqu’il est complètement masqué.  
  
 Substituez cette méthode dans une classe dérivée pour implémenter les effets de masquage automatique personnalisé.  
...
### <a name="return-value"></a>Valeur de retour  
 `TRUE` Si le volet ancrable est créé avec succès ; dans le cas contraire, `FALSE`.  
  
### <a name="remarks"></a>Notes  
 Crée un volet de Windows et l’attache à le `CDockablePane` objet.  
  
 Si le *dwStyle* style de fenêtre a le `CBRS_FLOAT_MULTI` indicateur, la fenêtre mini-frame peut flotter avec d’autres volets dans la fenêtre mini-frame. Par défaut, ancrer les volets permettre uniquement faire flotter individuellement.  
  
 Si le *dwTabbedStyle* le paramètre a la `AFX_CBRS_OUTLOOK_TABS` indicateur spécifié, le volet crée les volets à onglets de style Outlook lorsqu’un autre volet est attaché à ce volet en utilisant le [CDockablePane::AttachToTabWnd](#attachtotabwnd)(méthode). Par défaut, les volets ancrables créent les volets à onglets régulières de type [CTabbedPane](../../mfc/reference/ctabbedpane-class.md).  
  
##  <a name="createdefaultpanedivider"></a>  CDockablePane::CreateDefaultPaneDivider  
 Crée un séparateur par défaut dans le volet de car elle est en cours ancrée à une fenêtre frame.  
...
### <a name="parameters"></a>Paramètres  
 [in] *dwAlignment*  
 Spécifie le côté du frame principal auquel le volet est en cours ancré. Si *dwAlignment* contient le `CBRS_ALIGN_LEFT` ou `CBRS_ALIGN_RIGHT` indicateur, cette méthode crée une verticale ( `CPaneDivider::SS_VERT`) ligne de séparation ; sinon, cette méthode crée une horizontale ( `CPaneDivider::SS_HORZ`) séparateur.  
...
|`CBRS_ALIGN_BOTTOM`|Le volet est en cours ancré en bas de la zone cliente d’une fenêtre frame.|  
|`CBRS_ALIGN_LEFT`|Le volet est en cours ancré sur le côté gauche de la zone cliente d’une fenêtre frame.|  
|`CBRS_ALIGN_RIGHT`|Le volet est en cours ancré sur le côté droit de la zone cliente d’une fenêtre frame.|  
...
### <a name="remarks"></a>Notes  
 ...
 Remplacement de cette méthode dans une classe dérivée de personnaliser des volets à onglets sont créés et initialisés.  
  
 Le volet à onglets est créé selon les informations de classe runtime stockées dans le `m_pTabbedControlBarRTC` membre, qui est initialisé par le [CDockablePane::CreateEx](#createex) (méthode).  
...
### <a name="parameters"></a>Paramètres  
 ...
 [in] *dwAlignment*  
 `DWORD` qui spécifie le côté du volet à laquelle le conteneur est en cours ancré.  
  
 [in] *dockMethod*  
 Non utilisé.  
  
### <a name="return-value"></a>Valeur de retour  
 `TRUE` Si le conteneur a été correctement ancré sur le volet. dans le cas contraire, `FALSE`.  
...
|`CBRS_ALIGN_BOTTOM`|Le conteneur est en cours ancré en bas du volet.|  
...
### <a name="parameters"></a>Paramètres  
 [in] *bWasDocked*  
 Lorsque la méthode est retournée, cette valeur contient `TRUE` si le volet a été correctement ancrées ; sinon, il contient `FALSE`.  
  
### <a name="return-value"></a>Valeur de retour  
 Si le volet est ancré à une fenêtre à onglets, ou si une fenêtre à onglets a été créée à la suite d’ancrage, cette méthode retourne un pointeur vers la fenêtre à onglets. Si le volet est sinon ancré avec succès, cette méthode retourne le **cela** pointeur. Si d’ancrage a échoué, cette méthode retourne `NULL`.  
...
### <a name="parameters"></a>Paramètres  
 ...
 [in] *rectCaption*  
 Spécifie le rectangle englobant du légende du volet.  
...
### <a name="parameters"></a>Paramètres  
 [in] *bActivez*  
 `TRUE` Pour activer la fonction Masquer automatiquement toutes les fonctionnalités pour le volet ancrable ; dans le cas contraire, `FALSE`.  
  
### <a name="remarks"></a>Notes  
 Lorsque l’utilisateur maintient la `Ctrl` clé et clique sur le bouton pin pour basculer d’un volet en mode de masquage automatique, toutes les autres volets dans le même conteneur sont également passer en mode de masquage automatique.  
  
 Appelez cette méthode avec *bActivez* la valeur `FALSE` pour désactiver cette fonctionnalité pour un volet spécifique.  
...
### <a name="remarks"></a>Notes  
 Lorsque l’infrastructure crée les volets ancrables, ils n’ont pas le **WS_STYLE** style de fenêtre, même s’il est spécifié. Cela signifie que légende du volet est une zone non cliente qui est contrôlée par le framework, mais cette exposition diffère de la légende de fenêtre standard.  
  
 Vous pouvez afficher ou masquer la légende à tout moment. L’infrastructure de la légende est masquée lorsqu’un volet est ajouté sous forme d’onglet dans une fenêtre à onglets ou lorsqu’un volet est affichée dans une fenêtre mini-frame.  
...
### <a name="return-value"></a>Valeur de retour  
 A `CRect` objet qui contient la position du volet lorsqu’il est en mode de masquage automatique.  
  
### <a name="remarks"></a>Notes  
  
##  <a name="getahslidemode"></a>  CDockablePane::GetAHSlideMode  
 Récupère le mode de diapositive de masquage automatique pour le volet.  
...
### <a name="remarks"></a>Notes  
 Hauteur de la légende est 0 si la légende est masquée par la [CDockablePane::EnableGripper](#enablegripper) (méthode), ou si le volet ne dispose pas d’une légende.  
...
### <a name="return-value"></a>Valeur de retour  
 Valide [CPaneDivider](../../mfc/reference/cpanedivider-class.md) objet si le volet ancrable est ancré à la fenêtre frame principale, ou `NULL` si le volet ancrable n’est pas ancré, ou si elle est flottant.  
  
### <a name="remarks"></a>Notes  
 Pour plus d’informations sur diviseurs de volet, consultez [CPaneDivider classe](../../mfc/reference/cpanedivider-class.md).  
  
##  <a name="getdockingstatus"></a>  CDockablePane::GetDockingStatus  
 Détermine la possibilité d’un volet ancré en fonction de l’emplacement du pointeur fourni.  
...
### <a name="parameters"></a>Paramètres  
 ...
 [in] *nSensitivity*  
 La distance, en pixels, en s’éloignant de la bordure d’un rectangle le pointeur doit être à l’activation de l’ancrage.  
...
|---------------------------|-------------|  
|`CS_NOTHING`|Le pointeur ne se trouve pas sur un site d’ancrage. Le framework n’ancre pas le volet.|  
|`CS_DOCK_IMMEDIATELY`|Le pointeur se trouve sur le site d’ancrage en mode immédiat (le volet utilise la `DT_IMMEDIATE` mode d’ancrage). Le framework ancre le volet immédiatement.|  
|`CS_DELAY_DOCK`|Le pointeur se trouve sur un site d’ancrage qui est un autre volet d’ancrage ou un bord du frame principal. Le framework ancre le volet après un certain délai. Consultez la section Notes pour plus d’informations sur ce délai.|  
|`CS_DELAY_DOCK_TO_TAB`|Le pointeur se trouve sur un site d’ancrage qui provoque le volet ancré dans une fenêtre à onglets. Cela se produit lorsque le pointeur se trouve sur la légende d’un autre volet d’ancrage ou sur la zone d’onglet d’un volet à onglets.|  
  
### <a name="remarks"></a>Notes  
 L’infrastructure appelle cette méthode pour gérer l’ancrage d’un volet flottant.  
  
 Pour les barres d’outils flottantes ou ancrer les volets qui utilisent la `DT_IMMEDIATE` ancrage mode, le framework diffère de la commande d’ancrage pour permettre à l’utilisateur déplacer la fenêtre en dehors de la zone cliente du frame parent avant d’ancrage. La longueur du délai est mesurée en millisecondes et est contrôlée par le [CDockingManager::m_nTimeOutBeforeToolBarDock](../../mfc/reference/cdockingmanager-class.md#m_ntimeoutbeforetoolbardock) membre de données... La valeur par défaut [CDockingManager::m_nTimeOutBeforeToolBarDock](../../mfc/reference/cdockingmanager-class.md#m_ntimeoutbeforetoolbardock) est 200. Ce comportement émule le comportement d’ancrage de [!INCLUDE[ofprword](../../mfc/reference/includes/ofprword_md.md)] 2007.  
  
 Pour différé d’ancrage États ( `CS_DELAY_DOCK` et `CS_DELAY_DOCK_TO_TAB`), le framework n’effectue pas d’ancrage jusqu'à ce que l’utilisateur relâche le bouton de la souris. Si un volet utilise le `DT_STANDARD` ancrage mode, l’infrastructure affiche un rectangle à l’emplacement d’ancrage projetée. Si un volet utilise le `DT_SMART` ancrage mode, l’infrastructure affiche des marqueurs d’ancrage intelligents et rectangles semi-transparents à l’emplacement d’ancrage projetée. Pour spécifier le mode d’ancrage pour votre volet, appelez le [CBasePane::SetDockingMode](../../mfc/reference/cbasepane-class.md#setdockingmode) (méthode). Pour plus d’informations sur l’ancrage actif, consultez [CDockingManager::GetSmartDockingParams](../../mfc/reference/cdockingmanager-class.md#getsmartdockingparams).  
  
##  <a name="getdragsensitivity"></a>  CDockablePane::GetDragSensitivity  
 Retourne le respect de glissement d’un volet d’ancrage.  
...
### <a name="remarks"></a>Notes  
 Cette méthode est utilisée lorsque le conteneur s’ajuste à sa disposition.  
...
##  <a name="gettabbedpanertc"></a>  CDockablePane::GetTabbedPaneRTC  
 Retourne les informations de classe d’exécution sur une fenêtre à onglets qui est créée quand un autre volet est ancré dans le volet en cours.  
...
### <a name="remarks"></a>Notes  
 Appelez cette méthode pour récupérer les informations de classe runtime pour les volets à onglets qui sont créés dynamiquement. Cela peut se produire lorsqu’un utilisateur fait glisser un volet à la légende d’un autre volet, ou si vous appelez le [CDockablePane::AttachToTabWnd](#attachtotabwnd) méthode pour créer par programme un volet à onglets à partir de deux volets ancrables.  
  
 Vous pouvez définir les informations de classe runtime en appelant le [CDockablePane::SetTabbedPaneRTC](#settabbedpanertc) (méthode).  
...
### <a name="return-value"></a>Valeur de retour  
 `TRUE` Si le volet ancrable peut être basculé en mode de masquage automatique ; dans le cas contraire, `FALSE`.  
...
##  <a name="hittest"></a>  CDockablePane::HitTest  
 Spécifie l’emplacement dans un volet sur lequel l’utilisateur clique sur la souris.  
...
- `HTNOWHERE` Si *point* n’est pas dans le volet Ancrable.  
  
- `HTCLIENT` Si *point* est dans la zone cliente du volet Ancrable.  
  
- `HTCAPTION` Si *point* est dans la zone de légende du volet Ancrable.  
  
- `AFX_HTCLOSE` Si *point* se trouve sur le bouton Fermer.  
  
- `HTMAXBUTTON` Si *point* se trouve sur le bouton de code confidentiel.  
  
##  <a name="isautohideallenabled"></a>  CDockablePane::IsAutohideAllEnabled  
 Indique si le volet d’ancrage et tous les autres volets dans le conteneur peuvent être basculés en mode masquage automatique.  
...
### <a name="return-value"></a>Valeur de retour  
 `TRUE` Si le volet ancrable et tous les autres volets dans le conteneur, il est possible en mode de masquage automatique ; dans le cas contraire, `FALSE`.  
...
### <a name="return-value"></a>Valeur de retour  
 `TRUE` Si le volet ancrable est en mode de masquage automatique ; dans le cas contraire, `FALSE`.  
...
### <a name="return-value"></a>Valeur de retour  
 `TRUE` Si le volet ancrable n’appartient pas à une fenêtre mini-frame ou si elle est flottant dans une fenêtre mini-frame avec un autre volet. `FALSE` Si le volet est un enfant d’une fenêtre mini-frame et il n’y a aucune autres volets qui appartiennent à la fenêtre mini-frame.  
...
### <a name="return-value"></a>Valeur de retour  
 `TRUE` Si le volet ancrable doit être masqué en mode de masquage automatique ; dans le cas contraire, `FALSE`.  
  
### <a name="remarks"></a>Notes  
 Lorsqu’un volet ancrable est en mode de masquage automatique, il comporte différemment lorsque vous appelez `ShowPane` pour masquer ou afficher le volet. Ce comportement est contrôlé par le membre statique [CDockablePane::m_bHideInAutoHideMode](#m_bhideinautohidemode). Si ce membre est `TRUE`, le volet ancrable et sa barre d’outils connexes masquage automatique ou le bouton masquage automatique est masqué ou affiché lorsque vous appelez `ShowPane`. Sinon, le volet ancrable est activé ou désactivé, et sa barre d’outils connexes masquage automatique ou le bouton masquage automatique est toujours visible.  
...
### <a name="remarks"></a>Notes  
 ...
 Les volets qui ne peut pas être redimensionnés peuvent ni float ni entrer en mode de masquage automatique et sont toujours situés au niveau du bord extérieur du frame parent.  
  
##  <a name="istablocationbottom"></a>  CDockablePane::IsTabLocationBottom  
 Spécifie si les onglets sont situés en haut ou bas du volet.  
...
### <a name="return-value"></a>Valeur de retour  
 `TRUE` Si le volet ancrable est visible ; dans le cas contraire, `FALSE`.  
  
### <a name="remarks"></a>Notes  
 Appelez cette méthode pour déterminer si un volet ancrable est visible. Vous pouvez utiliser cette méthode au lieu d’appeler [CWnd::IsWindowVisible](../../mfc/reference/cwnd-class.md#iswindowvisible) ou des tests pour le `WS_VISIBLE` style. L’état de visibilité retourné dépend si le mode de masquage automatique est activé ou désactivé et la valeur de la [CDockablePane::IsHideInAutoHideMode](#ishideinautohidemode) propriété.  
  
 Si le volet ancrable est en mode de masquage automatique et `IsHideInAutoHideMode` retourne `FALSE` l’état de visibilité est toujours `FALSE`.  
  
 Si le volet ancrable est en mode de masquage automatique et `IsHideInAutoHideMode` retourne `TRUE` l’état de visibilité dépend de l’état de visibilité de la barre d’outils connexes masquage automatique.  
...
### <a name="remarks"></a>Notes  
 ...
 Si vous définissez ce membre sur `TRUE`, volets ancrables seront affichés ou masqués avec leurs boutons et les barres d’outils connexes Masquer automatiquement lorsque vous appelez [CDockablePane::ShowPane](#showpane).  
  
 Si vous définissez ce membre sur `FALSE`, volets ancrables sont activés ou désactivés lorsque vous appelez [CDockablePane::ShowPane](#showpane).  
...
##  <a name="onafterdockfromminiframe"></a>  CDockablePane::OnAfterDockFromMiniFrame  
 Appelé par le framework lorsqu’une barre d’ancrage flottante est ancré à une fenêtre frame.  
...
##  <a name="onbeforechangeparent"></a>  CDockablePane::OnBeforeChangeParent  
 L’infrastructure appelle cette méthode avant que le parent du volet.  
...
### <a name="parameters"></a>Paramètres  
 ...
 [in] *bDelay*  
 `BOOL` qui spécifie s’il faut différer le recalcul de la mise en page d’accueil si le volet est déconnecté. Pour plus d’informations, consultez [CDockablePane::UndockPane](#undockpane).  
  
### <a name="remarks"></a>Notes  
 Si le volet est ancré et le nouveau parent n’autorise pas l’ancrage, cette méthode détache le volet.  
  
 Si le volet est converti en un document à onglets, cette méthode stocke sa position d’ancrage récente. L’infrastructure utilise la position d’ancrage récente pour restaurer la position du volet quand il est converti dans un état ancré.  
  
##  <a name="onbeforefloat"></a>  CDockablePane::OnBeforeFloat  
 L’infrastructure appelle cette méthode avant d’un volet passe à l’état flottant.  
...
### <a name="remarks"></a>Notes  
 Cette méthode est appelée par l’infrastructure lorsqu’un volet est sur float. Vous pouvez substituer cette méthode dans une classe dérivée si vous souhaitez effectuer un traitement avant le volet flotte.  
  
##  <a name="onpressbuttons"></a>  CDockablePane::OnPressButtons  
 Appelé lorsque l’utilisateur appuie sur un bouton de légende autre que le `AFX_HTCLOSE` et `AFX_HTMAXBUTTON` boutons.  
...
##  <a name="removefromdefaultpanedividier"></a>  CDockablePane::RemoveFromDefaultPaneDividier  
 L’infrastructure appelle cette méthode lorsqu’un volet est en cours Annuler l’ancrage.  
...
### <a name="parameters"></a>Paramètres  
 ...
 Si `TRUE`, le nouveau volet est inscrit auprès du Gestionnaire d’ancrage du parent du volet ancien. Le nouveau volet est inséré à l’index de l’ancien volet dans la liste des volets qui est gérée par le Gestionnaire d’ancrage.  
...
### <a name="remarks"></a>Notes  
 Le diviseur de volet par défaut restaurée remplace le diviseur de volet par défaut actuel, s’il existe.  
...
### <a name="parameters"></a>Paramètres  
 ...
 [in] *dwAlignment*  
 Spécifie l’alignement du volet masquage automatique à créer.  
  
 [in] [out] *pCurrAutoHideBar*  
 Pointeur vers la barre d’outils de masquage automatique en cours. Peut être `NULL`.  
  
 [in] *bUseTimer*  
 Spécifie s’il faut utiliser l’effet de masquer automatiquement lorsque l’utilisateur bascule le volet en mode masquage automatique ou masquer le volet immédiatement.  
  
### <a name="return-value"></a>Valeur de retour  
 La barre d’outils de masquage automatique a été créé après le passage au mode de masquage automatique, ou `NULL`.  
  
### <a name="remarks"></a>Notes  
 L’infrastructure appelle cette méthode lorsqu’un utilisateur clique sur le bouton pin pour basculer le volet ancrable en mode de masquage automatique ou en mode d’ancrage normal.  
  
 Appelez cette méthode pour basculer d’un volet ancrable en mode masquage automatique par programme. Le volet doit être ancré à la fenêtre frame principale ( [CDockablePane::GetDefaultPaneDivider](#getdefaultpanedivider) doit retourner un pointeur valide vers le [CPaneDivider](../../mfc/reference/cpanedivider-class.md)).  
...
### <a name="remarks"></a>Notes  
 Le framework ajuste le volet pour utiliser la nouvelle valeur lors de la disposition est recalculée.  
...
##  <a name="settabbedpanertc"></a>  CDockablePane::SetTabbedPaneRTC  
 Définit les informations de classe runtime pour une fenêtre à onglets qui est créée lorsque deux volets ancrer ensemble.  
...
### <a name="remarks"></a>Notes  
 ...
 La classe d’exécution par défaut est définie en fonction de la *dwTabbedStyle* paramètre de [CDockablePane::Create](#create) et [CDockablePane::CreateEx](#createex). Pour personnaliser les volets à onglets nouvelle, dérivez votre classe à partir d’une des classes suivantes :  
...
### <a name="parameters"></a>Paramètres  
 ...
 [in] *bDelay*  
 `TRUE` pour différer l’ajustement de la disposition d’ancrage ; `FALSE` pour ajuster la disposition d’ancrage immédiatement.  
  
 [in] *bActivate*  
 `TRUE` Pour activer le volet en cas d’affichage ; dans le cas contraire, `FALSE`.  
  
### <a name="remarks"></a>Notes  
 Appelez cette méthode à la place de la [CWnd::ShowWindow](../../mfc/reference/cwnd-class.md#showwindow) lors de l’affichage ou masquage des volets ancrables.  
  
##  <a name="slide"></a>  CDockablePane::Slide  
 Réalise une animation d’un volet qui est en mode de masquage automatique.  
...
### <a name="parameters"></a>Paramètres  
 ...
 [in] *bUseTimer*  
 `TRUE` Pour afficher ou masquer le volet avec l’effet de masquage automatique ; `FALSE` pour afficher ou masquer le volet immédiatement.  
  
### <a name="remarks"></a>Notes  
 L’infrastructure appelle cette méthode pour animer un volet qui est en mode de masquage automatique.  
  
 Cette méthode utilise le `CDockablePane::m_nSlideDefaultTimeOut` valeur pour déterminer le délai d’attente pour l’effet de diapositive. La valeur par défaut pour le délai d’attente est 1. Si vous personnalisez l’algorithme de masquage automatique, modifiez ce membre pour modifier le délai d’attente.  
  
##  <a name="toggleautohide"></a>  CDockablePane::ToggleAutoHide  
 Bascule le volet entre toujours visible et le mode de masquage automatique.  
...
##  <a name="undockpane"></a>  CDockablePane::UndockPane  
 Détache un volet à partir de la fenêtre frame principale ou un conteneur de fenêtre mini-frame.  
...
### <a name="parameters"></a>Paramètres  
 [in] *bDelay*  
 `TRUE` pour différer le calcul de la disposition d’ancrage ; `FALSE` pour recalculer la disposition d’ancrage immédiatement.  
  
### <a name="remarks"></a>Notes  
 Appelez cette méthode pour détacher un volet à partir de la fenêtre frame principale ou d’un conteneur de fenêtre mini-frame de multiples (volet est flottant dans une fenêtre mini-frame unique avec d’autres).  
  
 Vous devez annuler l’ancrage un volet avant d’effectuer toute opération externe qui n’est pas effectuée par le [CDockingManager](../../mfc/reference/cdockingmanager-class.md). Par exemple, vous devez déconnecter un volet déplacer par programmation à partir d’un emplacement vers un autre.  
  
 Le framework déconnecte automatiquement les volets avant qu’ils sont détruits.  
