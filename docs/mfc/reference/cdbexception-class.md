...
Pour plus d’informations sur les codes utilisées pour créer cette chaîne, consultez la [SQLError](/sql/odbc/reference/syntax/sqlerror-function) fonctionner dans le *de référence du programmeur ODBC*.
