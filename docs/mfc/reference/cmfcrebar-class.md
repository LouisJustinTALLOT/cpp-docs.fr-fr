---
description: 'En savoir plus sur : classe CMFCReBar'
...
*dwStyle*<br/>
dans Contient le style à appliquer à la bande. Pour obtenir la liste complète des styles de bande, consultez la description de `fStyle` dans la structure [REBARBANDINFO](/windows/win32/api/commctrl/ns-commctrl-rebarbandinfow) dans la documentation SDK Windows.
...
Fournit un accès direct au `CReBarCtrl` contrôle commun sous-jacent pour les `CMFCReBar` objets.
