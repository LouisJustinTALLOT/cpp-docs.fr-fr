---
title: Cmfcvisualmanagerwindows7, classe | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
|`CMFCVisualManagerWindows7::DrawNcBtn`|Dessine un bouton dans la zone non cliente sur le frame. Les utilisations de framework cette méthode pour dessiner réduire, agrandir, fermer et restaurer des boutons dans le coin supérieur droit du frame de fenêtre. Cette méthode n’est pas appelée lorsque le programme utilise un thème non Aero.|  
