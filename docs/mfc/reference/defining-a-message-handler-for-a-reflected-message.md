---
description: 'En savoir plus sur : définition d’un gestionnaire de messages pour un message réfléchi'
...
1. Cliquez sur la cellule dans la colonne de droite de l’Assistant classe pour afficher le nom suggéré du gestionnaire en tant que \<add> *HandlerName*. (Par exemple, le gestionnaire de messages **= WM_CTLCOLOR** suggère \<add> **CtlColor**).
