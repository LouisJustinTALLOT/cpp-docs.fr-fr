...
|[IMPLEMENT_OLECREATE_EX](#implement_olecreate_ex)|Implémente la fonction `GetClassID` du contrôle et déclare une instance de la fabrique de classe.|
...
Déclare une fabrique de classe et la fonction membre `GetClassID` de votre classe de contrôle.
