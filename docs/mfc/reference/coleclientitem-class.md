...
*ppd*<br/>
Pointeur vers un [PRINTDLG](/windows/desktop/api/commdlg/ns-commdlg-tagpda) structure de données qui contient des informations sur le nouveau périphérique cible à l’impression. Peut être NULL.
