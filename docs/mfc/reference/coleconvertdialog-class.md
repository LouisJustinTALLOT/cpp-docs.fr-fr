...
### <a name="remarks"></a>Notes  
 ...
 Pour plus d’informations sur l’aspect de dessin, consultez le [FORMATETC](http://msdn.microsoft.com/library/windows/desktop/ms682177) structure de données dans le SDK Windows.  
