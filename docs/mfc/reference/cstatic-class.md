...
### <a name="remarks"></a>Notes  
 Construire un `CStatic` objet en deux étapes. Tout d’abord, appelez le constructeur `CStatic`, puis appelez `Create`, ce qui crée le contrôle statique Windows et l’attache à le `CStatic` objet.  
...
- Utilisez SS_CENTERIMAGE pour centrer l’image dans le contrôle statique.  
...
### <a name="return-value"></a>Valeur de retour  
 Handle vers l’image bitmap actuelle, ou NULL si aucune image bitmap n’a été défini.  
...
### <a name="return-value"></a>Valeur de retour  
 Handle vers le métafichier amélioré en cours, ou NULL si aucune métafichier amélioré n’a été défini.  
...
### <a name="return-value"></a>Valeur de retour  
 Le handle du curseur associé précédemment du contrôle statique, ou NULL si aucun curseur n’a été associé au contrôle statique.  
...
- SS_ICON utiliser toujours ce style pour les icônes et curseurs.  
  
- Utilisez SS_CENTERIMAGE pour centrer dans le contrôle statique. Si l’image est plus grande que le contrôle statique, il apparaît découpé. Si elle est inférieure à celle du contrôle statique, l’espace vide autour de l’image sera rempli avec la couleur d’arrière-plan du contrôle statique.  
...
### <a name="return-value"></a>Valeur de retour  
 Le handle du métafichier amélioré associé précédemment du contrôle statique, ou NULL si aucune métafichier amélioré a été associé au contrôle statique.  
...
### <a name="return-value"></a>Valeur de retour  
 Le handle de l’icône précédemment associé avec le contrôle statique, ou NULL si aucune icône n’a été associé au contrôle statique.  
