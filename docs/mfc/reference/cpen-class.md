...
*lpLogPen*<br/>
Pointe vers le Windows [LOGPEN](/windows/desktop/api/Wingdi/ns-wingdi-taglogpen) structure qui contient des informations sur le stylet.
