---
title: 'Wm, gestionnaires de messages : F - K | Microsoft Docs'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
ms.locfileid: "46414561"
---
# <a name="wm-message-handlers-f---k"></a>WM_, gestionnaires de messages : F - K

Les entrées de mappage suivant sur la gauche correspondent aux prototypes de fonction à droite :
...
|ON_WM_INITMENUPOPUP()|afx_msg void [OnInitMenuPopup](../../mfc/reference/cwnd-class.md#oninitmenupopup)(CMenu *, UINT, valeur Booléenne) ;|
