---
title: CComboBoxEx, classe | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
2.  Appelez cette fonction membre, ce qui crée la zone de liste déroulante étendue Windows et l’attache à la `CComboBoxEx` objet.  
