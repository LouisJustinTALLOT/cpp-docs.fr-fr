---
description: 'En savoir plus sur : classe CFileException'
...
*nErrno*<br/>
Un code d’erreur entier, tel que défini dans le fichier include Runtime ERRNO. H.
