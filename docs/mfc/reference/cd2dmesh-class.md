---
title: Classe de CD2DMesh | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
|[CD2DMesh::Detach](#detach)|Détache l’interface de ressources de l’objet|
...
Pointeur vers un ID2D1TessellationSink qui est utilisé pour remplir la maille.
