---
description: 'En savoir plus sur : classe CStringArray'
...
|[CStringArray :: GetData](../../mfc/reference/cobarray-class.md#getdata)|Autorise l'accès aux éléments du tableau. Peut avoir la **valeur null**.|
