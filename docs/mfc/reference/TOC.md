...
## [UICheckState, énumération](uicheckstate-enumeration.md)
...
### [Macros de délégué et de mappage d’interface](delegate-and-interface-maps.md)
...
### [Gestionnaires de messages WM_ : A - C](wm-message-handlers-a-c.md)
### [Gestionnaires de messages WM_ : D - E](wm-message-handlers-d-e.md)
### [Gestionnaires de messages WM_ : F - K](wm-message-handlers-f-k.md)
### [Gestionnaires de messages WM_ : L - M](wm-message-handlers-l-m.md)
### [Gestionnaires de messages WM_ : N - O](wm-message-handlers-n-o.md)
### [Messages WM_ : P - R](wm-messages-p-r.md)
### [Messages WM_ : S](wm-messages-s.md)
### [Messages WM_ : T - Z](wm-messages-t-z.md)
