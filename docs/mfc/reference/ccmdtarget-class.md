...
*lpRect*<br/>
Pointeur vers le [RECT](/previous-versions/dd162897\(v=vs.85\)) rectangle de cadre englobant de structure contenant les coordonnées, en pixels, qui définissent un objet *hwndParent*.
