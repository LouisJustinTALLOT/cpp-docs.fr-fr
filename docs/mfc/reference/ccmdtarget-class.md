...
*pIID*<br/>
Un pointeur vers un ID d’interface (un [GUID](/previous-versions/aa373931\(v=vs.80\))).
...
*guid*<br/>
Le [GUID](/previous-versions/aa373931\(v=vs.80\)) de la description de type.
