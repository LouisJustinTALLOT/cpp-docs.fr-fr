...
Cette fonction membre émule les fonctionnalités du message [SBM_SCROLLBARINFO](/windows/win32/Controls/sbm-getscrollbarinfo) , comme décrit dans la SDK Windows.
