...
*pBarToDock*<br/>
[in, out] Un pointeur vers le volet pour être ancré à gauche de *pTargetBar*.
...
*pBar*<br/>
[in, out] Un pointeur vers le volet pour être affichée ou masquée.
