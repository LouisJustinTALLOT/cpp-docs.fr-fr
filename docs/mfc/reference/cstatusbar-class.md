---
title: CStatusBar (classe) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
2.  Appelez [CCmdUI::SetText](../../mfc/reference/ccmdui-class.md#settext) dans Gestionnaire ON_UPDATE_COMMAND_UI de la barre d’état.  
  
3.  Appelez [SetPaneText](#setpanetext) pour mettre à jour le texte pour n’importe quel volet.  
