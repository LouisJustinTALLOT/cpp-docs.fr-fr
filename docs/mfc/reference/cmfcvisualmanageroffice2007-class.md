...
L’exemple suivant montre comment utiliser le Gestionnaire visuel Office 2007. Cet extrait de code fait partie de la [exemple de démonstration alerte Desktop](../../overview/visual-cpp-samples.md).
