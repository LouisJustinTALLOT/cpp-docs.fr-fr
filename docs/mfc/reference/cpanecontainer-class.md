...
L’exemple suivant montre comment construire une instance de la `CPaneContainer` classe. Cet extrait de code fait partie de la [exemple de définir la taille du volet](../../overview/visual-cpp-samples.md).
