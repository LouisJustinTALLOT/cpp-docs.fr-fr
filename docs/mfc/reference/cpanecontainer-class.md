...
ms.locfileid: "81364146"
---
# <a name="cpanecontainer-class"></a>CPaneContainer, classe

La `CPaneContainer` classe est un élément de base du modèle d’amarrage mis en œuvre par MFC. Un objet de cette classe stocke des pointeurs vers deux volets d'ancrage ou deux instances `CPaneContainer.` . Il stocke aussi un pointeur vers le séparateur qui sépare les volets (ou les conteneurs). En imbriquant des conteneurs dans des conteneurs, l’infrastructure peut générer un arbre binaire qui représente des dispositions d’ancrage complexes. La racine de l’arbre binaire est stockée dans un objet [CPaneContainerManager.](../../mfc/reference/cpanecontainermanager-class.md)
...
|[CPaneContainer::Est-Ildéposé](#isdisposed)||
...
|[CPaneContainer::Libération](#release)||
...
`CPaneContainer`objets sont créés automatiquement par le cadre.

## <a name="example"></a>Exemple

L’exemple suivant montre comment construire `CPaneContainer` une instance de la classe. Cet extrait de code fait partie de [l’échantillon Set Pane Size](../../overview/visual-cpp-samples.md).
...
[dans] *nRequiredOffset (en anglais)*<br/>
[dans] *pBar (pBar)*<br/>
[dans] *pContainer*<br/>
[dans] *bLeftBar (en)*<br/>
...
## <a name="cpanecontainercopy"></a><a name="copy"></a>CPaneContainer::Copier
...
[dans] *rect*<br/>
[dans] *bIgnoreVisibilité*<br/>

### <a name="remarks"></a>Notes

## <a name="cpanecontainerisdisposed"></a><a name="isdisposed"></a>CPaneContainer::Est-Ildéposé
...
## <a name="cpanecontainermove"></a><a name="move"></a>CPaneContainer::Déplacer
...
## <a name="cpanecontainerrelease"></a><a name="release"></a>CPaneContainer::Libération
