---
description: 'En savoir plus sur : classe CPaneContainer'
...
L’exemple suivant montre comment construire une instance de la `CPaneContainer` classe. Cet extrait de code fait partie de l' [exemple Set Pane Size](../../overview/visual-cpp-samples.md).
