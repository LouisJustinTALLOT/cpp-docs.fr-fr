...
## <a name="remarks"></a>Notes  
 ...
 Lorsqu’un `CMapPtrToPtr` objet est supprimé, ou lorsque ses éléments sont supprimés, seuls les pointeurs sont supprimées, pas les entités qu’ils référencent.  
