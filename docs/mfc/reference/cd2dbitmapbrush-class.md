...
|[CD2DBitmapBrush::Detach](#detach)|Détache l’interface de ressources de l’objet|
...
*pBitmapBrushProperties*<br/>
Pointeur vers les propriétés de pinceau image bitmap.
...
Pointeur vers un objet de CD2DBitmap ou d’une valeur NULL si l’objet n’est pas encore initialisé.
...
*pBitmap*<br/>
La source de la bitmap utilisée par le pinceau
