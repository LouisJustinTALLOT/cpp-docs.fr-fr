...
### <a name="parameters"></a>Paramètres  
 [in, out] *pAccel*  
 Pointeur vers l’attribution de clavier proposée est exprimée comme une [accélération](/windows/desktop/api/winuser/ns-winuser-tagaccel) struct.  
