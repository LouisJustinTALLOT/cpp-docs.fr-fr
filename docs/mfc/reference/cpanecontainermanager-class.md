---
description: 'En savoir plus sur : classe CPaneContainerManager'
...
ms.locfileid: "97301527"
---
# <a name="cpanecontainermanager-class"></a>CPaneContainerManager, classe

La `CPaneContainerManager` classe gère le stockage et l’affichage de la disposition d’ancrage actuelle.
...
L’infrastructure crée automatiquement des instances d' `CPaneContainerManager` objets et les incorpore dans des objets de [classe CPaneDivider](../../mfc/reference/cpanedivider-class.md) ou dans des objets de [classe CMultiPaneFrameWnd](../../mfc/reference/cmultipaneframewnd-class.md) .

La `CPaneContainerManager` classe stocke un pointeur vers la racine d’une arborescence binaire qui est générée à partir d’objets [CPaneContainer](../../mfc/reference/cpanecontainer-class.md) .

## <a name="example"></a>Exemple

L’exemple suivant montre comment obtenir une référence à un `CPaneContainerManager` objet. Cet extrait de code fait partie de l' [exemple Set Pane Size](../../overview/visual-cpp-samples.md).
...
dans *rectInserted*<br/>
dans *rectSlider*<br/>
dans *dwSliderStyle*<br/>
dans *dwAlignment*<br/>
dans *sizeMinOriginal*<br/>
dans *sizeMinInserted*<br/>
