---
description: 'En savoir plus sur : WM_ gestionnaires de messages : N-O'
title: 'WM_, gestionnaires de messages : N - O'
ms.date: 11/04/2016
f1_keywords:
- ON_WM_NCHITTEST
- ON_WM_NCLBUTTONDOWN
...
ms.locfileid: "97218314"
---
# <a name="wm_-message-handlers-n---o"></a>WM_, gestionnaires de messages : N - O
