---
title: Gestionnaires de contrôle d’édition | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
|---------------|------------------------|
|ON_EN_CHANGE ( \<id >, \<memberFxn >)|void memberFxn d’afx_msg () ;|
|ON_EN_ERRSPACE ( \<id >, \<memberFxn >)|void memberFxn d’afx_msg () ;|
|ON_EN_HSCROLL ( \<id >, \<memberFxn >)|void memberFxn d’afx_msg () ;|
|ON_EN_KILLFOCUS ( \<id >, \<memberFxn >)|void memberFxn d’afx_msg () ;|
|ON_EN_MAXTEXT ( \<id >, \<memberFxn >)|void memberFxn d’afx_msg () ;|
|ON_EN_SETFOCUS ( \<id >, \<memberFxn >)|void memberFxn d’afx_msg () ;|
|ON_EN_UPDATE ( \<id >, \<memberFxn >)|void memberFxn d’afx_msg () ;|
|ON_EN_VSCROLL ( \<id >, \<memberFxn >)|void memberFxn d’afx_msg () ;|
