...
ms.locfileid: "37039308"
---
# <a name="chtmleditctrlbase-class"></a>Classe de CHtmlEditCtrlBase
...
|Nom|Description|  
|----------|-----------------|  
|[CHtmlEditCtrlBase::AddToGlyphTable](#addtoglyphtable)|Ajoute une entrée dans la table de glyphe, qui spécifie les images à afficher des balises spécifiques en mode Création.|  
...
|[CHtmlEditCtrlBase::Cut](#cut)|Copie la sélection actuelle dans le Presse-papiers et supprime ensuite.|  
...
|[CHtmlEditCtrlBase::Font](#font)|Ouvre une boîte de dialogue Police permettant à l’utilisateur de modifier la couleur du texte, la police et la taille de police de la sélection actuelle.|  
...
|[CHtmlEditCtrlBase::GetBlockFormatNames](#getblockformatnames)|Récupère les chaînes correspondant aux balises de format de bloc disponible.|  
...
|[CHtmlEditCtrlBase::GetShowBRTags](#getshowbrtags)|Récupère si le contrôle WebBrowser affiche un glyphe pour balises br.|  
...
|[CHtmlEditCtrlBase::Indent](#indent)|Augmente le retrait du texte sélectionné par incrément de la mise en un retrait.|  
...
|[CHtmlEditCtrlBase::Italic](#italic)|Active/désactive la sélection actuelle en italique.|  
|[CHtmlEditCtrlBase::JustifyCenter](#justifycenter)|Centre du bloc de format dans lequel se trouve la sélection actuelle.|  
|[CHtmlEditCtrlBase::JustifyLeft](#justifyleft)|Aligne à gauche le bloc du format dans lequel se trouve la sélection actuelle.|  
|[CHtmlEditCtrlBase::JustifyRight](#justifyright)|Aligne à droite le bloc du format dans lequel se trouve la sélection actuelle.|  
|[CHtmlEditCtrlBase::ListBox](#listbox)|Remplace le contrôle de zone de sélection de liste sur la sélection actuelle.|  
|[CHtmlEditCtrlBase::Marquee](#marquee)|Remplace un texte défilant utilisé comme vide sur la sélection actuelle.|  
|[CHtmlEditCtrlBase::NewDocument](#newdocument)|Crée un nouveau document.|  
|[CHtmlEditCtrlBase::OrderList](#orderlist)|Active/désactive la sélection actuelle entre une liste triée et un bloc de format normal.|  
...
|[CHtmlEditCtrlBase::Paste](#paste)|Remplace le contenu du Presse-papiers dans la sélection actuelle.|  
|[CHtmlEditCtrlBase::PrintDocument](#printdocument)|Imprime le document actif.|  
|[CHtmlEditCtrlBase::PrintPreview](#printpreview)|Ouvre la fenêtre Aperçu avant impression du document actif à l’aide du modèle d’aperçu avant impression par défaut ou un modèle personnalisé.|  
...
|[CHtmlEditCtrlBase::Set2DPosition](#set2dposition)|Permet de positionnement absolu d’éléments à déplacer en faisant glisser.|  
...
|[CHtmlEditCtrlBase::SetCSSEditingLevel](#setcsseditinglevel)|Sélectionne le niveau CSS (CSS1 ou CSS2) l’éditeur prendront en charge le cas échéant.|  
...
|[CHtmlEditCtrlBase::SetDesignMode](#setdesignmode)|Définir le mode de conception.|  
...
|[CHtmlEditCtrlBase::SetLiveResize](#setliveresize)|Provoque le contrôle WebBrowser à mettre à jour d’apparence d’un élément en permanence pendant une opération de redimensionnement ou de déplacement.|  
...
|[CHtmlEditCtrlBase::Underline](#underline)|Active/désactive la sélection actuelle entre souligné et ne pas souligné.|  
|[CHtmlEditCtrlBase::Unlink](#unlink)|Supprime un lien hypertexte à partir de la sélection actuelle.|  
|[CHtmlEditCtrlBase::UnorderList](#unorderlist)|Active/désactive la sélection actuelle entre une liste triée et un bloc de format normal.|  
 ...
 **CHtmlEditCtrlBase** fournit des fonctions membres pour HTML du WebBrowser modification des commandes, telles que [gras](#bold). (Vous pouvez également appeler [ExecCommand](#execcommand) pour exécuter le **IDM_BOLD** commande.)  
...
##  <a name="addtoglyphtable"></a>  CHtmlEditCtrlBase::AddToGlyphTable  
 Ajoute une entrée dans la table de glyphe, qui spécifie les images à afficher des balises spécifiques en mode Création.  
 ...
 *nTagType*  
 Type de balise : 0 signifie que l’image est à la balise d’ouverture. 1 signifie que l’image est à la balise de fermeture uniquement. 2 signifie l’image pour l’ouverture et la fermeture des balises. Balises uniques comme br et commentaire doivent être ajoutés avec le type de balise défini sur 0.  
  
 *nAlignment*  
 Alignement (éléments rectangulaires uniquement) : ce paramètre indique que l’image est un élément avec un attribut d’alignement. Gauche = 0, centre = 1, à droite = 2 et non défini = 3. Gauche, droite ou centre attributs doivent être définie explicitement sur l’élément.  
  
 *nPosInfo*  
 Informations de positionnement. Détermine la valeur de positionnement (CSS) le glyphe s’applique, où statiques des feuilles de style en cascade positionnement = 0, positionnement absolu = 1, positionnement relatif = 2 et tous les = 3. Ce champ vous permet de spécifier un glyphe pour une balise lorsqu’il n’est pas placé et un autre glyphes pour afficher un point d’ancrage lorsque la balise est positionnée.  
  
 *nDirection*  
 La direction. Ce paramètre spécifie l’image d’une balise en fonction de l’ordre de lecture de la langue actuelle. la valeur 0 spécifie de gauche à droite, 1 indique de droite à gauche, 2 spécifie de haut en bas, 3 spécifie de bas en haut et 4 spécifie tous les. Normalement, vous définissez ce champ à 4.  
...
##  <a name="cut"></a>  CHtmlEditCtrlBase::Cut  
 Copie la sélection actuelle dans le Presse-papiers et supprime ensuite.  
 ...
 *cmdExecOpt*  
 Valeurs extraites à partir de la [OLECMDEXECOPT](http://msdn.microsoft.com/library/windows/desktop/ms683930) énumération, qui décrivent comment l’objet doit exécuter la commande.  
...
##  <a name="font"></a>  CHtmlEditCtrlBase::Font  
 Ouvre une boîte de dialogue Police permettant à l’utilisateur de modifier la couleur du texte, la police et la taille de police de la sélection actuelle.  
...
### <a name="parameters"></a>Paramètres  
 *strFormat*  
 La balise de format de bloc actuel.  
...
##  <a name="getblockformatnames"></a>  CHtmlEditCtrlBase::GetBlockFormatNames  
 Récupère les chaînes correspondant aux balises de format de bloc disponible.  
...
### <a name="remarks"></a>Notes  
 Indique si le document a été modifiée. `GetIsDirty` Retourne un `HRESULT` de [IPersistStorage::IsDirty](http://msdn.microsoft.com/library/windows/desktop/ms683910).  
...
### <a name="parameters"></a>Paramètres  
 *bCurValue*  
 True si le contrôle WebBrowser affiche des glyphes pour afficher l’emplacement de toutes les balises dans un document ; False si elle n’est pas le cas.  
...
##  <a name="getshowbrtags"></a>  CHtmlEditCtrlBase::GetShowBRTags  
 Récupère si le contrôle WebBrowser affiche un glyphe pour balises br.  
...
### <a name="parameters"></a>Paramètres  
 *bCurValue*  
 True si le contrôle WebBrowser affiche toutes les balises affichées dans Microsoft Internet Explorer 4.0, la valeur false s’il n’existe pas.  
...
##  <a name="indent"></a>  CHtmlEditCtrlBase::Indent  
 Augmente le retrait du texte sélectionné par incrément de la mise en un retrait.  
...
### <a name="parameters"></a>Paramètres  
 *szId*  
 L’ID du contrôle de la réinitialisation.  
...
##  <a name="italic"></a>  CHtmlEditCtrlBase::Italic  
 Active/désactive la sélection actuelle en italique.  
...
##  <a name="justifycenter"></a>  CHtmlEditCtrlBase::JustifyCenter  
 Centre du bloc de format dans lequel se trouve la sélection actuelle.  
...
##  <a name="justifyleft"></a>  CHtmlEditCtrlBase::JustifyLeft  
 Aligne à gauche le bloc du format dans lequel se trouve la sélection actuelle.  
...
##  <a name="justifyright"></a>  CHtmlEditCtrlBase::JustifyRight  
 Aligne à droite le bloc du format dans lequel se trouve la sélection actuelle.  
...
##  <a name="listbox"></a>  CHtmlEditCtrlBase::ListBox  
 Remplace le contrôle de zone de sélection de liste sur la sélection actuelle.  
...
##  <a name="marquee"></a>  CHtmlEditCtrlBase::Marquee  
 Remplace un texte défilant utilisé comme vide sur la sélection actuelle.  
...
##  <a name="orderlist"></a>  CHtmlEditCtrlBase::OrderList  
 Active/désactive la sélection actuelle entre une liste triée et un bloc de format normal.  
...
##  <a name="paste"></a>  CHtmlEditCtrlBase::Paste  
 Remplace le contenu du Presse-papiers dans la sélection actuelle.  
...
##  <a name="printpreview"></a>  CHtmlEditCtrlBase::PrintPreview  
 Ouvre la fenêtre Aperçu avant impression du document actif à l’aide du modèle d’aperçu avant impression par défaut ou un modèle personnalisé.  
...
### <a name="parameters"></a>Paramètres  
 *cmdID*  
 ID de la commande. Identificateurs de commande sont tirées de la `CGID_MSHTML` de groupe de commandes. Ces commandes sont définies dans Mshtmcid.h. Vous trouverez également la liste en ligne en [les identificateurs de commande MSHTML](http://go.microsoft.com/fwlink/p/?linkid=149220).  
...
##  <a name="set2dposition"></a>  CHtmlEditCtrlBase::Set2DPosition  
 Permet de positionnement absolu d’éléments à déplacer en faisant glisser.  
...
### <a name="parameters"></a>Paramètres  
 *bNewValue*  
 Si la valeur est true, vous pouvez déplacer des éléments de position absolue en faisant glisser.  
...
### <a name="parameters"></a>Paramètres  
 *bNewValue*  
 Si la valeur est true, la propriété de position de l’élément est « absolute » ; Si la valeur est false, elle est « statique ».  
...
### <a name="parameters"></a>Paramètres  
 *bNewValue*  
 Si la valeur est true, tout élément qui possède un attribut ATOMICSELECTION défini sur TRUE est accessibles uniquement en tant qu’unité.  
...
##  <a name="setcsseditinglevel"></a>  CHtmlEditCtrlBase::SetCSSEditingLevel  
 Sélectionne le niveau CSS (CSS1 ou CSS2) l’éditeur prendront en charge le cas échéant.  
 ...
 *bgras*  
 Passez la valeur true pour le texte en gras.  
  
 *bItalic*  
 Passez la valeur true pour du texte en italique.  
  
 *bUnderline*  
 Passez la valeur true pour le texte souligné.  
...
### <a name="parameters"></a>Paramètres  
 *bMode*  
 Si la valeur est true, active en mode Création.  
...
### <a name="parameters"></a>Paramètres  
 *bNewValue*  
 Si la valeur est true, désactive la bordure hachurée et handles autour d’un élément sélectionnable site lorsque l’élément a l’option « Modifier le focus » en mode Création ; Autrement dit, lorsque le texte ou le contenu de l’élément peut être modifiée.  
...
### <a name="parameters"></a>Paramètres  
 *size*  
 La taille de police HTML (1-7). La taille de police affecte la valeur de 0 à 1.  
...
##  <a name="setliveresize"></a>  CHtmlEditCtrlBase::SetLiveResize  
 Provoque le contrôle WebBrowser à mettre à jour d’apparence d’un élément en permanence pendant une opération de redimensionnement ou de déplacement, au lieu de la mise à jour uniquement à la fin du déplacement ou redimensionnement.  
...
### <a name="parameters"></a>Paramètres  
 *bNewValue*  
 Si la valeur est true, provoque le contrôle WebBrowser à mettre à jour d’apparence d’un élément en permanence pendant une opération de redimensionnement ou de déplacement ; Si la valeur est false, elle met à jour uniquement à la fin du déplacement ou redimensionnement.  
...
### <a name="parameters"></a>Paramètres  
 *bNewValue*  
 Si la valeur est true, tous les éléments qui ont une visibilité a la valeur « hidden » ou afficher la propriété est définie sur « aucun » seront affichera pas dans le mode Création et le mode de navigation ; Si la valeur est false, ces éléments seront affichera uniquement en mode de navigation.  
...
##  <a name="underline"></a>  CHtmlEditCtrlBase::Underline  
 Active/désactive la sélection actuelle entre souligné et ne pas souligné.  
...
##  <a name="unlink"></a>  CHtmlEditCtrlBase::Unlink  
 Supprime un lien hypertexte à partir de la sélection actuelle.  
