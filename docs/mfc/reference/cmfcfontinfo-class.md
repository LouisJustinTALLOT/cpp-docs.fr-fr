---
description: 'En savoir plus sur : classe CMFCFontInfo'
...
*lpszName*<br/>
dans Nom de la police. Pour plus d’informations, consultez le `lfFaceName` membre de la structure [LOGFONT](/windows/win32/api/wingdi/ns-wingdi-logfontw) .

*lpszScript*<br/>
dans Nom du script (jeu de caractères) de la police.

*nCharSet*<br/>
dans Valeur qui spécifie le jeu de caractères (script) de la police. Pour plus d’informations, consultez le `lfCharSet` membre de la structure [LOGFONT](/windows/win32/api/wingdi/ns-wingdi-logfontw) .

*nPitchAndFamily*<br/>
dans Valeur qui spécifie le pas et la famille de la police. Pour plus d’informations, consultez le `lfPitchAndFamily` membre de la structure [LOGFONT](/windows/win32/api/wingdi/ns-wingdi-logfontw) .
