...
### <a name="return-value"></a>Valeur de retour  
 Un pointeur vers l’élément global `CUserToolsManager` de l’objet ; NULL si l’utilisateur des outils administration n’est pas activé pour l’application.  
