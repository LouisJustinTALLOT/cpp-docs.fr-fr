---
title: Csmartdockinginfo, classe | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
### <a name="parameters"></a>Paramètres  
 [out] *params*  
 Un objet de type `CSmartDockingInfo` qui est rempli avec les paramètres d’ancrage actives en cours.  
