---
title: 'Wm, gestionnaires de messages : A - C | Documents Microsoft'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
ms.locfileid: "36271270"
---
# <a name="wm-message-handlers-a---c"></a>WM_, gestionnaires de messages : A - C
...
|ON_WM_CTLCOLOR()|afx_msg HBRUSH [OnCtlColor](../../mfc/reference/cwnd-class.md#onctlcolor)(capture de données modifiées\*, CWnd\*, UINT) ;|  
