---
title: Cmditabinfo, classe | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
### <a name="remarks"></a>Notes  
 ...
 STYLE_3D_SCROLLED  
 Style 3D avec des étiquettes d’onglet de rectangle.  
  
 STYLE_FLAT_SHARED_HORZ_SCROLL  
 Style à deux dimensions avec barre de défilement horizontale partagé.  
  
 STYLE_3D_ROUNDED_SCROLL  
 Style 3D avec des étiquettes de l’onglet arrondi.  
...
### <a name="parameters"></a>Paramètres  
 [in] *ar*  
 Un [de la classe CArchive](../../mfc/reference/carchive-class.md) objet à sérialiser.  
