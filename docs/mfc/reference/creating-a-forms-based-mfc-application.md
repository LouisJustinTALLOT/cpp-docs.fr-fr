...
2.  Dans l’Assistant Application MFC [Type d’Application](../../mfc/reference/application-type-mfc-application-wizard.md) page, sélectionnez le **support de l’architecture Document/vue** case à cocher.  
  
3.  Sélectionnez **monodocument**, **plusieurs documents**, ou **plusieurs documents de niveau supérieur**.  
...
4.  Définissez d’autres options de projet que vous souhaitez que sur les autres pages de l’Assistant.  
