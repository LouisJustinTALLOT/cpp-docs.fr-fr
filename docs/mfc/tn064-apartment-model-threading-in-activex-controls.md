---
description: 'En savoir plus sur : TN064 : Apartment-Model Threading dans les contrôles ActiveX'
...
## <a name="what-is-apartment-model-threading"></a>Qu’est-ce que le Threading Apartment-Model
...
## <a name="why-support-apartment-model-threading"></a>Pourquoi prendre en charge le Threading Apartment-Model
