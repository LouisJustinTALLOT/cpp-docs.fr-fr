---
description: 'En savoir plus sur : Comment : créer un Type-Safe collection'
...
## <a name="using-template-based-classes-for-type-safety"></a><a name="_core_using_template.2d.based_classes_for_type_safety"></a> Utilisation de classes Template-Based pour la sécurité de type
