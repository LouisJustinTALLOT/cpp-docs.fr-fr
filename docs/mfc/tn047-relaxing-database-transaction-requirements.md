---
title: 'TN047 : Assouplissement des exigences de Transaction de base de données'
ms.date: 11/04/2016
f1_keywords:
- vc.data
helpviewer_keywords:
...
ms.locfileid: "57276804"
---
# <a name="tn047-relaxing-database-transaction-requirements"></a>TN047 : Assouplissement des exigences de Transaction de base de données
