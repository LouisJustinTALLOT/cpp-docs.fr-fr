...
2.  Utilisez l’éditeur de boîtes de dialogue pour ajouter des contrôles au modèle de page de propriété.  
...
2.  Double-cliquez sur le **boîte de dialogue** icône directory.  
...
5.  Pour cet exemple, un texte de contrôle de l’étiquette « Caption : » et un contrôle de zone d’édition avec un identificateur IDC_CAPTION suffisent.  
