...
1. Dans le **nom interne** , tapez le nom de fonction interne de la méthode ou la valeur par défaut (dans ce cas, *PtInCircle*).

1. Dans le **Type de retour** , cliquez sur **VARIANT_BOOL** pour le type de retour de la méthode.

1. À l’aide de la **Type de paramètre** et **nom du paramètre** contrôles, ajoutez un paramètre appelé *xCoord* (type *OLE_XPOS_PIXELS*).
