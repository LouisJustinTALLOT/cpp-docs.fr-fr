...
Fournit des liens vers `CObject`l’utilisation de la classe de base pour la plupart des classes dans MFC.

[Collections](../mfc/collections.md)<br/>
Décrit les classes de collection créées à partir de et C++ non créées à partir de modèles.
...
`CFile` Décrit et comment gérer des fichiers dans MFC.
...
[Gestion des exceptions (MFC)](../mfc/exception-handling-in-mfc.md)<br/>
