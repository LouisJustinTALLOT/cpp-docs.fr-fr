...
Une fois la taille du champ de rappel actuel calculée, vous devez fournir une valeur pour le champ. Cette opération est effectuée dans le gestionnaire de la notification DTN_FORMAT.

## <a name="handling-the-dtn_format-notification"></a>Gestion de la notification DTN_FORMAT

La notification DTN_FORMAT est utilisée par l’application pour demander la chaîne de caractères qui sera substituée. L'exemple de code suivant illustre une méthode possible :
