---
description: 'En savoir plus sur : liste d’exemples de contrôle commun'
title: Liste d'exemples de contrôle commun
ms.date: 11/04/2016
helpviewer_keywords:
...
ms.locfileid: "97310717"
---
# <a name="common-control-sample-list"></a>Liste d'exemples de contrôle commun

Consultez les exemples de programmes suivants qui illustrent les contrôles courants :
