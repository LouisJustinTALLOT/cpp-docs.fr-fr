...
1. Générer le [exemple TSTCON : Contrôle ActiveX Test Container](../overview/visual-cpp-samples.md).
...
[Procédure : déboguer un contrôle ActiveX](/visualstudio/debugger/how-to-debug-an-activex-control)
