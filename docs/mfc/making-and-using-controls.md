---
title: Création et utilisation de contrôles | Documents Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
ms.locfileid: "33347005"
---
# <a name="making-and-using-controls"></a>Création et utilisation de contrôles
Vous effectuez la plupart des contrôles de boîtes de dialogue dans Visual C++ [éditeur de boîte de dialogue](../windows/dialog-editor.md). Mais vous pouvez également créer des contrôles dans toute boîte de dialogue ou la fenêtre.  
...
-   [Ajout manuel de contrôles](../mfc/adding-controls-by-hand.md) (sans l’éditeur de boîte de dialogue)  
  
-   [Dériver des contrôles d’un contrôle standard](../mfc/deriving-controls-from-a-standard-control.md)  
  
-   [À l’aide d’un contrôle commun en tant que fenêtre enfant](../mfc/using-a-common-control-as-a-child-window.md)  
...
-   Des contrôles individuels : consultez [contrôles](../mfc/controls-mfc.md) pour des liens vers tous les contrôles communs  
