...
|`// use the archive to pass data:`<br /><br /> `arIn >> dwValue;`<br /><br /> - ou -<br /><br /> `arOut << dwValue;`6|`// use the archive to pass data:`<br /><br /> `arIn >> dwValue;`<br /><br /> - ou -<br /><br /> `arOut << dwValue;`6|  
 ...
 2. Le serveur doit toujours spécifier un port afin que les clients peuvent se connecter. Le `Create` appel spécifie également une adresse. Du côté client, utilisez les paramètres par défaut, qui demandent à MFC d’utiliser tout port disponible.  
