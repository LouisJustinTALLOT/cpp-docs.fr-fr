...
### [Gestion de la mémoire : Allocation des tas](memory-management-heap-allocation.md)
...
##### [Clients Automation : Utilisation de bibliothèques de types](automation-clients-using-type-libraries.md)
#### [Serveurs Automation](automation-servers.md)
##### [Serveurs Automation : Problèmes de durée de vie des objets](automation-servers-object-lifetime-issues.md)
...
#### [Glisser-déposer : Implémentation d’une source de déplacement](drag-and-drop-implementing-a-drop-source.md)
#### [Glisser-déposer : Implémentation d’une cible de déplacement](drag-and-drop-implementing-a-drop-target.md)
...
#### [Menus et ressources : Fusion des menus](menus-and-resources-menu-merging.md)
...
##### [Guide pratique pour Implémentation du suivi dans votre code](how-to-implement-tracking-in-your-code.md)
##### [Bande élastique et dispositifs de suivi](rubber-banding-and-trackers.md)
## [Sérialisation dans MFC](serialization-in-mfc.md)
### [Sérialisation : Définition d’une classe sérialisable](serialization-making-a-serializable-class.md)
...
### [Sérialisation : Sérialisation ou base de données d’entrée-sortie](serialization-serialization-vs-database-input-output.md)
...
##### [Contrôles ActiveX MFC : Licence d’un contrôle ActiveX](mfc-activex-controls-licensing-an-activex-control.md)
...
##### [Presse-papiers : Copie et collage de données](clipboard-copying-and-pasting-data.md)
...
#### [Windows Sockets : Séquence d’opérations](windows-sockets-sequence-of-operations.md)
...
## [TN045 : Prise en charge de longs varchar-varbinary par MFC-Database](tn045-mfc-database-support-for-long-varchar-varbinary.md)
...
## [TN071 : Implémentation d’IOleCommandTarget MFC](tn071-mfc-iolecommandtarget-implementation.md)
