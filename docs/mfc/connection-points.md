...
Un Point de connexion implémenté  
 ...
 Si la classe a plusieurs connexions de point, insérer supplémentaires **CONNECTION_PART** macros entre le **BEGIN_CONNECTION_MAP** et **END_CONNECTION_MAP** macros.  
