...
2.  Dans le **nouveau projet** boîte de dialogue, dans le volet gauche sous **modèles installés**, développez **Visual C++** , puis sélectionnez **MFC**. Dans le volet central, sélectionnez **Application MFC**. Dans la zone **Nom**, tapez `MFCAnimationWalkthrough`. Cliquez sur **OK**.  
...
4.  Sous **Animation**, dans le **Type ici** , tapez `Start &Forward` pour créer une commande Démarrer en avant.  
  
5.  Sous **démarrer avant**, dans le **Type ici** , tapez `Start &Backward`.  
  
6.  Sous **démarrer descendante**, dans le **Type ici** , tapez `S&top` pour créer une commande d’arrêt.  
