...
2. Dans le fichier mainfrm.cpp, ajoutez le code suivant avant le dernier `return` instruction à la fin de la `CMainFrame::OnCreate` (fonction). Cette opération crée une instance de la barre du ruban.
...
2. Enregistrer les modifications, puis créer et exécuter l’application. L’interface utilisateur de l’application doit ressembler à l’interface utilisateur d’Office 2007.

[[Sections](#top)]

## <a name="next-steps"></a>Étapes suivantes

Vous avez modifié l’exemple MFC de 1.0 Scribble classique pour utiliser le Concepteur de ruban. Passez maintenant à [partie 2](../mfc/walkthrough-updating-the-mfc-scribble-application-part-2.md).
