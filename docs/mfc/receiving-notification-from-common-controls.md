---
description: 'En savoir plus sur : réception des notifications à partir de contrôles communs'
...
> [!NOTE]
> `CWnd::GetCurrentMessage` doit uniquement être appelé dans un gestionnaire de messages.
...
À ce stade, l’emplacement du curseur de la souris est stocké dans l' `cursorPos` objet.
