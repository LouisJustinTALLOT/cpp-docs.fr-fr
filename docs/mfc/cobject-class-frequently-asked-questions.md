---
title: 'Classe CObject : Forum aux Questions | Documents Microsoft'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
-   [Combien coûte le service dériver une classe de CObject](what-does-it-cost-me-to-derive-a-class-from-cobject-q.md)  
