...
description: Liste des fichiers qui contiennent les bibliothèques Runtime C Microsoft, ainsi que les options de compilateur et les directives de préprocesseur qui leur sont associées.
ms.date: 09/03/2020
ms.topic: conceptual
helpviewer_keywords:
- MSVCR71.dll
