...
description: Il s’agit de différents fichiers. lib qui composent les bibliothèques Runtime C de Microsoft, ainsi que les options de compilateur et les directives de préprocesseur qui leur sont associées.
ms.date: 08/20/2018
helpviewer_keywords:
- MSVCR71.dll
