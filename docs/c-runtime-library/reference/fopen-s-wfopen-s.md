...
Le tableau suivant récapitule les modes pour différents indicateurs *CCS* qui sont donnés à **fopen_s** et pour les marques d’ordre d’octet dans le fichier.
...
|*mode*|Accès|
|-|-|
| **r** | Ouvre pour l'accès en lecture. Si le fichier n’existe pas ou est introuvable, l’appel de **fopen_s** échoue. |
...
|**r +**|**_O_RDWR** &#124; **_O_APPEND** (généralement **_O_RDWR** &#124; **_O_APPEND &#124; _O_CREAT** **)**|
|**r**|**_O_RDONLY**|
|**r +**|**_O_RDWR**|
