...
Pour plus d’informations sur ces codes d’erreur [ \_,\_consultez doserrno, errno, \_\_sys errlist et \_sys nErr](../../c-runtime-library/errno-doserrno-sys-errlist-and-sys-nerr.md) .
