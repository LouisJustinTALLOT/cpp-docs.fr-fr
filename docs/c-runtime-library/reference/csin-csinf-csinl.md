...
C++ autorisant la surcharge, vous pouvez appeler des surcharges de **csin** qui acceptent et retournent **_Fcomplex** et **_Lcomplex** valeurs. Dans un programme C, **csin** accepte et retourne toujours un **_Dcomplex** valeur.
