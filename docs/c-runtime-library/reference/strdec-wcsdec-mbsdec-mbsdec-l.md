)---titre : « _strdec, _wcsdec, _mbsdec, _mbsdec_l | Microsoft Docs » ms.custom : « » ms.date : « 11/04/2016"ms.technology : [« cpp-standard-bibliothèques »] ms.topic : apiname « référence » : [« _wcsdec », « _strdec », « _mbsdec », « _mbsdec_l »] apilocation : [« msvcrt.dll », « msvcr80.dll », « msvcr90.dll », « msvcr100.dll » « msvcr100_clr0400.dll », « msvcr110.dll », « msvcr110_clr0400.dll », « msvcr120.dll », « msvcr120_clr0400.dll », « ucrtbase.dll », « api-ms-win-crt-multibyte-l1-1-0.dll »] apitype : « DLLExport » f1_keywords : [« _strdec », « mbsdec_l », « strdec », « _mbsdec », « _mbsdec_l », « mbsdec », « wcsdec », « _wcsdec »] dev_langs : [« C++ »] helpviewer_keywords : [« mbsdec_l (fonction) », « fonction mbsdec », « tcsdec (fonction) », « fonction _tcsdec », « fonction _strdec », « _wcsdec (fonction) », « fonction _mbsdec_l », « strdec (fonction) », » wcsdec (fonction) », « fonction _mbsdec »] ms.assetid : ae37c223-800f-48a9-ae8e-38c8d20af2dd auteur : « msft corob » ms.author : « corob » ms.workload : [« cplusplus »]
---
