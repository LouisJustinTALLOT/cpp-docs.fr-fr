...
|*buffer*|*numberOfElements*|*pSizeRead*|Return|Contenu de la *mémoire tampon*|
|--------------|------------------------|-----------------|------------|--------------------------|
|**NULL**|indifférent|indifférent|**EINVAL**|N/A|
|non **null**|zéro|indifférent|**EINVAL**|non modifié|
|non **null**|indifférent|**NULL**|**EINVAL**|chaîne de longueur nulle|
