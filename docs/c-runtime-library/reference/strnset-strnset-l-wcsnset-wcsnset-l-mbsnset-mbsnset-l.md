...
Le **_strnset** affecte la fonction, au maximum, la première *nombre* caractères de *str* à *c* (converti en **char**). Si *nombre* est supérieure à la longueur de *str*, la longueur de *str* est utilisé à la place de *nombre*.
