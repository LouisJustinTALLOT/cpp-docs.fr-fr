...
Sachant que C++ autorise la surcharge, vous pouvez appeler des surcharges de **expm1** qui acceptent et retournent **float** et **long** **double** valeurs. Dans un programme C, **expm1** accepte et retourne toujours un **double**.
