...
Étant C++ donné que autorise la surcharge, vous pouvez appeler des surcharges de **copysign** qui acceptent et retournent des valeurs **float** ou **long** **double** . Dans un programme C, **copysign** accepte et retourne toujours un **double**.
