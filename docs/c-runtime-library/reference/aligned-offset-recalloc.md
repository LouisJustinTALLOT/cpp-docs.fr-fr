...
Comme [_aligned_offset_malloc](aligned-offset-malloc.md), **_aligned_offset_recalloc** permet l’alignement d’une structure sur un décalage au sein de la structure.
