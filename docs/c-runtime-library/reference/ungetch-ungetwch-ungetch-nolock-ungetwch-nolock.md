...
Les deux fonctions retournent le caractère *c* en cas de réussite. S’il existe une erreur, **_ungetch** retourne une valeur de **EOF** et **_ungetwch** retourne **WEOF**.
