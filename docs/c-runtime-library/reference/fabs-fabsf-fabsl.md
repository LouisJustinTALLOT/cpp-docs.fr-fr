...
C++ autorisant la surcharge, vous pouvez appeler des surcharges de **fabs** si vous incluez le \<cmath > en-tête. Dans un programme C, **fabs** accepte et retourne toujours un **double**.
