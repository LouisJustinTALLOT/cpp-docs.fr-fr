...
C++autorise la surcharge, donc vous pouvez appeler des surcharges de **FABS** si vous incluez \<l’en-tête de > cmath. Dans un programme C, **FABS** accepte et retourne toujours un **double**.
