...
Si le chemin d’accès complet ne contient pas de composant (par exemple, un nom de fichier), **_splitpath** assigne des chaînes vides aux mémoires tampons correspondantes.
