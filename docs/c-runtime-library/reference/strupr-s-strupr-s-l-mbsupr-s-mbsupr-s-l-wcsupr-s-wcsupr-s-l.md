...
> [!IMPORTANT]
> **_mbsupr_s** et **_mbsupr_s_l** ne peuvent pas être utilisés dans les applications qui s’exécutent dans le Windows Runtime. Pour plus d’informations, consultez [Fonctions CRT non prises en charge dans les applications de la plateforme Windows universelle](../../cppcx/crt-functions-not-supported-in-universal-windows-platform-apps.md).
...
Ces fonctions valident leurs paramètres. Si *str* est un pointeur **NULL,** le gestionnaire de paramètres invalides est invoqué, tel que décrit dans [La validation de paramètres](../../c-runtime-library/parameter-validation.md) . Si l’exécution est autorisée à se poursuivre, les fonctions retournent **EINVAL** et **placent errno** à **EINVAL**. Si *numberOfElements* est inférieur à la longueur de la chaîne, les fonctions renvoient **ERANGE** et **placent errno** à **ERANGE**.

## <a name="remarks"></a>Notes

La fonction **_strupr_s** convertit, en place, chaque lettre minuscule en *str* à uppercase. **_wcsupr_s** est la version grand caractère de **_strupr_s**. **_mbsupr_s** est la version multi-byte caractère de **_strupr_s**.

La conversion est déterminée par le **LC_CTYPE** cadre de catégorie du lieu. Les autres caractères ne sont pas concernés. Pour plus d’informations sur **LC_CTYPE**, voir [setlocale](setlocale-wsetlocale.md). Les versions de ces fonctions sans le **suffixe _l** utilisent le lieu actuel; les visions avec le **suffixe _l** sont identiques, sauf qu’ils utilisent le lieu passé à la place. Pour plus d’informations, consultez [Locale](../../c-runtime-library/locale.md).
...
Consultez l’exemple relatif à [_strlwr_s, _strlwr_s_l, _mbslwr_s, _mbslwr_s_l, _wcslwr_s, _wcslwr_s_l](strlwr-s-strlwr-s-l-mbslwr-s-mbslwr-s-l-wcslwr-s-wcslwr-s-l.md).
