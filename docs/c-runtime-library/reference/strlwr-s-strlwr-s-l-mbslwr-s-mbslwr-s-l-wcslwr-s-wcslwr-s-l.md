...
Ces fonctions valident leurs paramètres. Si *str* n’est pas une chaîne valide non résiliée, le gestionnaire de paramètres invalide est invoqué, tel que décrit dans [La validation de paramètres](../../c-runtime-library/parameter-validation.md) . Si l’exécution est autorisée à se poursuivre, les fonctions retournent **EINVAL** et **placent errno** à **EINVAL**. Si *numberOfElements* est inférieur à la longueur de la chaîne, les fonctions retournent également **EINVAL** et **placent errno** à **EINVAL**.

## <a name="remarks"></a>Notes

La fonction **_strlwr_s** convertit, en place, toutes les lettres majuscules en *str* à lowercase. **_mbslwr_s** est une version de caractère multi-byte de **_strlwr_s**. **_wcslwr_s** est une version à caractère large de **_strlwr_s**.
