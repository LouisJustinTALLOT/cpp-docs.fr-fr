...
Chacune de ces routines retourne une valeur différente de zéro si *c* est une représentation particulière d’un caractère minuscule. **IsLower** retourne une valeur différente de zéro si *c* est un caractère minuscule (a-z). **iswlower** retourne une valeur différente de zéro si *c* est un caractère élargi qui correspond à une lettre minuscule, ou si *c* est l’un des jeux de caractères larges définis par l’implémentation pour lesquels aucun des **iswcntrl**, **iswdigit**, **iswpunct** , ou **iswspace** est différent de zéro. Chacune de ces routines retourne 0 si *c* ne satisfait pas la condition de test.
