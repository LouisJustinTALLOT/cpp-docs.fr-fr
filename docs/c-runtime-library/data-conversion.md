---
description: 'En savoir plus sur : conversion de données'
...
|Routine|Utilisation|
|-------------|---------|
|[absolue](../c-runtime-library/reference/abs-labs-llabs-abs64.md)|Rechercher la valeur absolue d’un entier|
...
|[atol, _atol_l](../c-runtime-library/reference/atol-atol-l-wtol-wtol-l.md)|Convertir une chaîne en **`long`**|
...
|[_ecvt](../c-runtime-library/reference/ecvt.md), [_ecvt_s](../c-runtime-library/reference/ecvt-s.md)|Convertir **`double`** en chaîne de longueur spécifiée|
|[_fcvt](../c-runtime-library/reference/fcvt.md), [_fcvt_s](../c-runtime-library/reference/fcvt-s.md)|Convertir **`double`** en chaîne avec le nombre spécifié de chiffres après la virgule décimale|
|[_gcvt](../c-runtime-library/reference/gcvt.md), [_gcvt_s](../c-runtime-library/reference/gcvt-s.md)|Convertir un **`double`** nombre en chaîne ; stocker la chaîne dans la mémoire tampon|
...
|[labs](../c-runtime-library/reference/abs-labs-llabs-abs64.md)|Rechercher la valeur absolue de l' **`long`** entier|
|[llabs](../c-runtime-library/reference/abs-labs-llabs-abs64.md)|Rechercher la valeur absolue de l' **`long long`** entier|
...
|[strtol, wcstol, _strtol_l, _wcstol_l](../c-runtime-library/reference/strtol-wcstol-strtol-l-wcstol-l.md)|Convertir une chaîne en **`long`** entier|
|[strtoul, _strtoul_l, wcstoul, _wcstoul_l](../c-runtime-library/reference/strtoul-strtoul-l-wcstoul-wcstoul-l.md)|Convertir une chaîne en **`unsigned long`** entier|
...
|[tolower, _tolower, towlower, _tolower_l, _towlower_l](../c-runtime-library/reference/tolower-tolower-towlower-tolower-l-towlower-l.md)|Convertir un caractère en minuscule sans condition|
