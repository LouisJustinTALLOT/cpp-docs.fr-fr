...
|[_fgetchar, _fgetwchar](../c-runtime-library/reference/fgetc-fgetwc.md)|Lire un caractère à partir de **stdin** (versions fonction de **getchar** et **getwchar**)|
