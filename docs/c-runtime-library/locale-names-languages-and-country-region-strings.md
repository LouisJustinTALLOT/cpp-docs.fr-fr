...
&nbsp;&nbsp;&nbsp;&nbsp;\| \[LC_COLLATE **=** _locale_]\[ **; LC_CTYPE =** _paramètres régionaux_]\[ **; LC_MONETARY =** _paramètres régionaux_]\[ **; LC_NUMERIC =** _paramètres régionaux_]\[ **; LC_TIME =** _paramètres régionaux_]
