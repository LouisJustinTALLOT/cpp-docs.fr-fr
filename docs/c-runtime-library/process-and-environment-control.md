...
|Routine|Utilisation|
|-------------|---------|
|[abort](../c-runtime-library/reference/abort.md)|Abandonner le processus sans vider les mémoires tampons ou appeler des fonctions inscrites par **atexit** et **_onexit**|
...
|[_spawnlp, _wspawnlp](../c-runtime-library/reference/spawnlp-wspawnlp.md)|Créer un processus et l’exécuter en utilisant la variable **PATH** et la liste d’arguments spécifiée|
...
### <a name="_spawn-and-_exec-function-families"></a>Familles de fonctions _spawn et _exec
...
|---------------|--------------------------------------|----------------------------------|--------------------------|
|**_execl**, **_spawnl**|Non|List|Hérité du processus appelant|
|**_execle**, **_spawnle**|Non|List|Pointeur vers la table d’environnement pour le nouveau processus passé comme dernier argument|
|**_execlp**, **_spawnlp**|Oui|List|Hérité du processus appelant|
|**_execvpe**, **_spawnvpe**|Oui|Array|Pointeur vers la table d’environnement pour le nouveau processus passé comme dernier argument|
|**_execlpe**, **_spawnlpe**|Oui|List|Pointeur vers la table d’environnement pour le nouveau processus passé comme dernier argument|
|**_execv**, **_spawnv**|Non|Array|Hérité du processus appelant|
|**_execve**, **_spawnve**|Non|Array|Pointeur vers la table d’environnement pour le nouveau processus passé comme dernier argument|
|**_execvp**, **_spawnvp**|Oui|Array|Hérité du processus appelant|
