---
description: 'En savoir plus sur : messages générés par la fonction perror'
title: Messages générés par la fonction perror
ms.date: 11/04/2016
...
La fonction `perror` génère les messages suivants :
