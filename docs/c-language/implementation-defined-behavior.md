---
title: Comportement défini par l'implémentation
ms.date: 11/04/2016
helpviewer_keywords:
...
> [!NOTE]
> Cette section décrit uniquement la version anglaise des États-Unis du compilateur C. Les implémentations de Microsoft C pour les autres langages sont susceptibles de différer légèrement.
