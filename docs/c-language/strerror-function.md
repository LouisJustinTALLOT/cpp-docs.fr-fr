---
description: 'En savoir plus sur : fonction strerror'
title: strerror, fonction
ms.date: 11/04/2016
helpviewer_keywords:
- strerror function
...
ms.locfileid: "97205250"
---
# <a name="strerror-function"></a>strerror, fonction

**ANSI 4.11.6.2** Le contenu des chaînes de message d'erreur retourné par la fonction `strerror`

La fonction `strerror` génère les messages suivants :
