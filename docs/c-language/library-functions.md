---
title: Fonctions des bibliothèques | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-language
...
- [Fonction signal](../c-language/signal-function-c.md)

- [Signaux par défaut](../c-language/default-signals.md)

- [Fin des caractères de saut de ligne](../c-language/terminating-newline-characters.md)
...
- [Lecture des plages](../c-language/reading-ranges.md)

- [Erreurs de position de fichier](../c-language/file-position-errors.md)
...
- [Fonction atexit](../c-language/atexit-function-c.md)

- [Noms d’environnement](../c-language/environment-names.md)

- [Fonction système](../c-language/system-function.md)

- [Fonction strerror](../c-language/strerror-function.md)

- [Fuseau horaire](../c-language/time-zone.md)

- [Fonction d'horloge](../c-language/clock-function-c.md)
