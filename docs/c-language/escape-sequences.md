---
description: 'En savoir plus sur : séquences d’échappement'
...
Notez que le point d’interrogation précédé d’une barre oblique inverse (**\\ ?**) spécifie un point d’interrogation littéral dans les cas où la séquence de caractères serait interprétée à tort comme un trigraphe. Pour plus d'informations, consultez [Trigraphes](../c-language/trigraphs.md).
