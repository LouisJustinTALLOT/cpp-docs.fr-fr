...
description: En savoir plus sur la grammaire C standard pour les déclarations implémentées par le compilateur Microsoft C/C++.
ms.date: 10/30/2020
...
&emsp;*`extended-decl-modifier`*<sub>possibilité</sub>\
...
&emsp;**`short`**\
&emsp;**`int`**\
&emsp;**`__int8`**<sup>1,0</sup>\
&emsp;**`__int16`**<sup>1,0</sup>\
&emsp;**`__int32`**<sup>1,0</sup>\
&emsp;**`__int64`**<sup>1,0</sup>\
&emsp;**`long`**\
&emsp;**`float`**\
&emsp;**`double`**\
&emsp;**`signed`**\
...
&emsp;*`struct-or-union`**`identifier`* <sub>opt</sub> **`{`** OPT *`struct-declaration-list`***`}`**\
...
&emsp;*`identifier`*\
&emsp;**`(`** *`declarator`* **`)`**\
&emsp;*`direct-declarator`***`[`** OPT opt *`type-qualifier-list`* <sub>opt</sub> *`assignment-expression`* <sub>opt</sub>**`]`**\
...
&emsp;*`direct-declarator`***`[`** *`type-qualifier-list`* <sub>opt</sub> opt **`*`****`]`**\
...
&emsp;*`direct-abstract-declarator`***`[`** OPT opt *`type-qualifier-list`* <sub>opt</sub> *`assignment-expression`* <sub>opt</sub>**`]`**\
...
&emsp;*`direct-abstract-declarator`***`[`** *`type-qualifier-list`* <sub>opt</sub> opt **`*`****`]`**\
...
<sup>1</sup> cet élément de syntaxe est spécifique à Microsoft. \
<sup>2</sup> pour plus d’informations sur ces éléments, consultez,,,,,, [`__asm`](../assembler/inline/asm.md) [`__clrcall`](../cpp/clrcall.md) [`__stdcall`](../cpp/stdcall.md) [`__based`](../cpp/based-grammar.md) [`__fastcall`](../cpp/fastcall.md) [`__thiscall`](../cpp/thiscall.md) [`__cdecl`](../cpp/cdecl.md) , [`__inline`](../cpp/inline-functions-cpp.md) et [`__vectorcall`](../cpp/vectorcall.md) .
<sup>3</sup> ce style est obsolète.

## <a name="see-also"></a>Voir aussi

[Conventions d’appel](../cpp/calling-conventions.md)\
[Grammaire de la structure des expressions](./phrase-structure-grammar.md)\
