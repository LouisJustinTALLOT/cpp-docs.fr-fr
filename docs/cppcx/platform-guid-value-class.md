...
Pour générer `Platform::Guid`une nouvelle , utilisez [windows::Foundation::GuidHelper::CreateNewGuid](/uwp/api/windows.foundation.guidhelper.createnewguid) méthode statique.
