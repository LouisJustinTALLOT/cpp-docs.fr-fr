...
*__is_valid_winrt_type()* une fonction générée par le compilateur qui valide le type de *K* et *V* et fournit un message d’erreur convivial si le type ne peut pas être stocké dans le mappage.
