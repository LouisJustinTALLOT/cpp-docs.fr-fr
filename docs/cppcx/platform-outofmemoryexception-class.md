---
description: 'En savoir plus sur : Platform :: OutOfMemoryException, classe'
title: Platform::OutOfMemoryException, classe
ms.date: 12/30/2016
ms.topic: reference
f1_keywords:
...
ms.locfileid: "97308079"
---
# <a name="platformoutofmemoryexception-class"></a>Platform::OutOfMemoryException, classe
