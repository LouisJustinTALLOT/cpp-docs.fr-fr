...
|[EventSource (classe)](eventsource-class.md)|Représente un événement. `EventSource` fonctions membres ajouter, supprimer et appellent des gestionnaires d’événements.|
...
|[Callback, fonction](callback-function-wrl.md)|Crée un objet dont la fonction membre est une méthode de rappel.|
