...
|[Aide-mémoire (C++/CX)](../../cppcx/quick-reference-c-cx.md)|Décrit brièvement les C++fonctionnalités de/CX qui prennent en charge le Windows Runtime.|
