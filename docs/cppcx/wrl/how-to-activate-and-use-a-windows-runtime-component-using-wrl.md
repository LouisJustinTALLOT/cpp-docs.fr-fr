---
title: 'Procédure : Activer et utiliser un composant Windows Runtime à l’aide de WRL'
ms.date: 11/04/2016
ms.topic: reference
...
5. Utilisez la `IUriRuntimeClassFactory::CreateUri` méthode de fabrique pour créer `ABI::Windows::Foundation::IUriRuntimeClass` un objet.
...
Pour compiler le code, copiez-le, puis collez-le dans un projet Visual Studio, ou collez-le `wrl-consume-component.cpp` dans un fichier nommé, puis exécutez la commande suivante dans une fenêtre d’invite de commandes Visual Studio.
