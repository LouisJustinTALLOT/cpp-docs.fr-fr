...
|[Platform::Collections::InputIterator\<T>](../cppcx/platform-collections-inputiterator-class.md)<br /><br /> (Stocke en interne [IIterator\<T >](/uwp/api/Windows.Foundation.Collections.IIterator_T_)^ et T.)|[commencer](../cppcx/begin-function.md)/ [fin](../cppcx/end-function.md) ([IIterable\<T >](/uwp/api/Windows.Foundation.Collections.IIterable_T_))|
|[Platform::Collections::InputIterator<IKeyValuePair\<K, V>^>](../cppcx/platform-collections-inputiterator-class.md)<br /><br /> (Stocke en interne [IIterator\<T >](/uwp/api/Windows.Foundation.Collections.IIterator_T_)^ et T.)|[commencer](../cppcx/begin-function.md)/ [fin](../cppcx/end-function.md) ([IMap\<K, V >](/uwp/api/Windows.Foundation.Collections.IMap_K_V_).|
