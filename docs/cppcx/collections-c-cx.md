...
- Les C++types de collections/CX prennent en charge les mêmes garanties de sécurité des threads que celles prises en charge par les conteneurs STL.
