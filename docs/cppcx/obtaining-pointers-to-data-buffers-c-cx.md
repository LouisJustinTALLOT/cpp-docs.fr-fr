---
description: 'En savoir plus sur : obtention de pointeurs vers des mémoires tampons de données (C++/CX)'
...
1. Ajoutez un nouveau composant de Windows Runtime C++ à la solution existante, puis nommez-le `ImageManipCPP` . Ajoutez une référence à ce dernier dans le projet C# en cliquant avec le bouton droit sur le projet dans l' **Explorateur de solutions** , puis en choisissant **Ajouter**, **Référence**.
