...
|[GetColumnInfo](#getcolumninfo)|Implémente [IColumnsInfo::GetColumnInfo](https://docs.microsoft.com/previous-versions/windows/desktop/ms722704(v=vs.85)).|
...
Consultez [IColumnsInfo::GetColumnInfo](https://docs.microsoft.com/previous-versions/windows/desktop/ms722704(v=vs.85)) dans le *de référence du programmeur OLE DB*.
...
Pour plus d’informations, consultez [IColumnsInfo::GetColumnInfo](https://docs.microsoft.com/previous-versions/windows/desktop/ms722704(v=vs.85)) dans le *de référence du programmeur OLE DB*.
