...
Consultez [ISourcesRowset::GetSourcesRowset](https://docs.microsoft.com/previous-versions/windows/desktop/ms711200(v=vs.85)) dans le *de référence du programmeur OLE DB* pour plus d’informations.
