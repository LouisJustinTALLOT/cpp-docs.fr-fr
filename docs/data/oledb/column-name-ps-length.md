---
title: COLUMN_NAME_PS_LENGTH | Documents Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
ms.locfileid: "33098067"
---
# <a name="columnnamepslength"></a>COLUMN_NAME_PS_LENGTH
Représente une liaison sur l’ensemble de lignes à la colonne dans l’ensemble de lignes. Semblable à [COLUMN_NAME](../../data/oledb/column-name.md), sauf que cette macro prend également la longueur de la précision, échelle et de colonne.  
