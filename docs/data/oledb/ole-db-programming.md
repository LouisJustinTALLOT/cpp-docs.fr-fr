---
description: 'En savoir plus sur : programmation de OLE DB'
...
En outre, vous pouvez utiliser des attributs pour implémenter les modèles de consommateur OLE DB.
...
|Classes et macros des modèles OLE DB|Informations de référence sur les [modèles de OLE DB](../../data/oledb/ole-db-templates.md) (Visual C++)|
|Attributs du consommateur OLE DB|[Attributs du consommateur OLE DB](../../windows/attributes/ole-db-consumer-attributes.md)|
|Interfaces OLE DB|[Guide de référence du programmeur OLE DB](/sql/connect/oledb/oledb-driver-for-sql-server) (dans le SDK Windows)|
|Exemples de modèles OLE DB|[Exemples de modèles de OLE DB](https://github.com/Microsoft/VCSamples/tree/master/VC2010Samples/ATL/OLEDB)|
...
|Rubriques sur les concepts d'ODBC|[Open Database Connectivity (ODBC)](../../data/odbc/open-database-connectivity-odbc.md)|
