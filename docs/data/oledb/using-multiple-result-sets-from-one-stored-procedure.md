...
La plupart des procédures stockées retournent plusieurs jeux de résultats. Une telle procédure stockée inclut généralement une ou plusieurs instructions select. Le consommateur doit en tenir compte pour gérer tous les jeux de résultats.  
