...
2.  Dans le volet Types de projets, sélectionnez le dossier **Projets Visual C++**. Dans le volet Modèles, sélectionnez **Application MFC**.  
  
3.  Nom de projet, entrez **TestProv**, puis cliquez sur **OK**.  
