...
|[CATALOGUES](https://msdn.microsoft.com/library/ms721241.aspx)|[CCatalogs](#catalog)|[CCatalogInfo](#catalog)|  
|[CHARACTER_SETS](https://msdn.microsoft.com/library/ms722638.aspx)|[CCharacterSets](#characterset)|[CCharacterSetInfo](#characterset)|  
|[CLASSEMENTS](https://msdn.microsoft.com/library/ms715783.aspx)|[CCollations](#collation)|[CCollationInfo](#collation)|  
...
|[FOREIGN_KEYS CONTENU DANS](https://msdn.microsoft.com/library/ms711276.aspx)|[CForeignKeys](#foreignkeys)|[CForeignKeysInfo](#foreignkeys)|  
|[INDEX](https://msdn.microsoft.com/library/ms709712.aspx)|[CIndexes](#index)|[CIndexInfo](#index)|  
...
|[PROCÉDURES](https://msdn.microsoft.com/library/ms724021.aspx)|[CProcedures](#procedure)|[CProcedureInfo](#procedure)|  
...
|[SCHÉMAS](https://msdn.microsoft.com/library/ms716887.aspx)|[CSchemata](#schemata)|[CSchemataInfo](#schemata)|  
|[SQL_LANGUAGES](https://msdn.microsoft.com/library/ms714374.aspx)|[CSQLLanguages](#sqllanguage)|[CSQLLanguageInfo](#sqllanguage)|  
|[STATISTIQUES](https://msdn.microsoft.com/library/ms715957.aspx)|[CStatistics](#statistic)|[CStatisticInfo](#statistic)|  
...
|[TRADUCTIONS](https://msdn.microsoft.com/library/ms725365.aspx)|[CTranslations](#translation)|[CTranslationInfo](#translation)|  
...
|[AFFICHAGE](https://msdn.microsoft.com/library/ms723122.aspx)|[CViews](#view)|[CViewInfo](#view)|  
...
### <a name="remarks"></a>Notes  
 ...
 Le tableau suivant répertorie les membres de données de classe et de leurs colonnes OLE DB correspondant. Consultez [ensemble de lignes de catalogues](https://msdn.microsoft.com/library/ms721241.aspx) dans le *de référence du programmeur OLE DB* pour plus d’informations sur le schéma et les colonnes.  
...
### <a name="remarks"></a>Notes  
 ...
 Le tableau suivant répertorie les membres de données de classe et de leurs colonnes OLE DB correspondant. Consultez [ensemble de lignes CHARACTER_SETS](https://msdn.microsoft.com/library/ms722638.aspx) dans le *de référence du programmeur OLE DB* pour plus d’informations sur le schéma et les colonnes.  
...
### <a name="remarks"></a>Notes  
 ...
 Le tableau suivant répertorie les membres de données de classe et de leurs colonnes OLE DB correspondant. Consultez [ensemble de lignes CHECK_CONSTRAINTS](https://msdn.microsoft.com/library/ms712845.aspx) dans le *de référence du programmeur OLE DB* pour plus d’informations sur le schéma et les colonnes.  
...
### <a name="remarks"></a>Notes  
 ...
 Le tableau suivant répertorie les membres de données de classe et de leurs colonnes OLE DB correspondant. Consultez [ensemble de lignes de classements](https://msdn.microsoft.com/library/ms715783.aspx) dans le *de référence du programmeur OLE DB* pour plus d’informations sur le schéma et les colonnes.  
...
### <a name="remarks"></a>Notes  
 ...
 Le tableau suivant répertorie les membres de données de classe et de leurs colonnes OLE DB correspondant. Consultez [ensemble de lignes COLUMN_DOMAIN_USAGE](https://msdn.microsoft.com/library/ms711240.aspx) dans le *de référence du programmeur OLE DB* pour plus d’informations sur le schéma et les colonnes.  
...
### <a name="remarks"></a>Notes  
 ...
 Le tableau suivant répertorie les membres de données de classe et de leurs colonnes OLE DB correspondant. Consultez [ensemble de lignes COLUMN_PRIVILEGES](https://msdn.microsoft.com/library/ms715800.aspx) dans le *de référence du programmeur OLE DB* pour plus d’informations sur le schéma et les colonnes.  
...
### <a name="remarks"></a>Notes  
 ...
 Le tableau suivant répertorie les membres de données de classe et de leurs colonnes OLE DB correspondant. Consultez [ensemble de lignes COLUMNS](https://msdn.microsoft.com/library/ms723052.aspx) dans le *de référence du programmeur OLE DB* pour plus d’informations sur le schéma et les colonnes.  
...
### <a name="remarks"></a>Notes  
 ...
 Le tableau suivant répertorie les membres de données de classe et de leurs colonnes OLE DB correspondant. Consultez [ensemble de lignes CONSTRAINT_TABLE_USAGE](https://msdn.microsoft.com/library/ms724522.aspx) dans le *de référence du programmeur OLE DB* pour plus d’informations sur le schéma et les colonnes.  
...
### <a name="remarks"></a>Notes  
 ...
 Le tableau suivant répertorie les membres de données de classe et de leurs colonnes OLE DB correspondant. Consultez [ensemble de lignes FOREIGN_KEYS](https://msdn.microsoft.com/library/ms711276.aspx) dans le *de référence du programmeur OLE DB* pour plus d’informations sur le schéma et les colonnes.  
...
### <a name="remarks"></a>Notes  
 ...
 Le tableau suivant répertorie les membres de données de classe et de leurs colonnes OLE DB correspondant. Consultez [ensemble de lignes INDEXES](https://msdn.microsoft.com/library/ms709712.aspx) dans le *de référence du programmeur OLE DB* pour plus d’informations sur le schéma et les colonnes.  
...
### <a name="remarks"></a>Notes  
 ...
 Le tableau suivant répertorie les membres de données de classe et de leurs colonnes OLE DB correspondant. Consultez [ensemble de lignes KEY_COLUMN_USAGE](https://msdn.microsoft.com/library/ms712990.aspx) dans le *de référence du programmeur OLE DB* pour plus d’informations sur le schéma et les colonnes.  
...
### <a name="remarks"></a>Notes  
 ...
 Le tableau suivant répertorie les membres de données de classe et de leurs colonnes OLE DB correspondant. Consultez [ensemble de lignes PRIMARY_KEYS](https://msdn.microsoft.com/library/ms714362.aspx) dans le *de référence du programmeur OLE DB* pour plus d’informations sur le schéma et les colonnes.  
...
### <a name="remarks"></a>Notes  
 ...
 Le tableau suivant répertorie les membres de données de classe et de leurs colonnes OLE DB correspondant. Consultez [ensemble de lignes PROCEDURE_COLUMNS](https://msdn.microsoft.com/library/ms723092.aspx) dans le *de référence du programmeur OLE DB* pour plus d’informations sur le schéma et les colonnes.  
...
### <a name="remarks"></a>Notes  
 ...
 Le tableau suivant répertorie les membres de données de classe et de leurs colonnes OLE DB correspondant. Consultez [ensemble de lignes PROCEDURE_PARAMETERS](https://msdn.microsoft.com/library/ms713623.aspx) dans le *de référence du programmeur OLE DB* pour plus d’informations sur le schéma et les colonnes.  
...
### <a name="remarks"></a>Notes  
 ...
 Le tableau suivant répertorie les membres de données de classe et de leurs colonnes OLE DB correspondant. Consultez [ensemble de lignes de procédures](https://msdn.microsoft.com/library/ms724021.aspx) dans le *de référence du programmeur OLE DB* pour plus d’informations sur le schéma et les colonnes.  
...
### <a name="remarks"></a>Notes  
 ...
 Le tableau suivant répertorie les membres de données de classe et de leurs colonnes OLE DB correspondant. Consultez [ensemble de lignes PROVIDER_TYPES](https://msdn.microsoft.com/library/ms709785.aspx) dans le *de référence du programmeur OLE DB* pour plus d’informations sur le schéma et les colonnes.  
...
### <a name="remarks"></a>Notes  
 ...
 Le tableau suivant répertorie les membres de données de classe et de leurs colonnes OLE DB correspondant. Consultez [ensemble de lignes REFERENTIAL_CONSTRAINTS](https://msdn.microsoft.com/library/ms719737.aspx) dans le *de référence du programmeur OLE DB* pour plus d’informations sur le schéma et les colonnes.  
...
### <a name="remarks"></a>Notes  
 ...
 Le tableau suivant répertorie les membres de données de classe et de leurs colonnes OLE DB correspondant. Consultez [ensemble de lignes de schéma](https://msdn.microsoft.com/library/ms716887.aspx) dans le *de référence du programmeur OLE DB* pour plus d’informations sur le schéma et les colonnes.  
...
### <a name="remarks"></a>Notes  
 ...
 Le tableau suivant répertorie les membres de données de classe et de leurs colonnes OLE DB correspondant. Consultez [ensemble de lignes SQL_LANGUAGES](https://msdn.microsoft.com/library/ms714374.aspx) dans le *de référence du programmeur OLE DB* pour plus d’informations sur le schéma et les colonnes.  
...
### <a name="remarks"></a>Notes  
 ...
 Le tableau suivant répertorie les membres de données de classe et de leurs colonnes OLE DB correspondant. Consultez [ensemble de lignes de statistiques](https://msdn.microsoft.com/library/ms715957.aspx) dans le *de référence du programmeur OLE DB* pour plus d’informations sur le schéma et les colonnes.  
...
### <a name="remarks"></a>Notes  
 ...
 Le tableau suivant répertorie les membres de données de classe et de leurs colonnes OLE DB correspondant. Consultez [ensemble de lignes TABLE_CONSTRAINTS](https://msdn.microsoft.com/library/ms715921.aspx) dans le *de référence du programmeur OLE DB* pour plus d’informations sur le schéma et les colonnes.  
...
### <a name="remarks"></a>Notes  
 ...
 Le tableau suivant répertorie les membres de données de classe et de leurs colonnes OLE DB correspondant. Consultez [ensemble de lignes TABLE_PRIVILEGES](https://msdn.microsoft.com/library/ms725428.aspx) dans le *de référence du programmeur OLE DB* pour plus d’informations sur le schéma et les colonnes.  
...
### <a name="remarks"></a>Notes  
 ...
 Le tableau suivant répertorie les membres de données de classe et de leurs colonnes OLE DB correspondant. Consultez [ensemble de lignes de TABLES](https://msdn.microsoft.com/library/ms716980.aspx) dans le *de référence du programmeur OLE DB* pour plus d’informations sur le schéma et les colonnes.  
...
### <a name="remarks"></a>Notes  
 ...
 Le tableau suivant répertorie les membres de données de classe et de leurs colonnes OLE DB correspondant. Consultez [ensemble de lignes de traductions](https://msdn.microsoft.com/library/ms725365.aspx) dans le *de référence du programmeur OLE DB* pour plus d’informations sur le schéma et les colonnes.  
...
### <a name="remarks"></a>Notes  
 ...
 Le tableau suivant répertorie les membres de données de classe et de leurs colonnes OLE DB correspondant. Consultez [ensemble de lignes USAGE_PRIVILEGES](https://msdn.microsoft.com/library/ms722743.aspx) dans le *de référence du programmeur OLE DB* pour plus d’informations sur le schéma et les colonnes.  
...
### <a name="remarks"></a>Notes  
 ...
 Le tableau suivant répertorie les membres de données de classe et de leurs colonnes OLE DB correspondant. Consultez [ensemble de lignes VIEW_COLUMN_USAGE](https://msdn.microsoft.com/library/ms714896.aspx) dans le *de référence du programmeur OLE DB* pour plus d’informations sur le schéma et les colonnes.  
...
### <a name="remarks"></a>Notes  
 ...
 Le tableau suivant répertorie les membres de données de classe et de leurs colonnes OLE DB correspondant. Consultez [ensemble de lignes de vues](https://msdn.microsoft.com/library/ms723122.aspx) dans le *de référence du programmeur OLE DB* pour plus d’informations sur le schéma et les colonnes.  
...
### <a name="remarks"></a>Notes  
 ...
 Le tableau suivant répertorie les membres de données de classe et de leurs colonnes OLE DB correspondant. Consultez [ensemble de lignes VIEW_TABLE_USAGE](https://msdn.microsoft.com/library/ms719727.aspx) dans le *de référence du programmeur OLE DB* pour plus d’informations sur le schéma et les colonnes.  
