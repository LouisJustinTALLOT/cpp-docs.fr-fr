...
3.  Enfin, appelez le `CDatabase` l’objet `CommitTrans` fonction membre. Si une erreur se produit dans une des mises à jour ou si vous décidez d’annuler les modifications, appelez sa `Rollback` fonction membre.  
