...
Pour plus d’informations sur ces étapes, consultez le [Open Database Connectivity (ODBC)](/previous-versions/windows/desktop/ms710252\(v=vs.85\)) SDK dans la documentation MSDN.  
