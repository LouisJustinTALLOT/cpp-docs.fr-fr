...
2.  Vous pouvez éventuellement modifier le comportement de jeu d’enregistrements par défaut. Pour les options disponibles, consultez [définition des Options de jeu d’enregistrements](#_core_setting_recordset_options).  
  
3.  Appeler l’objet [Open](../../mfc/reference/crecordset-class.md#open) fonction membre.  
