---
title: Informations supplémentaires sur les Classes ODBC MFC | Documents Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
ms.locfileid: "33089218"
---
# <a name="further-reading-about-the-mfc-odbc-classes"></a>Informations supplémentaires sur les classes ODBC MFC
Autres rubriques suivantes expliquent les concepts et techniques présentées dans cette rubrique :  
...
-   [Transaction (ODBC)](../../data/odbc/transaction-odbc.md)  
 ...
 Est un bon point de départ de la lecture [Recordset (ODBC)](../../data/odbc/recordset-odbc.md).  
