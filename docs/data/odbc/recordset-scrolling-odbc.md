...
2.  Reculer d’un enregistrement ou un ensemble de lignes : appeler le [MovePrev](../../mfc/reference/crecordset-class.md#moveprev) fonction membre.  
...
4.  Pour le dernier enregistrement dans le jeu d’enregistrements ou pour le dernier ensemble de lignes : appeler le [MoveLast](../../mfc/reference/crecordset-class.md#movelast) fonction membre.  
