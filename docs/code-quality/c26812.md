---
description: 'En savoir plus sur : C26812'
title: c26812
keywords: c26812
author: JordanMaples
ms.author: jomaples
...
ms.locfileid: "97254181"
---
# <a name="c26812"></a>C26812

> AVERTISSEMENT C26812 : préférer’enum class’à’enum' (enum. 3)

Le type d’énumération *type-name est sans* portée. Préférer’enum class’à’enum' (enum. 3)

## <a name="example"></a>Exemple

L’exemple suivant provient de l’C++ Core Guidelines
