...
helpviewer_keywords:
- C26496
description: CppCoreCheck règle C26496 qui applique C++ Core Guidelines con. 4
ms.openlocfilehash: 15536231913f8b8451c80ec42da6596012fb150f
ms.sourcegitcommit: a1676bf6caae05ecd698f26ed80c08828722b237
ms.translationtype: MT
ms.contentlocale: fr-FR
ms.lasthandoff: 09/29/2020
ms.locfileid: "91502646"
---
# <a name="c26496-use_const_for_variable"></a>C26496 USE_CONST_FOR_VARIABLE

> La variable'*variable*'n’est assignée qu’une seule fois, marquez-la comme `const` .
