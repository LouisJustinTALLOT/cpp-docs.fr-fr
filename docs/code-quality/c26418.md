...
Instructions principales : R. 36 : utiliser un widget const shared_ptr\<> & paramètre pour exprimer qu’il peut conserver un décompte de références à l’objet **C++**
