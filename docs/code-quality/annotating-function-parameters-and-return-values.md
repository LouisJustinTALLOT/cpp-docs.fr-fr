...
- `_Printf_format_string_` indique que le paramètre est une chaîne de format à utiliser dans une expression `printf`.
...
- `_Scanf_format_string_` indique que le paramètre est une chaîne de format à utiliser dans une expression `scanf`.
...
- `_Scanf_s_format_string_` indique que le paramètre est une chaîne de format à utiliser dans une expression `scanf_s`.
