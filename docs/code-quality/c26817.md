...
Pour plus d’informations, consultez les [Notes es. 71](https://github.com/isocpp/CppCoreGuidelines/blob/master/CppCoreGuidelines.md#note-217) dans le C++ Core Guidelines.
