---
title: NE, opérateur | Documents Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-masm
...
ms.locfileid: "32052048"
---
# <a name="operator-ne"></a>NE, opérateur
Retourne la valeur true (-1) si *expression1* n’est pas égale *expression2*, ou la valeur false (0) dans ce cas.  
