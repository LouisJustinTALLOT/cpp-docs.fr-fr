---
title: PUBLIC (MASM) | Documents Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-masm
...
Permet de chaque variable, une étiquette ou un symbole absolu spécifié en tant que *nom* disponibles pour tous les autres modules dans le programme.  
