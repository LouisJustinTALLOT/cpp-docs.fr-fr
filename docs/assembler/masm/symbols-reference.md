---
title: Référence des symboles | Microsoft Docs
ms.custom: ''
ms.date: 08/30/2018
ms.technology:
- cpp-masm
...
### <a name="environment-information"></a>Informations d’environnement
...
### <a name="segment-information"></a>Informations de segment
