---
title: opérateur PTR | Documents Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-masm
...
La première force opérateur la *expression* pour être considérée comme ayant spécifié `type`. Le deuxième opérateur spécifie un pointeur vers `type`.  
