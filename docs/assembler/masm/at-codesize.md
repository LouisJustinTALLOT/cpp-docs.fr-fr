---
title: '@CodeSize | Documents Microsoft'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-masm
...
ms.locfileid: "32049136"
---
# <a name="codesize"></a>@CodeSize
0 pour **minuscule**, **petit**, **COMPACT**, et **plat** modèles et 1 pour **support**,  **GRAND**, et **énorme** modèles (numérique sont équivalentes).  
