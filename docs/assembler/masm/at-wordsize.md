---
title: '@WordSize | Documents Microsoft'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-masm
...
ms.locfileid: "32050101"
---
# <a name="wordsize"></a>@WordSize
Deux pour un segment de 16 bits ou quatre pour un segment de 32 bits (numérique sont équivalentes).  
