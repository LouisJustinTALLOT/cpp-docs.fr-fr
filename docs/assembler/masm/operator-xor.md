---
title: XOR, opérateur | Documents Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-masm
...
ms.locfileid: "32057375"
---
# <a name="operator-xor"></a>XOR, opérateur
Retourne le résultat d’une opération de bits **XOR** opération pour *expression1* et *expression2*.  
