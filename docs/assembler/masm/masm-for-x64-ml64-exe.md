...
### <a name="to-add-an-assembler-language-file-to-an-existing-visual-studio-c-project"></a>Pour ajouter un fichier en langage assembleur à un Visual Studio existante C++ projet
