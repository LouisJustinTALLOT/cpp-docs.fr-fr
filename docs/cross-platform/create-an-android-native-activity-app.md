...
1. Donnez un nom à l’application, par exemple *MyAndroidApp*, puis choisissez **OK**.
   ...
   ![Projet Native Activity dans Explorateur de solutions](../cross-platform/media/cppmdd-rc-na-solutionexp.png "Projet Native Activity dans l'Explorateur de solutions")
...
1. Si ce n’est pas déjà fait, choisissez **x86** dans la liste déroulante **Plateformes Solution** .
     ...
     ![Plateformes de solution, sélection x86](../cross-platform/media/cppmdd-rc-na-solution-x86.png "Sélection x86 de liste déroulante de plateformes de solution")
...
1. Appuyez sur **F5** pour démarrer le débogage, ou sur **MAJ**+**F5** pour démarrer sans débogage.
   ...
   ![L’émulateur exécutant votre application](../cross-platform/media/cppmdd-emulator-running-app.png "Émulateur exécutant votre application")
