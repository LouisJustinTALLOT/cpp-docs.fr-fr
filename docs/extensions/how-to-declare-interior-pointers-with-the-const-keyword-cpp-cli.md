---
description: 'En savoir plus sur : Comment : déclarer des pointeurs intérieurs avec le mot clé const (C++/CLI)'
title: 'Comment : déclarer des pointeurs intérieurs avec le mot clé const (C++/CLI)'
ms.date: 10/12/2018
ms.topic: reference
helpviewer_keywords:
- pointers, interior
