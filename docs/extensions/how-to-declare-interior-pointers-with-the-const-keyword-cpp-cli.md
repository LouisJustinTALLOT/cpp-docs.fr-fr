---
title: 'Procédure : déclarer des pointeurs intérieurs avec le mot clé const (C++/CLI)'
ms.date: 10/12/2018
ms.topic: reference
helpviewer_keywords:
- pointers, interior
...
ms.locfileid: "65515774"
---
# <a name="how-to-declare-interior-pointers-with-the-const-keyword-ccli"></a>Procédure : déclarer des pointeurs intérieurs avec le mot clé const (C++/CLI)
