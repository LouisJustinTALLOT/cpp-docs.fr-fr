---
title: 'Procédure : surcharger des fonctions avec des pointeurs intérieurs et des pointeurs natifs (C++/CLI)'
ms.date: 10/12/2018
ms.topic: reference
helpviewer_keywords:
...
ms.locfileid: "65515724"
---
# <a name="how-to-overload-functions-with-interior-pointers-and-native-pointers-ccli"></a>Procédure : surcharger des fonctions avec des pointeurs intérieurs et des pointeurs natifs (C++/CLI)
